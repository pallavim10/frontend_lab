                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <label style="color: red; font-weight: normal;">[Note : Please Select Word and Excel File Only]</label>
                                                </div>
                                            </div>
                                        </div>
                                        <br />
                                    ...
                                    <div class="rows">
                                        <div class="col-md-12">
                                            <div style="width: 100%; max-height: 352px; overflow: auto;">
                                                <div>
                                                    <asp:GridView ID="GrdShipment" AutoGenerateColumns="false" runat="server" class="table table-bordered table-striped responsive Datatable" EmptyDataText="No Data Found!" Width="100%" OnRowCommand="GrdShipment_RowCommand">
