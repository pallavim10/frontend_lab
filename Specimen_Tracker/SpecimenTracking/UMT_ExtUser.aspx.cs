            ...
            try
            {
                ...
                else
                {
                    ...
                    string script = @"
                     swal({
                     title: 'Success!',
                     text: 'External User Created Successfully.',
                     icon: 'success',
                     button: 'OK'
                     }).then((value) => {
                        window.location.href = 'UMT_ExtUser.aspx'; 
                     });";
            ...
            try
            {
                ...
                else
                {
                    ...
                    string script = @"
                     swal({
                     title: 'Success!',
                     text: 'External User Updated Successfully.',
                     icon: 'success',
                     button: 'OK'
                     }).then((value) => {
                        window.location.href = 'UMT_ExtUser.aspx'; 
        ...
        private void DELETE_USER(string ID)
        {
            try
            {
                ...
                string script = @"
                     swal({
                     title: 'Success!',
                     text: 'External User deleted Successfully.',
                     icon: 'success',
                     button: 'OK'
                     }).then((value) => {
                        window.location.href = 'UMT_ExtUser.aspx'; 
