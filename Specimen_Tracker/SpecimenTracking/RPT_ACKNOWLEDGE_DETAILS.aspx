<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RPT_ACKNOWLEDGE_DETAILS.aspx.cs" Inherits="SpecimenTracking.RPT_ACKNOWLEDGE_DETAILS" %>
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Acknowledge Details</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Acknowledge Details</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Acknowledge Details</h3>
                                                ...
                                                <div>
                                                    <asp:GridView ID="grd_Data" runat="server" AutoGenerateColumns="true"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-CssClass="align-left">
                                                                <HeaderTemplate>
                                                                    <label>Acknowledge Details</label><br />
