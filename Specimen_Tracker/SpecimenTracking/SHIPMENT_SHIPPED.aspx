<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SHIPMENT_SHIPPED.aspx.cs" Inherits="SpecimenTracking.SHIPMENT_SHIPPED" %>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Shipments Shipped</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Shipments Shipped</h3>
                                <div class="pull-right">
                                    <asp:LinkButton ID="lbtnExport" runat="server" Font-Size="14px" Style="margin-top: 3px;" CssClass="btn btn-default btn-sm" OnClick="lbtnExport_Click" ForeColor="Black">Export Shipment Ship Details &nbsp;<span class="fas fa-download btn-sm"></span></asp:LinkButton>
                                    &nbsp;&nbsp;
                                        ...
                                        <div style="width: 100%; overflow: auto;">
                                            <div>
                                                <asp:GridView ID="Grid_Data" runat="server" AutoGenerateColumns="false"
                                                    CssClass="table table-bordered table-striped Datatable1" OnPreRender="Grid_Data_PreRender" OnRowCommand="Grid_Data_RowCommand" OnRowDataBound="Grid_Data_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Shipment Date" HeaderStyle-CssClass="text-center  align-middle" ItemStyle-CssClass="text-center align-middle">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblSHIPMENTDAT" runat="server" Text='<%#Eval("SHIPMENTDAT")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="AWB No." HeaderStyle-CssClass="text-center  align-middle" ItemStyle-CssClass="text-center align-middle">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblAWBNUM" runat="server" Text='<%#Eval("AWBNUM")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderStyle-CssClass="align-left">
                                                            <HeaderTemplate>
                                                                <label>Shipment Ship Details</label><br />
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Update Shipment Details</h4>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <asp:TextBox runat="server" ID="txtReason" Text="" CssClass="form-control required2" TextMode="MultiLine" MaxLength="500"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div style="width: 100%; height: 100%; max-height: 500px; overflow: auto;">
                                <div>
                                    <asp:GridView ID="grdDATA" runat="server" AutoGenerateColumns="true" CssClass="table table-bordered table-striped Datatable"
                                        Style="width: 91%; border-collapse: collapse; margin-left: 20px;" OnPreRender="Grid_Data_PreRender" OnRowDataBound="grdDATA_RowDataBound">
                                        <Columns>
                                        </Columns>
                                    </asp:GridView>
                                </div>
