<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RPT_SDV_DETAILS.aspx.cs" Inherits="SpecimenTracking.RPT_SDV_DETAILS" %>
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">SDV Details</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                ...
                                <div class="pull-right">
                                    <asp:LinkButton ID="lbtnExport" runat="server" Font-Size="14px" Style="margin-top: 3px;" CssClass="btn btn-default btn-sm" OnClick="lbtnExport_Click" ForeColor="Black">Export SDV Details &nbsp;<span class="fas fa-download btn-sm"></span></asp:LinkButton>
                                    &nbsp;&nbsp;
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4" id="divSID" runat="server">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txtSpecimenID" runat="server" CssClass="form-control  numeric"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div>
                                                    <asp:GridView ID="grd_Data" runat="server" AutoGenerateColumns="true"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="SDV Status">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSDV" runat="server" Text='<%# Eval("SDV").ToString() == "1" ? "Yes" : "No" %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
