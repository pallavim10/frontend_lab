...
{
    public partial class RPT_ACKNOWLEDGE_DETAILS : System.Web.UI.Page
    {
        ...
        private void GET_ACKNOWLEDGEMENT_DETAILS()
        {
            try
            {
                DataSet ds = Dal_MF.SPECIMEN_REPORT_SP(
                   ACTION: "GET_ACKNOWLEDGEMENT_DETAILS",
        ...
        protected void lbtnExport_Click(object sender, EventArgs e)
        {
            try
            {
                GET_ACKNOWLEDGEMENT_DETAILS_EXPORT();
            }
            catch (Exception ex)
            {
                ExceptionLogging.SendErrorToText(ex);
        ...
        private void GET_ACKNOWLEDGEMENT_DETAILS_EXPORT()
        {
            try
            {
                ...
                DataSet ds = Dal_MF.SPECIMEN_REPORT_SP(
                   ACTION: "GET_ACKNOWLEDGEMENT_DETAILS_EXPORT",
                   SITEID: drpSite.SelectedValue,
                   SUBJID: drpSubject.SelectedValue,
                   SID: txtSpecimenID.Text,
                   FromDate: txtDateFrom.Text,
