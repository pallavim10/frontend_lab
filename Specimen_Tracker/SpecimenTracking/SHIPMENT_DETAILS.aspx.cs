...
namespace SpecimenTracking
{
    public partial class SHIPMENT_DETAILS : System.Web.UI.Page
    {
        ...
        private void GET_SHIPMENT_GENETRATE_EXPORT()
        {
            try
            {
                string xlname = "Shipment Generate Report";

                DataSet ds = Dal_MF.SHIPMENT_MENIFEST_SP(
                   ACTION: "GET_SHIPMENT_ForSHIP_EXPORT",
                    SITEID: drpSite.SelectedValue,
                    VISITNUM: drpVISIT.SelectedValue,
                    ALIQUOTTYPE: drpALIQUOTTYPE.SelectedValue,
                    FROMDAT: txtFROMDAT.Text,
