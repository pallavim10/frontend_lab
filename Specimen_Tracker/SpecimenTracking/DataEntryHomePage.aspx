<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DataEntryHomePage.aspx.cs" Inherits="SpecimenTracking.DataEntryHomePage" %>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">DataEntry</li>
                        </ol>
                    </div>
                </div>
            </div>
