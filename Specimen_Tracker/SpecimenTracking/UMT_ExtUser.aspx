<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UMT_ExtUser.aspx.cs" Inherits="SpecimenTracking.UMT_ExtUser" %>
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Create External Users</h3>
                                <div class="pull-right">
                                    <asp:LinkButton ID="lbtnExport" runat="server" Font-Size="14px" Style="margin-top: 3px;" CssClass="btn btn-default" OnClick="lblUserDetailsExport_Click" ForeColor="Black">Export External Users&nbsp;<span class="fas fa-download btn-xs"></span></asp:LinkButton>
                                    &nbsp;&nbsp; 
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox runat="server" ID="txtCompany" CssClass="form-control required" Width="100%"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
