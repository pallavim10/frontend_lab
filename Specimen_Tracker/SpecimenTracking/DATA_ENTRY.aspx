    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">L1 - New Entry</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 d-inline-flex">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <asp:HiddenField runat="server" ID="hdnOldSpecimenType" />
                                        </div>
                                    </div>
                                    <div runat="server" id="divSID" visible="false">
                                        ...
                                        <div class="col-md-12 d-inline-flex">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <asp:TextBox ID="txtSpecimen" runat="server" CssClass="form-control required" Width="100%" AutoPostBack="true" OnTextChanged="txtSpecimen_TextChanged">
                                                </asp:TextBox>
                                                <asp:HiddenField runat="server" ID="hdnOldSpecimen" />
                                            </div>
                                        </div>
                                    </div>
                                    <div runat="server" id="divSubject" visible="false">
                                        ...
                                        <div class="col-md-12 d-inline-flex">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <asp:TextBox ID="txtSubject" runat="server" CssClass="form-control required" Width="100%" AutoPostBack="true" OnTextChanged="txtSubject_TextChanged">
                                                </asp:TextBox>
                                                <asp:HiddenField runat="server" ID="hdnOldSubject" />
                                            </div>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="col-md-12 mt-0 d-inline-flex">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <asp:HiddenField runat="server" ID="hdnOldVisit" />
                                        </div>
                                    </div>
                                    <br />
                                    ...
                                    <div runat="server" id="divAliquotPrep" visible="false">
                                        ...
                                        <asp:GridView runat="server" ID="gridAliquots" OnRowDataBound="gridAliquots_RowDataBound" AutoGenerateColumns="false" CssClass="table table-bordered table-striped txt_center" Width="100%">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Aliquot No." ItemStyle-Width="16%">
                                                    <ItemTemplate>
                                                        <asp:TextBox runat="server" ID="txtALIQUOTNO" CssClass="form-control txt_center" autocomplete="off" Text='<%# Eval("ALIQUOTNO") %>' AutoPostBack="true" OnTextChanged="txtALIQUOTNO_TextChanged"></asp:TextBox>
                                                ...
                                                <asp:TemplateField HeaderText="Box Number" ItemStyle-Width="16%">
                                                    <ItemTemplate>
                                                        <asp:TextBox runat="server" ID="txtBOXNO" CssClass="form-control txt_center" autocomplete="off" Text='<%# Eval("BOXNO") %>' AutoPostBack="true" OnTextChanged="txtBOXNO_TextChanged"></asp:TextBox>
                                                        <asp:HiddenField runat="server" ID="hdnOldBOXNO" Value='<%# Eval("BOXNO") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Slot Number" ItemStyle-Width="16%">
                                                    <ItemTemplate>
                                                        <asp:TextBox runat="server" ID="txtSLOTNO" CssClass="form-control txt_center" autocomplete="off" Text='<%# Eval("SLOTNO") %>' AutoPostBack="true" OnTextChanged="txtSLOTNO_TextChanged"></asp:TextBox>
                ...
                <cc1:ModalPopupExtender ID="modalReason" runat="server" BehaviorID="mpe" PopupControlID="pnlReason" TargetControlID="openModalReason" BackgroundCssClass="modalBackground">
