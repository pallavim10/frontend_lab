...
{
    public partial class RPT_ACKNOWLEDGEMENT : System.Web.UI.Page
    {
        ...
        private void GET_DATA()
        {
            try
            {
                DataSet ds = Dal_MF.ACKNOWLEDGEMENT_SP(
                   ACTION: "GET_ACKNOWLEDGEMENT_REPORT",
        ...
        private void EXPORT_ACKNOWLEDGEMENT_REPORT()
        {
            try
            {
                string xlname = "Acknowledge Report";

                DataSet ds = Dal_MF.ACKNOWLEDGEMENT_SP(
                   ACTION: "EXPORT_ACKNOWLEDGEMENT_REPORT",
                   SITEID: drpSite.SelectedValue,
                   SUBJID: drpSubject.SelectedValue,
                   SID: txtSpecimenID.Text,
                   STATUS: drpstatus.SelectedValue);
        ...
        protected void grd_Data_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                gv.HeaderRow.Cells[17].Text = Session["Subject ID"].ToString();
            }
        }
