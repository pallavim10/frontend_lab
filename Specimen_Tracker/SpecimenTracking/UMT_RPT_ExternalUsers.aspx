<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UMT_RPT_ExternalUsers.aspx.cs" Inherits="SpecimenTracking.UMT_RPT_ExternalUsers" %>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3>
                            <asp:Label runat="server" ID="lblHeader" Text="External Users Report"></asp:Label></h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">External Users Report</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">External Users Report</h3>
                                <div class="pull-right">
                                    <asp:LinkButton runat="server" ID="btnExport" OnClick="btnExport_Click" CssClass="btn btn-default" Style="color: #333333; font-size: 14px; font-weight: 500;">Export External Users Report<span class="fa fa-download btn-xs"></span></asp:LinkButton>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 align-content-center">
                                                <div class="d-inline-flex align-items-center">
                                                    ...
                                                    <div id="divDownload" class="dropdown " runat="server" style="margin-left: 5px;" visible="false">
                                                        <a href="#" class="dropdown-toggle fa fa-download" data-toggle="dropdown"
                                                            style="color: #333333" title="Export"></a>
                                                        <ul class="dropdown-menu dropdown-menu-sm">
                                                            <li>
                                                                <asp:LinkButton runat="server" ID="lbtnExport" OnClick="btnExport_Click" ToolTip="Export to Excel" Text="Export to Excel" CssClass="dropdown-item" Style="color: #333333;">
                                                                </asp:LinkButton></li>
                                                            <hr style="margin: 5px;" />
                                                        </ul>
                                                    </div>
