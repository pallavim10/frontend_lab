...
{
    public partial class RPT_SDV_DETAILS : System.Web.UI.Page
    {
        ...
        private void GET_SDV_DETAILS_EXPORT()
        {
            try
            {
                string xlname = "SDV Details Report";
        ...
        protected void grd_Data_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                gv.HeaderRow.Cells[13].Text = Session["Subject ID"].ToString();
            }
        }
