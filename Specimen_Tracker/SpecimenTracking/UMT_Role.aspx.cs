...
namespace SpecimenTracking
{
    public partial class UMT_Role : System.Web.UI.Page
    {
        ...
        protected void btnSUBMITRoles_Click(object sender, EventArgs e)
        {
            try
            {
                if (CHECK_ROLE_EXISTS("INSERT"))
                {
                    ...
                    ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "swal('Warning!',' Role Name already exists for this system.', 'warning');", true);
                }
                else
                {
                    dal_UMT.UMT_ROLE_SP(
        ...
        private void Clear()
        {
            ...
            drpSystem_SelectedIndexChanged(this, EventArgs.Empty);
        }
        ...
        private void DELETE_ROLES(string ID)
        {
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "swal('Success!','User Role Deleted Succesfully', 'success');", true);
