                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <div runat="server" id="divSite" visible="false">
                                                        ...
                                                        <div>
                                                            <asp:Label ID="lblSiteID" runat="server" CssClass=" form-control w-100"></asp:Label>
                                                        </div>
                                                    </div>
                                                    <div runat="server" id="divExternal" visible="false">
                                                        <asp:Label ID="lblDiv" style="font-weight:600; font-size:14px;" runat="server"></asp:Label>: &nbsp;
                                                        <asp:Label ID="lblCompany" runat="server" CssClass=" form-control w-100 m-0"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div style="width: 100%;">
                                        <div>
                                            <asp:GridView ID="grdAssignRolesAct" runat="server" AllowSorting="True" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Systems" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="text_center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSystem" runat="server" Text='<%# Bind("SystemName") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Privileges" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="text_center">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSubSystem" runat="server" Text='<%# Bind("SubSystem") %>' />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Notes" HeaderStyle-Width="40%" ItemStyle-CssClass="text_center" ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Select Roles" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="text_center">
                                                        <ItemTemplate>
