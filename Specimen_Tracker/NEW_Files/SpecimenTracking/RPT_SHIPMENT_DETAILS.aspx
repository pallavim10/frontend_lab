                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList ID="drpSite" runat="server" AutoPostBack="false" class="form-control drpControl w-75  select2" SelectionMode="Single">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div style="width: 100%; height:700px; overflow: auto;">
                                                <div>
                                                    <asp:GridView ID="grd_Data" runat="server" AutoGenerateColumns="false"
                                                        CssClass="table table-bordered table-striped Datatable" Width="100%" OnPreRender="grd_Data_PreRender">
                                                        <Columns>
