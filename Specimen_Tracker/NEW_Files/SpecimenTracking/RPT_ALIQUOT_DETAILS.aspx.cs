...
{
    public partial class RPT_ALIQUOT_DETAILS : System.Web.UI.Page
    {
        ...
        private void GET_ALIQUOT_DETAILS()
        {
            try
            {
                DataSet ds = Dal_MF.SPECIMEN_REPORT_SP(
                   ACTION: "GET_ALIQUOT_DETAILS",
        ...
        private void GET_ALIQUOT_DETAILS_EXPORT()
        {
            try
            {
                string xlname = "Aliquot Details Report";

                DataSet ds = Dal_MF.SPECIMEN_REPORT_SP(
                   ACTION: "GET_ALIQUOT_DETAILS_EXPORT");
