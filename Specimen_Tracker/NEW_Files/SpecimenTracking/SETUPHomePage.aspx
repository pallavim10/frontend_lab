<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SETUPHomePage.aspx.cs" Inherits="SpecimenTracking.SETUPHomePage" %>
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Set-Up</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
