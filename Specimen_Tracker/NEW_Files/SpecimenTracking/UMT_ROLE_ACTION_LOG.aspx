<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UMT_ROLE_ACTION_LOG.aspx.cs" Inherits="SpecimenTracking.UMT_ROLE_ACTION_LOG" %>
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3><asp:Label runat="server" ID="lblHeader" Text="Role related activities"></asp:Label></h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Role related activities</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Role related activities</h3>
                                  <div class="pull-right">
                                    <asp:LinkButton runat="server" ID="btnExport" OnClick="btnExport_Click" CssClass="btn btn-default btn-sm" Style="color: #333333; font-size: 14px; font-weight: 500;">Export Role Activities Report<span class="fa fa-download btn-xs"></span></asp:LinkButton>
