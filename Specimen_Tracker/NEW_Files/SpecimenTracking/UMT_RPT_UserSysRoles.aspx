<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UMT_RPT_UserSysRoles.aspx.cs" Inherits="SpecimenTracking.UMT_RPT_UserSysRoles" %>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3>
                            <asp:Label runat="server" ID="lblHeader" Text="User Role Assignment Logs"></asp:Label></h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="HomePage.aspx">Home </a></li>
                            <li class="breadcrumb-item">Logs</li>
                            <li class="breadcrumb-item active">User Role Assignment Logs</li>
                        </ol>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">User Role Assignment Logs</h3>
                                <div class="pull-right">
                                    <asp:LinkButton runat="server" ID="LinkButton1" OnClick="btnExport_Click" CssClass="btn btn-default btn-sm" Style="color: #333333; font-size: 14px; font-weight: 500;">Export User Role Assignment Logs<span class="fa fa-download btn-xs"></span></asp:LinkButton>
