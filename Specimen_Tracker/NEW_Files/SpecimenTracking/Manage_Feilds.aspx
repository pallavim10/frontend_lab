                                            ...
                                            <div style="width: 100%; overflow: auto;">
                                                <div>
                                                    <asp:GridView ID="grdMngOptFields" runat="server" AllowSorting="True" AutoGenerateColumns="false"
                                                        CssClass="table table-bordered table-striped Datatable1" OnRowDataBound="grdMngOptFields_RowDataBound" OnRowCommand="grdMngOptFields_RowCommand" OnPreRender="grdMngOptFields_PreRender">
                                                        <Columns>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtVariableName" runat="server" OnTextChanged="txtVariableName_TextChanged" AutoPostBack="true" CssClass="form-control required w-75 uppercase"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
