...
namespace SpecimenTracking.App_Code
{
    public class DAL_MF
    {
        ...
        public DataSet SHIPMENT_MENIFEST_SP(string ACTION = null, string SPECTYP = null, string VISIT = null, string VISITNUM = null, string ALIQUOTTYPE = null, string SITEID = null, string FROMDAT = null, string TODAT = null, string SHIPMENTID = null, string SHIPMENTDAT = null, string AWBNUM = null, string REASON = null)
        {
        ...
        public DataSet ACKNOWLEDGEMENT_SP(string ACTION = null, string SITEID = null, string VISITNUM = null, string SID = null, string SUBJID = null,string ACKNOWLEDGEMENT = null)
        {
            DataSet ds = new DataSet();
            SqlCommand cmd;
            SqlDataAdapter adp;
        ...
        public DataSet SDV_SP(string ACTION = null, string SITEID = null, string VISITNUM = null, string SID = null, string SUBJID = null, string ACKNOWLEDGEMENT = null)
        {
            DataSet ds = new DataSet();
            SqlCommand cmd;
            SqlDataAdapter adp;
        ...
        public DataSet SPECIMEN_REPORT_SP(string ACTION = null, string SITEID = null, string VISITNUM = null, string SID = null, string SUBJID = null, string ACKNOWLEDGEMENT = null)
        {
            DataSet ds = new DataSet();
            SqlCommand cmd;
            SqlDataAdapter adp;
