...
{
    public class DAL_SERVER_MASTER
    {
        ...
        public DataSet SERVER_MASTER_SP(string ACTION = null, string ID = null, string SERVERNAME = null, string USER_ID = null, string PASSWORD = null)
        {
            ...
            try
            {
                ...
                cmd = new SqlCommand("SERVER_MASTER_SP", con);
        ...
        public DataSet SERVER_LOG_SP(string ACTION = null, string FROMDATE = null, string TODATE = null, string USERNAME = null, string TABLENAME = null, string ID = null)
        {
            DataSet ds = new DataSet();
            SqlCommand cmd;
            SqlDataAdapter adp;
            try
            {
                ...
                cmd = new SqlCommand("SERVER_LOG_SP", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@ACTION", ACTION);
