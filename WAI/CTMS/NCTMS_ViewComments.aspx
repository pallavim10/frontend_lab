<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NCTMS_ViewComments.aspx.cs"
    Inherits="CTMS.NCTMS_ViewComments" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CallCkedit() {
            ...
            CKEDITOR.replace("MainContent_txtSponsorComment");
...
<body>
    ...
    <div class="page">
        <div class="box box-warning">
            ...
            <div class="box-header" style="display: inline-flex; width: 100%;">
                <h3 class="box-title" style="width: 100%; font-weight: bold;">
                    ...
                    Id :<asp:Label runat="server" ForeColor="Blue" ID="lblSVID" />&nbsp;&nbsp&nbsp&nbsp
        ...
        <div class="box-body" id="divUpdateComment" runat="server" visible="false">
            <div id="accordion">
                <div class="box box-danger">
                    <div class="box-header">
                        <h4 class="box-title">
                            <asp:Label runat="server" ID="lblUpdateComment" Text="Update Comment">
                            </asp:Label>
                        </h4>
                    </div>
                    <div class="box-body">
                        <div class="row" id="divField" runat="server">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-8">
                                    <asp:Label ID="lblFieldName" runat="server" ReadOnly="true" Font-Size="Small" Width="100%"
                                        Style="max-height: 100px; height: auto;" CssClass="form-control"></asp:Label>
                                </div>
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div style="margin-left: 20%;">
                                <asp:Button ID="bntSave" runat="server" Text="Update" CssClass="btn btn-primary btn-sm cls-btnSave"
