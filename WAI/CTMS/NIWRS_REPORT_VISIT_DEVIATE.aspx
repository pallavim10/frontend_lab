<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_REPORT_VISIT_DEVIATE.aspx.cs" Inherits="CTMS.NIWRS_REPORT_VISIT_DEVIATE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">
                <asp:Label runat="server" ID="lblHeader" Text="Visit Deviation Report"></asp:Label>
            </h3>
            ...
            <div class="pull-right">
                ...
                <a href="#" class="dropdown-toggle btn-info prevent-refresh-button" data-toggle="dropdown" style="color: #FFFFFF">Export Visit Deviation Report&nbsp;<span class="glyphicon glyphicon-download"></span></a>
                                ...
                                <div style="width: 100%; overflow: auto;">
                                    <div>
                                        <asp:GridView ID="gridData" HeaderStyle-CssClass="txt_center" runat="server" AutoGenerateColumns="true"
                                            Width="100%" OnPreRender="grd_data_PreRender" CssClass="table table-bordered Datatable table-striped notranslate txt_center">
                                            <Columns>
                                            </Columns>
                                        </asp:GridView>
                                    </div>
