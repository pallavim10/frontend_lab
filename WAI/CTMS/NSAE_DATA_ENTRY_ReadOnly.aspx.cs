...
namespace CTMS
{
    public partial class NSAE_DATA_ENTRY_ReadOnly : System.Web.UI.Page
    {
        ...
        protected void CHECK_MM_MODULE()
        {
            try
            {
                ...
                if (ds_MM.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        hfSAE_MM.Value = ds_MM.Tables[0].Rows[0]["SAE_MM"].ToString();
        ...
        protected void btnSAVEMR_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string MSG = "NSAE_DATA_ENTRY_ReadOnly.aspx?INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "&SAE=" + hdnSAE.Value + "&STATUS=" + hdnStatus.Value + "&SAEID=" + hdnSAEID.Value + "&MODULEID=" + drpModule.SelectedValue + "&ACTION=" + Request.QueryString["ACTION"].ToString();
        ...
        {
            Response.Redirect("NSAE_DATA_ENTRY_ReadOnly.aspx?INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "&SAE=" + hdnSAE.Value + "&STATUS=" + hdnStatus.Value + "&SAEID=" + hdnSAEID.Value + "&MODULEID=" + drpModule.SelectedValue + "&ACTION=" + Request.QueryString["ACTION"].ToString());
        }
        ...
        protected void GetDataExists_Deleted()
        {
            try
            {
                ...
                ds = dal_SAE.SAE_SINGLE_RECORS_SP(
                         ACTION: "CHECK_DATA_EXISTS_Deleted_MR",
                         SAEID: hdnSAEID.Value,
                         STATUS: hdnStatus.Value,
                         MODULEID: Request.QueryString["MODULEID"].ToString(),
                         SUBJID: Request.QueryString["SUBJID"].ToString(),
        ...
        protected void lnkPAGENUMDeleted_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("NSAE_DATA_ENTRY_ReadOnly.aspx?INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "&SAE=" + hdnSAE.Value + "&STATUS=" + hdnStatus.Value + "&SAEID=" + hdnSAEID.Value + "&MODULEID=" + drpModule.SelectedValue + "&ACTION=" + Request.QueryString["ACTION"].ToString() + "&RECID=" + REC_ID.Text + "&DELETED=1");
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
