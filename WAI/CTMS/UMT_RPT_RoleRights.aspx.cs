...
namespace CTMS
{
    public partial class UMT_RPT_RoleRights : System.Web.UI.Page
    {
        ...
        private void GET_DATA()
        {
            try
            {
                DataSet ds = dal_UMT.UMT_REPORT_SP(ACTION: "GET_ROLE_RIGHTS",
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_UMT.UMT_REPORT_SP(ACTION: "GET_INTERNAL_USERS",
                FromDate: txtDateFrom.Text,
                ToDate: txtDateTo.Text
                );
