...
namespace CTMS
{
    public partial class NIWRS_REPORT_KIT_DISP_SUM : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_LIST()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "REPORT_BLIND_GET_KIT_DISPENSE_SUMMARY", SITEID: ddlSite.SelectedValue, SUBSITEID: ddlSubSite.SelectedValue, ENTEREDBY: Session["User_ID"].ToString(),FROMDATE: txtDateFrom.Text, TODATE: txtDateTo.Text);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "REPORT_BLIND_GET_KIT_DISPENSE_SUMMARY", SITEID: ddlSite.SelectedValue, ENTEREDBY: Session["User_ID"].ToString());
                ds.Tables[0].Columns["Participant Id"].ColumnName = Session["SUBJECTTEXT"].ToString();
