...
namespace CTMS
{
    public partial class eTMF_Editable_NestedView : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void bind_Folder()
        {
            try
            {
                ...
                if (Request.QueryString["DocType"] != null)
                {
                    ...
                    ds = dal_eTMF.eTMF_SET_SP(ACTION: "get_Folder", Project_ID: Session["PROJECTID"].ToString(), DocType: Request.QueryString["DocType"].ToString());
                }
                else
                {
        ...
        protected void gvDocs_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    DataSet ds = dal.eTMF_SP(ACTION: "Get_Files", DocID: ID, RefNo: RefNo, UniqueRefNo: UniqueRefNo);
        ...
        protected void gvFiles_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (UploadFileName_Editable.ToString() != "" && UploadFileName_Editable != null)
                    {
