<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NSAE_DELETED_SAE.aspx.cs" Inherits="CTMS.NSAE_DELETED_SAE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">List Of Deleted SAE
            </h3>
        </div>
                        ...
                        <div class="box">
                            <div style="width: 100%; overflow: auto;">
                                <asp:GridView ID="grdSAELog" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                                    OnRowCommand="grdSAELog_RowCommand" AllowSorting="true" Width="100%" OnPreRender="grd_data_PreRender" OnRowDataBound="grdSAELog_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="align-left">
                                            ...
                                            <ItemTemplate>
                                                <div runat="server">
                                                    ...
                                                    <div>
                                                        <asp:Label ID="DELETEBYNAME" runat="server" Enabled="false" Font-Bold="true" Text='<%# Bind("DELETEBYNAME") %>' ForeColor="Blue"></asp:Label>
                                                    </div>
                                                    <div>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="align-left">
                                            <HeaderTemplate>
                                                <label>Restore Request</label><br />
                                            ...
                                            <ItemTemplate>
                                                <div align="center">
                                                    <asp:LinkButton ID="lbtnEdit" runat="server" ToolTip="Generate Re-Open Request" CommandName="EditSAE" CommandArgument='<%# Bind("SAE") %>'><i class="fa fa-undo"></i></asp:LinkButton>
                                                </div>
