<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NCTMS_AddChecklistComments.aspx.cs"
    Inherits="CTMS.NCTMS_AddChecklistComments" %>
        ...
        <div class="box box-warning">
            ...
            <div class="box-header" style="display: inline-flex; width: 100%;">
                <h3 class="box-title" style="width: 100%; font-weight: bold;">
                    Field Comments &nbsp;||&nbsp; Site Id :<asp:Label runat="server" ForeColor="Blue"
        ...
        <div class="box-body" id="divAddUpdateComment" runat="server">
            <div id="accordion">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <div class="row" id="divField" runat="server">
                            <div class="col-md-12">
                                <div class="label col-md-2">
                                    Field Name :
                                </div>
                                <div class="col-md-8">
                                    <asp:Label ID="lblFieldName" runat="server" Width="100%" Style="max-height: 100px;
                                        height: auto;" CssClass="form-control"></asp:Label>
                                </div>
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" ID="txtCRAComments" CssClass="ckeditor required" Height="10%"
                        ...
                        <div class="row" id="divPMCOMMENT" runat="server" visible="false">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" ID="txtPMComment" CssClass="ckeditor required" Enabled="false"
                                        Height="10%" TextMode="MultiLine" Width="99%"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <br />
                        <div class="row" id="divSPONSORCOMMENT" runat="server" visible="false">
                            <div class="col-md-12">
                                <div class="label col-md-2">
                                    Sponsor Comments :&nbsp;
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" ID="txtSponsorComment" CssClass="ckeditor required" Enabled="false"
                                        Height="10%" TextMode="MultiLine" Width="99%"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-header">
                            <div runat="server" style="display: inline-flex; padding: 0px; margin: 4px 0px 0px 10px;"
                                ...
                                <h3 class="box-title" style="padding-top: 0px;">
                                    <asp:Label ID="lblHeader" runat="server" Text="Field Comment"></asp:Label>
                                </h3>
                            </div>
                        </div>
