...
namespace CTMS
{
    public partial class eTMF_ShowMyView_Site : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void Get_Files()
        {
            try
            {
                DataSet ds = dal.eTMF_View_SP(ACTION: "Get_Show_ViewFiles_Site",
        ...
        protected void gvTreeArtifact_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    DataSet ds = dal.eTMF_View_SP(ACTION: "GET_VIEW_DOCS_Site", RefNo: MainRefNo, ID: Request.QueryString["VIEWID"].ToString());
