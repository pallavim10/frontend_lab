<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NIWRS_RETENTION_COUNTRY.aspx.cs" Inherits="CTMS.NIWRS_RETENTION_COUNTRY" %>
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="gvKits" runat="server" AllowSorting="True" AutoGenerateColumns="False" OnPreRender="gvKits_PreRender"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Lot Number" Visible="false">
                                    <ItemTemplate>
