...
namespace CTMS
{
    public partial class NCTMS_PM_REVIEW_LIST : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        public void FillVISITS_NOM()
        {
            ...
            {
                DataSet ds = dal.CTMS_DATA_SP(
                ACTION: "GET_VISIT_NOM_AGAINST_USER_PM",
        ...
        protected void GETDATA()
        {
            try
            {
                DataSet ds = dal.CTMS_DATA_SP(ACTION: "GET_VISIT_REPORT_DATA_PM",
