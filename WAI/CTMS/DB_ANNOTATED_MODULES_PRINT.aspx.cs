...
namespace CTMS
{
    public partial class DB_ANNOTATED_MODULES_PRINT : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    var AspxToPdfOptions = new IronPdf.Rendering.AdaptivePdfRenderOptions()
                    {
                        ...
                        {
                            LeftText = Session["PROJECTIDTEXT"].ToString() + " - " + hdnSYSTEM.Value,
                            RightText = "Annotated CRF",
                        ...
                        {
                            LeftText = Session["User_Name"].ToString() + " - " + DateTime.Now.ToString("yyyyMMdd hh:mm tt"),
                    ...
                    AspxToPdf.RenderThisPageAsPdf(
                        ...
                        "" + Session["PROJECTIDTEXT"].ToString() + "_" + hdnSYSTEM.Value + "_" + DateTime.Now.ToString("yyyyMMdd") + ".pdf",
                        AspxToPdfOptions
                   );
                }
            }
        ...
        private void GetStructure()
        {
            try
            {
                DataSet ds = dal_DB.DB_ANNOTATED_PRINT_SP(ACTION: "GET_MODULENAME_BY_SYSTEM",
        ...
        protected void repeat_AllModule_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    DataSet ds = dal_DB.DB_ANNOTATED_PRINT_SP(ACTION: "GET_STRUCTURE",
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (CONTROLTYPE == "TEXTBOX")
                    {
                        ...
                        {
                            DataSet ds = dal_DB.DB_ANNOTATED_PRINT_SP(ACTION: "GET_OPTIONS_LIST", VARIABLENAME: VARIABLENAME, ID: ID, MODULEID: dr["MODULEID"].ToString(),
                                SYSTEM: hdnSYSTEM.Value);
                    ...
                    if (CONTROLTYPE == "CHECKBOX")
                    {
                        ...
                        ds = dal_DB.DB_ANNOTATED_PRINT_SP(ACTION: "GET_OPTIONS_LIST", VARIABLENAME: VARIABLENAME, ID: ID, MODULEID: dr["MODULEID"].ToString(), SYSTEM: hdnSYSTEM.Value);
        ...
        protected void repeat_RAD_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    ds1 = dal_DB.DB_ANNOTATED_PRINT_SP(ACTION: "GET_STRUCTURE_CHILD",
                        MODULEID: row["MODULEID"].ToString(),
            ...
            try
            {
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    if (CONTROLTYPE == "TEXTBOX")
                    {
                        ...
                        if (CLASS == "OptionValues form-control")
                        {
                            DataSet ds = dal_DB.DB_ANNOTATED_PRINT_SP(ACTION: "GET_STRUCTURE_CHILD",
                                MODULEID: dr["MODULEID"].ToString(),
                                FIELDID: dr["ID"].ToString(),
                    ...
                    if (CONTROLTYPE == "CHECKBOX")
                    {
                        ...
                        ds = new DataSet();
                        hdnfieldname1.Value = VARIABLENAME;
                        ds = dal_DB.DB_ANNOTATED_PRINT_SP(ACTION: "GET_STRUCTURE_CHILD",
                                MODULEID: dr["MODULEID"].ToString(),
                                FIELDID: dr["ID"].ToString(),
                                OPTIONS: dr["TEXT"].ToString(),
                                SYSTEM: hdnSYSTEM.Value
