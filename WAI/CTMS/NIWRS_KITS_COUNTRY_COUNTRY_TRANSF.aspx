<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NIWRS_KITS_COUNTRY_COUNTRY_TRANSF.aspx.cs" Inherits="CTMS.NIWRS_KITS_COUNTRY_COUNTRY_TRANSF" %>
        ...
        <ContentTemplate>
            <div class="box box-warning">
                <div class="box-header">
                    <h3 class="box-title">
                        Country to Country Transfer</h3>
                </div>
                    ...
                    <div class="rows">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-10">
                                    <asp:DropDownList runat="server" ID="ddlfrmCountry"  CssClass="form-control required width200px"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddlfrmCountry_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-2">
                                    <label>
                                        Select To Country. :</label>
                                </div>
                                <div class="col-md-10">
                                    <asp:DropDownList runat="server" ID="ddlToCountry" CssClass="form-control required width200px"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddlToCountry_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
