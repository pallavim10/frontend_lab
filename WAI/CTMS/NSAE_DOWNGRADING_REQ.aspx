<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NSAE_DOWNGRADING_REQ.aspx.cs" Inherits="CTMS.NSAE_DOWNGRADING_REQ" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">List Of Requests For Downgrading
            </h3>
        </div>
                            ...
                            <div style="width: 100%; overflow: auto;">
                                <asp:GridView ID="grdSAELog" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="align-left">
                                            <HeaderTemplate>
                                                <label>Downgrading Request</label><br />
