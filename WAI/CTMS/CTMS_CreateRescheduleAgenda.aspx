<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CTMS_CreateRescheduleAgenda.aspx.cs" Inherits="CTMS.CTMS_CreateRescheduleAgenda" %>
    ...
    <script type="text/jscript">
        function pageLoad() {
            ...
            $('.txtTime').keypress(function (event) {
                if (event.charCode == 58 || event.keyCode == 8 || event.keyCode == 9 || event.charCode == 48 || event.charCode == 49 || event.charCode == 50 || event.charCode == 51
    ...
    <asp:UpdatePanel ID="Upd_Pan_Sel_Dept" runat="server">
        <ContentTemplate>
                    ...
                    <div>
                        <table>
                            <tr>
                                ...
                                <td class="Control">
                                    <asp:TextBox ID="txtAgendaTime" runat="server" CssClass="form-control txtTime required"></asp:TextBox>
                                </td>
                                <td class="style10">
                                </td>
                                <td class="label">
            ...
            <div class="txt_center">
                <asp:Button ID="btnSubmitAgenda" Text="Update" runat="server" CssClass="btn btn-primary btn-sm cls-btnSave"
