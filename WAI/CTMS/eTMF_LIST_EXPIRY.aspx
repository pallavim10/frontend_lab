<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="eTMF_LIST_EXPIRY.aspx.cs" Inherits="CTMS.eTMF_LIST_EXPIRY" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">
                <asp:Label runat="server" ID="lblHeader" Text="Document Expiry report"></asp:Label>
            </h3>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div runat="server" id="Div2" class="col-md-3">
                    <asp:Label ID="lblViewType" runat="server" Font-Bold="true" Text="Select :"></asp:Label>&nbsp;
    ...
    <asp:GridView ID="gvFiles" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="File Name">
                <ItemTemplate>
                    <asp:Label ID="lbl_UploadFileName" Width="100%" ToolTip='<%# Bind("UploadFileName") %>'
                        CssClass="label" runat="server" Visible="false" Text='<%# Bind("UploadFileName") %>'></asp:Label>
            ...
            <asp:TemplateField HeaderText="Expiry Date">
                <ItemTemplate>
                    <asp:Label ID="ExpiryDate" ToolTip='<%# Bind("ExpiryDate") %>' runat="server" Text='<%# Bind("ExpiryDate") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="No of days for Expiry">
                <ItemTemplate>
                    <asp:Label ID="EXP_DAYS" ToolTip='<%# Bind("EXP_DAYS") %>' runat="server" Text='<%# Bind("EXP_DAYS") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <HeaderTemplate>
