...
namespace CTMS
{
    public partial class User_Unlock_Config : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void lbtnsubmit_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet ds = dal.EMAIL_CONFIG_SP(
                     Action: "INSERT_UPDATE_USER_UNLOCK_DETAILS",
        ...
        protected void lbtnCancel_Click(object sender, EventArgs e)
        {
            try
            {
                Response.Redirect("User_Unlock.aspx");
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        protected void GetEmailDetails()
        {
            try
            {
                DataSet ds = dal.EMAIL_CONFIG_SP(Action: "Get_User_Unlock_Details");
