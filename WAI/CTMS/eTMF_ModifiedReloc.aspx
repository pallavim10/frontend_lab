<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="eTMF_ModifiedReloc.aspx.cs" Inherits="CTMS.eTMF_ModifiedReloc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">
                <asp:Label runat="server" ID="lblHeader" Text="Modified/Relocated Docs"></asp:Label>
            </h3>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div runat="server" id="Div7" class="col-md-3">
                    ...
                    <asp:DropDownList ID="ddlUplodedBy" runat="server" class="form-control drpControl drpwidth"></asp:DropDownList>
                </div>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-md-12">
                ...
                <div runat="server" id="Div12" class="col-md-3">
                    <label class="label">Modified / Relocated:</label>
                    <asp:DropDownList ID="drpModifReloc" runat="server" class="form-control drpControl drpwidth">
                        <asp:ListItem Value="Both" Text="Both"></asp:ListItem>
                        <asp:ListItem Value="Modified" Text="Modified"></asp:ListItem>
                        <asp:ListItem Value="Relocated" Text="Relocated"></asp:ListItem>
                    </asp:DropDownList>
                </div>
    ...
    <asp:GridView ID="gvFiles" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Modified/Relocated">
                <ItemTemplate>
                    <asp:Label ID="ModifReloc" Width="100%" ToolTip='<%# Bind("ModifReloc") %>' runat="server" Text='<%# Bind("ModifReloc") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
