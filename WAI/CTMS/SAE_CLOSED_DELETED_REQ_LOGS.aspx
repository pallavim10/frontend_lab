<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SAE_CLOSED_DELETED_REQ_LOGS.aspx.cs" Inherits="CTMS.SAE_CLOSED_DELETED_REQ_LOGS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title" style="width: 100%;">Closed & Downgraded Request Logs</h3>
        </div>
