...
namespace CTMS
{
    public partial class ETMF_MODI_DEL_DOCS : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void Get_Files()
        {
            try
            {
                ...
                DataSet ds = dal_eTMF.eTMF_DATA_SP(
                ACTION: "GET_MODIFY_DELE_DOCS",
        ...
        private void BIND_DOCUMENTTYPE()
        {
            try
            {
                if (ddlAction.SelectedItem.Text == "Event")
                {
                    ...
                    DataSet ds = dal.eTMF_DATA_SP(ACTION: "get_DocType_Event");
                ...
                {
                    lblViewType.Text = "Select" + " " + ddlAction.SelectedItem.Text + " :";
                    DataSet ds = dal.eTMF_DATA_SP(ACTION: "get_DocType_Milestone");
                ...
                else if (ddlAction.SelectedItem.Text == "eTMF")
                {
                    lblViewType.Text = "Select TMF Model :";
                    DataSet ds = dal.eTMF_DATA_SP(ACTION: "get_DocType");
                    drpDocType.DataSource = ds.Tables[0];
                    drpDocType.DataValueField = "ID";
                    drpDocType.DataTextField = "DocType";
                    drpDocType.DataBind();
        ...
        protected void gvFiles_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    DataSet ds = dal.eTMF_DATA_SP(ACTION: "Download_File", ID: e.CommandArgument.ToString());
