<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RISK_LISTING_DATA.aspx.cs" Inherits="CTMS.RISK_LISTING_DATA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function ViewEventDetails(element, LISTING_ID, FIELDID) {
            ...
            var SUBJID = $(element).closest('tr').find('td:eq(0)').text();
                                ...
                                <div style="width: 100%; overflow: auto;">
                                    <div>
                                        <asp:GridView ID="gridData" HeaderStyle-CssClass="txt_center" runat="server" AutoGenerateColumns="true"
                                            OnPreRender="grd_data_PreRender" OnRowDataBound="gridData_RowDataBound" CssClass="table table-bordered Datatable table-striped notranslate">
                                        </asp:GridView>
                                    </div>
                                </div>
                            </div>
