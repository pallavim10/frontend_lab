<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MM_QUERY_ROUTED.aspx.cs" Inherits="CTMS.MM_QUERY_ROUTED" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Queries Routed from DM</h3>
        </div>
        <div class="lblError">
            ...
            <div class="form-group">
                <div style="overflow: auto;">
                    <asp:GridView ID="grdQUERY" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Take Action" ItemStyle-CssClass="txt_center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnAction" runat="server" ToolTip="Take Action" CommandName="TakeAction" CommandArgument='<%# Bind("ID") %>'><i class="fa fa-edit"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
