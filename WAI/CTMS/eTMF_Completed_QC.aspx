<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="eTMF_Completed_QC.aspx.cs" Inherits="CTMS.eTMF_Completed_QC" %>
    ...
    <div class="box box-warning">
        <div>
            <div class="box-header">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblHeader" Text="QC Approved"></asp:Label>
                </h3>
            </div>
