...
namespace CTMS
{
    public partial class NIWRS_VISIT_DATES : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_VISITS()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "GET_VISIT_DATES", SITEID: ddlSite.SelectedValue, COUNTRYID: ddlCountry.SelectedValue, ENTEREDBY: Session["User_ID"].ToString(),FROMDATE: txtDateFrom.Text,TODATE: txtDateTo.Text);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "GET_VISIT_DATES", SITEID: ddlSite.SelectedValue, COUNTRYID: ddlCountry.SelectedValue, ENTEREDBY: Session["User_ID"].ToString());
                ds.Tables[0].Columns["Participant Id"].ColumnName = Session["SUBJECTTEXT"].ToString();
