<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IWRS_KITS_COUNTRY.aspx.cs" Inherits="CTMS.IWRS_KITS_COUNTRY" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Check_All_Quarantine(element) {
            ...
            $('input[type=checkbox][id*=Chek_Quarantine]').each(function () {
        ...
        function Check_All_Damage(element) {
            ...
            $('input[type=checkbox][id*=Chek_Damage]').each(function () {
                // >>this<< refers to specific checkbox
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                    <HeaderTemplate>
                                        <asp:Button ID="Quarantine" runat="server" CssClass="btn btn-primary btn-sm"
                                            Text="Quarantine" OnClientClick="UpdateSelectedKits(this); return CheckShipmentID(this);" OnClick="btn_Quarantine" />
                                        <br />
                                ...
                                <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                    <HeaderTemplate>
                                        <asp:Button ID="Damage" runat="server" CssClass="btn btn-primary btn-sm"
                                            Text="Damage" OnClientClick="UpdateSelectedKits(this);" OnClick="btn_Damage" />
                                        <br />
                                ...
                                <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                    <HeaderTemplate>
                                        ...
                                        <br />
                                        <asp:CheckBox ID="ChekAll_Retention" GroupName="All" runat="server" onclick="Check_All_Retention(this)" />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:CheckBox ID="Chek_Retention" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                    <HeaderTemplate>
                ...
                <asp:Panel ID="Panel7" runat="server" Style="display: none;" CssClass="Popup1">
                    ...
                    <div class="modal-body" runat="server">
                        <div id="ModelPopupExpire">
                            <div class="row">
                                <div class="col-md-4">
                                    <asp:Label ID="Label9" runat="server" CssClass="wrapperLable" Text="Comments" Style="color: black; font-weight: 600; font-size: 14px;"></asp:Label>
                                </div>
                                <div class="col-md-8">
