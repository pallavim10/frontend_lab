<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmEthicsCommityMember.aspx.cs" Inherits="CTMS.frmEthicsCommityMember" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <div class="box box-primary">
                <div class="box-header">
                    <div>
                    <h3 class="box-title">
                        Add Ethics Committee Team Member
                    </h3></div>

                       <div id="Div2" class="dropdown" runat="server" style="display: inline-flex"><h3 class="box-title">
               <asp:LinkButton runat="server" ID="lbECTeamMemberExport" OnClick="lbECTeamMemberExport_Click" ToolTip="Export to Excel Ethics Committee Details"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <asp:DropDownList ID="ddlEthicsCommity" runat="server" Width="250px" class="form-control drpControl required"
                                        ValidationGroup="View" AutoPostBack="True" OnSelectedIndexChanged="ddlEthicsCommity_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                ...
                <asp:GridView runat="server" ID="gvEmp" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable1"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="START DATE" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label ID="STARTDAT" runat="server" Text='<%# Bind("STARTDAT1") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="END DATE" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label ID="ENDDATE" runat="server" Text='<%# Bind("ENDDATE1") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="lbECTeamMemberExport" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
