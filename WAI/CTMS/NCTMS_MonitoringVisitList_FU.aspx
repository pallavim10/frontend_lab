<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_MonitoringVisitList_FU.aspx.cs" Inherits="CTMS.NCTMS_MonitoringVisitList_FU" %>
                ...
                <div class="box">
                    <asp:GridView runat="server" ID="grdVisits" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Create Follow-Up Letter" HeaderStyle-CssClass="txt_center" ItemStyle-CssClass="txt_center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnCreateFU" ToolTip="Create follow up letter" runat="server" CommandName="CreateFU" CommandArgument='<%# Bind("SVID") %>'><i class="fa fa-edit"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Print Follow-Up Letter" HeaderStyle-CssClass="txt_center" ItemStyle-CssClass="txt_center">
                                <ItemTemplate>
