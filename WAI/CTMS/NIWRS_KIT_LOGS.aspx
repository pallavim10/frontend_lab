<%@  Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NIWRS_KIT_LOGS.aspx.cs" Inherits="CTMS.NIWRS_KIT_LOGS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Kit Number Logs</h3>
           
            <div class="pull-right">
                <a href="#" class="dropdown-toggle btn-info prevent-refresh-button" data-toggle="dropdown" style="color: #FFFFFF">Export Kit Number Logs&nbsp;<span class="glyphicon glyphicon-download"></span></a>
        ...
        <div class="form-group">
            ...
            <div runat="server" id="Div3" style="display: inline-flex">
                <div style="display: inline-flex">
                    ...
                    <div class="Control" style="display: inline-flex">
                        <asp:TextBox ID="Txtkitnumber" runat="server" CssClass="form-control" autocomplete="off"
            ...
            &nbsp&nbsp;&nbsp;
                 <div style="display: inline-flex">
                     <%--<asp:LinkButton runat="server" ID="btnExcel" CssClass="btn btn-info" ForeColor="White"  OnClick="btnExcel_Click">Export to Excel&nbsp;<span class="glyphicon glyphicon-download 2x"></span></asp:LinkButton>--%>
                 </div>
        </div>
        <div class="rows">
            <div class="col_md-12">
