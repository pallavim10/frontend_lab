<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_FOLLOW_UP_ACTION.aspx.cs" Inherits="CTMS.NCTMS_FOLLOW_UP_ACTION" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script>
        function Approved_List(element) {
            ...
            var test = "NCTMS_ADD_FOLLOW_UP_ACTION.aspx?SVID=" + SVID + "&VISIT=" + VISIT + "&VISITID=" + VISITID + "&SITEID=" + SITEID;
