...
namespace CTMS
{
    public partial class Comm_Sent : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void Get_Sent()
        {
            try
            {
                DataSet ds = dal.Communication_SP(Action: "Get_Sent", UserID: Session["User_ID"].ToString(), PROJECTID: Session["PROJECTID"].ToString(), Reference: txtAutoCompText.Text);
