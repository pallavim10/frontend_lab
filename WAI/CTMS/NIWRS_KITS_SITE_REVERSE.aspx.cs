...
namespace CTMS
{
    public partial class NIWRS_KITS_SITE_REVERSE : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_SITE_ORDERS()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_SITE_SP(ACTION: "GET_SITE_SHIPMENTS_REVERSE", COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_SITE_SP(ACTION: "EXPORT_SITE_SHIPMENTS_REVERSE", COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
