...
namespace CTMS
{
    public partial class NIWRS_REPORT_DCF : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_LIST()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "REPORT_BLIND_DCF", SITEID: ddlSite.SelectedValue, FROMDATE: txtDateFrom.Text, TODATE: txtDateTo.Text);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "REPORT_BLIND_DCF", SITEID: ddlSite.SelectedValue, SUBSITEID: ddlSubSite.SelectedValue);
                ds.Tables[0].Columns["Participant Id"].ColumnName = Session["SUBJECTTEXT"].ToString();
