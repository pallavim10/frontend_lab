<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CTMS_CRA_ProjectTimeline.aspx.cs" Inherits="CTMS.CTMS_CRA_ProjectTimeline" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Print() {
            if ($("#<%=ddl_INVID.ClientID%>").val() == "99") {
                $("#<%=ddl_INVID.ClientID%>").addClass("brd-1px-redimp");
                return false;
            }

            var ProjectId = '<%= Session["PROJECTID"] %>'
            var Action = "get_CRA_project_Plans_Data";
            var INVID = $("#<%= ddl_INVID.ClientID %>").val();
    ...
    <script type="text/javascript">
        ...
        function ShowAudit(element) {
            ...
            var Action = "Get_Audit_Trail_CRA";
            $.ajax({
                type: "POST",
                url: "AjaxFunction.aspx/BudgetPP_Audit_Trail_CRA",
                data: '{Action:"' + Action + '",INVID: "' + $('#<%=ddl_INVID.ClientID%>').val() + '", Task_ID: "' + $('#<%=txtTaskID.ClientID%>').val() + '", Sub_Task_ID: "' + $('#<%=txt_SubtaskID.ClientID%>').val() + '" ,FieldName: "' + $('#<%=txt_FieldName.ClientID%>').val() + '",TableName: "' + $('#<%=txt_TableName.ClientID%>').val() + '",VariableName: "' + $('#<%=txt_VariableName.ClientID%>').val() + '",OldValue: "' + $('#<%=txt_OldValue.ClientID%>').val() + '",NewValue: "' + $('#<%=txt_NewValue.ClientID%>').val() + '",Reason: "' + $('#<%=drp_Reason.ClientID%>').val() + '",Comments: "' + $('#<%=txt_Comments.ClientID%>').val() + '",AutoId: "' + $('#<%=hdn_AutoId.ClientID%>').val() + '"}',
        ...
        function BudgetPP_UpdateData() {
            ...
            var Action = "Audit_trail_BudgetPP_CRA";
        ...
        function BudgetPP_CancelUpdate() {
            ...
            $("#popup_BudgetUpdateData1").dialog('close');
            window.location = window.location;
        ...
        function BudgetPPFunction(element) {
            ...
            if (hdnValue == elementValue) {
                ...
                $('#<%=popup_BudgetUpdateData1.ClientID%>').dialog({
                    title: "Update Data",
                    width: 700,
                    height: "auto",
                    modal: true
                ...
                $('#<%=popup_BudgetUpdateData1.ClientID%>').dialog("open");
                return false;
    ...
    <script type="text/javascript">
        function UploadDoc(element) {
            ...
            var test = "eTMF_UploadDocument.aspx?TaskID=" + TaskID + "&SubTaskID=" + SubTaskID + "&INVID=" + INVID + "&ID=" + ID;
        ...
        function DownloadDoc(element) {
            ...
            var test = "CTMS_DownloadDoc.aspx?TaskID=" + TaskID + "&SubTaskID=" + SubTaskID + "&INVID=" + INVID;
        ...
        function AddComment(element) {
            ...
            var test = "CTMS_TimeLineComment.aspx?TaskID=" + TaskID + "&SubTaskID=" + SubTaskID + "&INVID=" + INVID + "&Comment=" + Comment + "&ID=" + ID;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
      ...
      <span class="glyphicon glyphicon-print"></span>Print</asp:LinkButton>
            ...
            <div class="form-group">
                ...
                <table>
                    <tr>
                        ...
                        <td class="style10">
                            <asp:LinkButton ID="lbtnSync" Visible="false" runat="server" Style="margin-left: 20px;"
                                OnClick="lbtnSync_Click"> <i class="fa fa-2x fa-refresh" style="color: #333333;" title="Refresh"></i> </asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div id="popup_FieldComments1" title="Comments" class="disp-none">
            <div id="grdQueryDetails" class="">
            </div>
        </div>
        <div id="popup_BudgetUpdateData1" runat="server" title="Reason For Change" class="disp-none">
            <div class="disp-none">
                                                        ...
                                                        <asp:TemplateField HeaderText="Plan Date" ItemStyle-CssClass="txt_center" ItemStyle-Width="10%">
                                                            <ItemTemplate>
                                                                <asp:TextBox Style="text-align: center;" ID="txtDtPlan" Text='<%# Bind("DtPlan1") %>'
                                                                    ...
                                                                    onchange="BudgetPPFunction(this)" Tablename="CTMS_CRA_ProjectTimeline" FieldName="Plan Date"
                                                        ...
                                                        <asp:TemplateField HeaderText="" ItemStyle-Width="2%">
                                                            <ItemTemplate>
                                                                <asp:Image src="Images/Audit_Trail.png" ID="AuditTrailPlanDate" Height="16" Width="16"
                                                                    runat="server" class="Raise  Comments" title="Audit Trail" Tablename="CTMS_CRA_ProjectTimeline"
                                                        ...
                                                        <asp:TemplateField HeaderText="Actual Date" ItemStyle-CssClass="txt_center" ItemStyle-Width="10%">
                                                            <ItemTemplate>
                                                                <asp:TextBox Style="text-align: center; display: inline-flex" ID="txtDtActual" Text='<%# Bind("DtActual1") %>'
                                                                    runat="server" class=" txt_center form-control txtDate" onfocus="BudgetPPFocus(this)"
                                                                    onchange="BudgetPPFunction(this)" Tablename="CTMS_CRA_ProjectTimeline" FieldName="Actual Date"
                                                        ...
                                                        <asp:TemplateField HeaderText="" ItemStyle-Width="2%">
                                                            <ItemTemplate>
                                                                <asp:Image src="Images/Audit_Trail.png" Style="display: inline-flex" ID="AuditTrailAcualDate"
                                                                    ...
                                                                    Visible="false" Tablename="CTMS_CRA_ProjectTimeline" FieldName="Actual Date"
                                                                    VariableName="DtActual" onclick="ShowAudit(this)" />
