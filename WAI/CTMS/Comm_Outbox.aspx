<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Comm_Outbox.aspx.cs" Inherits="CTMS.Comm_Outbox" %>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="list-group" style="padding-left: 0px;">
                        <asp:Repeater runat="server" ID="repeatOutbox" OnItemCommand="repeatOutbox_ItemCommand"
                            OnItemDataBound="repeatOutbox_ItemDataBound">
                            <ItemTemplate>
                                <div class="row list-group-item" runat="server" id="divMailItem">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-1">
                                            <asp:LinkButton runat="server" ToolTip="Resend Mail" CommandArgument='<%# Bind("ID") %>'
                                                CommandName="Resend" ID="lbtnResend">
