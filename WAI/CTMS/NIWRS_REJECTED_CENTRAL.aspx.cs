...
namespace CTMS
{
    public partial class NIWRS_REJECTED_CENTRAL : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_KITS()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_CENTRAL_SP(ACTION: "GET_REJECTED_CENTRAL", COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_CENTRAL_SP(ACTION: "GET_REJECTED_CENTRAL_EXPORT", COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
                ...
                for (int i = 0; i < gvKits.Rows.Count; i++)
                {
                    ...
                    if (Chek_Expire.Checked)
                    {
                        dal_IWRS.IWRS_KITS_CENTRAL_SP(
                            ACTION: "CENTRAL_REJECTED_EXPIRE",
                            KITNO: KITNO,
