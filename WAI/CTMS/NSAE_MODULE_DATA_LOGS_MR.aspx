<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NSAE_MODULE_DATA_LOGS_MR.aspx.cs" Inherits="CTMS.NSAE_MODULE_DATA_LOGS_MR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="box-header" style="display: inline-flex; width: 100%;">
            ...
            <div class="pull-right" style="margin-top: 3px;">
                <div style="display: inline-flex;">
                    ...
                    <asp:Button ID="btnCloseSAE" runat="server" Text="Close SAE" CssClass="btn btn-sm btn-danger"
            ...
            <div class="box">
                <asp:GridView ID="Grd_OpenCRF" runat="server" AutoGenerateColumns="False" OnRowDataBound="Grd_OpenCRF_RowDataBound"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Internal Comment" ItemStyle-CssClass="txt_center">
                            <ItemTemplate>
    ...
    <cc2:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnlCloseSAE" TargetControlID="lnkReason"
        BackgroundCssClass="Background" BehaviorID="modalpnlCloseSAE">
    </cc2:ModalPopupExtender>
    <asp:Panel ID="pnlCloseSAE" runat="server" Style="display: none;" CssClass="Popup1">
        <asp:Button runat="server" ID="lnkReason" Style="display: none" />
        <h5 class="heading">Reason for SAE Closer</h5>
        <div class="modal-body" runat="server">
            <div id="ModelPopup2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:Button ID="btnSubmitClosedSAE" runat="server" Style="margin-left: 37px; height: 34px; width: 71px; font-size: 14px;" CssClass="btn btn-DarkGreen btn-sm cls-btnSave"
                            Text="Submit" OnClick="btnSubmitClosedSAE_Click" />
                        &nbsp;
                            &nbsp;
    ...
    <asp:Panel ID="pnlSAESupportdoc" runat="server" Style="display: none;" CssClass="Popup2">
        ...
        <div class="modal-body2" runat="server" style="height: 420px;">
            <div class="col-md-12">
