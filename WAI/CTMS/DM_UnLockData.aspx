<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DM_UnLockData.aspx.cs" Inherits="CTMS.DM_UnLockData" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function countCheckboxes() {
            ...
            if (count < 1) {
                alert("Select at least one data to Generate UnLock Request");
        ...
        function Check_child(element) {
            ...
            $(element).closest('tr').next().find('td').find('table').find('input[type=checkbox][id*=Chkchild_UnLockYN]').each(function () {
        ...
        function Check_All(element) {
            $('input[type=checkbox][id*=Chk_UnLockYN]').each(function () {
                if ($(element).prop('checked') == true) {
                    $(this).prop('checked', true);
                }
                else {
            ...
            $('input[type=checkbox][id*=Chkchild_UnLockYN]').each(function () {
                if ($(element).prop('checked') == true) {
                    $(this).prop('checked', true);
                }
                else {
        ...
        function VIEW_DM_DATA(element) {
            ...
            if ((($(element).closest('table').attr('id')).indexOf('Gridchild') != -1)) {
                ...
                MODULENAME = $(element).closest('table').closest('tr').prev().find('td:eq(15)').find('span').text();
            }
            else {
                ...
                MODULENAME = $(element).closest('tr').find('td:eq(15)').find('span').text();
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Generate UnLock Request
            </h3>
        </div>
        <div class="lblError">
        ...
        <div class="box-body">
            <div class="form-group ">
                ...
                <div style="width: 100%; overflow: auto; padding-top: 10px;">
                    <asp:GridView ID="Grd_unlock" runat="server" AutoGenerateColumns="False" CellPadding="3" HeaderStyle-ForeColor="Blue"
                        CssClass="table table-bordered table-striped" CellSpacing="2" OnRowDataBound="Grd_unlock_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField ItemStyle-CssClass="txt_center">
                                <HeaderTemplate>
                                    <asp:Button ID="Btn_Update" runat="server" OnClick="Btn_Update_Click" CssClass="btn btn-primary btn-sm cls-btnSave1"
                                        Text="Data UnLock YN" OnClientClick="return countCheckboxes();" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:CheckBox ID="Chk_UnLockYN" runat="server" onclick="Check_child(this)" />
                                </ItemTemplate>
                            </asp:TemplateField>
                                            ...
                                            <div id="PVID1<%# Eval("PVID") %>" style="display: none; position: relative; overflow: scroll;">
                                                <div class="box">
                                                    <div style="width: 100%; overflow: scroll;">
                                                        <asp:GridView ID="Gridchild" runat="server" CellPadding="4" AutoGenerateColumns="false" CssClass="table table-bordered table-striped"
                                                            HeaderStyle-ForeColor="Maroon" OnRowDataBound="Gridchild_RowDataBound">
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="PVID" HeaderStyle-CssClass="disp-none" ItemStyle-CssClass="disp-none">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblPVID" runat="server" Text='<%# Bind("PVID") %>'></asp:Label>
                                                                ...
                                                                <asp:TemplateField ItemStyle-CssClass="txt_center" HeaderStyle-Width="50px">
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="Chkchild_UnLockYN" CssClass="freezcheck" runat="server" />
