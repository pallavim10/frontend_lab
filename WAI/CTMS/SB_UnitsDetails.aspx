<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SB_UnitsDetails.aspx.cs" Inherits="CTMS.SB_UnitsDetails" %>
                ...
                <table>
                    <tr>
                        ...
                        <td class="requiredSign">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_INVID" runat="server" InitialValue="99" ControlToValidate="ddl_Site"
                                ValidationGroup="View"></asp:RequiredFieldValidator>
                        </td>
                        <td class="Control">
                            <asp:DropDownList ID="ddl_Site" Style="text-align: center;" runat="server" Width="100%"
                                                    ...
                                                    <asp:GridView ID="gvRates" runat="server" OnRowDataBound="gvRates_RowDataBound" AutoGenerateColumns="false"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderStyle-CssClass="disp-none" ItemStyle-CssClass="disp-none"
                                                                HeaderText="ID">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbl_VisitID" runat="server" Text='<%# Bind("Visit_ID") %>'></asp:Label>
                                                                    <asp:HiddenField ID="hf_VisitID" runat="server" Value='<%# Bind("Visit_ID") %>' />
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderStyle-CssClass="disp-none" ItemStyle-CssClass="disp-none"
                                                                HeaderText="ID">
