<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SAE_Internal_Comment.aspx.cs" Inherits="CTMS.SAE_Internal_Comment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title" style="width: 100%;">SAE Internal Comment Report</h3>
        </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div runat="server" id="divSAEID" style="display: inline-flex">
                            ...
                            <div class="Control">
                                <asp:DropDownList ID="drpSAEID" runat="server" CssClass="form-control required" OnSelectedIndexChanged="drpSAEID_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
