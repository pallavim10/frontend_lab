...
namespace CTMS
{
    public partial class CTMS_RolesTraining : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void drpRole_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                DataSet ds = dal.Budget_SP(Action: "GET_ROLE_TRAINING_Main", Project_Id: Session["PROJECTID"].ToString(), Role_ID: drpRole.SelectedValue);
        ...
        protected void gvMain_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    DataSet ds = dal.Budget_SP(Action: "GET_ROLE_TRAINING", Project_Id: Session["PROJECTID"].ToString(), Role_ID: drpRole.SelectedValue, Task_ID: Task_ID);
