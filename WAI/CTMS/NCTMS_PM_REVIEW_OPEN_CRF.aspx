<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_PM_REVIEW_OPEN_CRF.aspx.cs" Inherits="CTMS.NCTMS_PM_REVIEW_OPEN_CRF" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script>
        ...
        function VIEW_ALL_COMMENT(element) {
            ...
            var test = "NCTMS_ViewComments.aspx?Section=" + VISIT + "&ProjectId=" + PROJECTID + "&INVID=" + INVID + "&SVID=" + SVID + "&SectionID=" + VISITID + "&SubSectionID=" + MODULEID + "&MODULENAME=" + MODULENAME + "&ACTION=PM";
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header" style="display: inline-flex; width: 100%;">
            ...
            <div align="right">
                <asp:Button ID="btnPMFinal" runat="server" Text="Final" CssClass="btn btn-DarkGreen btn-sm"
                    OnClick="btnPMFinal_Click" />&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnSendToSponsor" runat="server" Text="Send To Sponsor Review" CssClass="btn btn-danger btn-sm"
                    OnClick="btnSendToSponsor_Click" />&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnReturnToCRA" runat="server" Text="Return To CRA" CssClass="btn btn-DARKORANGE btn-sm"
                    OnClick="btnReturnToCRA_Click" />&nbsp;&nbsp;&nbsp;
            </div>
        </div>
        <div class="box-body">
