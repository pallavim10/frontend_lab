<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_REPORT_DCF.aspx.cs" Inherits="CTMS.NIWRS_REPORT_DCF" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">
                <asp:Label runat="server" ID="lblHeader" Text="Corrected/Rejected DCF"></asp:Label>
            </h3>
            ...
            <div class="pull-right">
                ...
                <a href="#" class="dropdown-toggle btn-info prevent-refresh-button" data-toggle="dropdown" style="color: #FFFFFF">Export Corrected/Rejected DCF&nbsp;<span class="glyphicon glyphicon-download"></span></a>
