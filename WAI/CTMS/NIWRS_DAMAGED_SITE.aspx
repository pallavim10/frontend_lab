<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_DAMAGED_SITE.aspx.cs" Inherits="CTMS.NIWRS_DAMAGED_SITE" %>
    ...
    <div class="box box-warning">
        ...
        <div class="form-group">
            ...
            <div class="rows">
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="gvKits" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="KITNO">
                                    <ItemTemplate>
                ...
                <br />
                <cc2:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="Panel2" TargetControlID="Button_Return"
                    BackgroundCssClass="Background">
                ...
                <br />
                <cc3:ModalPopupExtender ID="ModalPopupExtender3" runat="server" PopupControlID="Panel3" TargetControlID="Button_Destroy"
                    BackgroundCssClass="Background">
