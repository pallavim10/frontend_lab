...
namespace CTMS
{
    public partial class RiskIndicators : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void Get_Dashboard()
        {
            try
            {
                DataSet ds1 = dal.Risk_Indicator_SP(Action: "GET_Risk_Indicator_Tiles", Cat1: drpCategory.SelectedItem.Text);

                repeatTiles.DataSource = ds1;
        ...
        private void POST_ISSUE_PROJECT(string IndicId)
        {
            try
            {
                dal.Risk_Indicator_SP(Action: "POST_ISSUE_PROJECT", ID: IndicId, Result: Session["User_ID"].ToString());
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        private void POST_ISSUE_COUNTRY(string IndicId)
        {
            try
            {
                dal.Risk_Indicator_SP(Action: "POST_ISSUE_COUNTRY", ID: IndicId, Result: Session["User_ID"].ToString());
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        private void POST_ISSUE_SITE(string IndicId)
        {
            try
            {
                dal.Risk_Indicator_SP(Action: "POST_ISSUE_SITE", ID: IndicId, Result: Session["User_ID"].ToString());
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        private void UPDATE_NON_POSTED(string IndicId, string Level)
        {
            try
            {
                dal.Risk_Indicator_SP(Action: "UPDATE_NON_POSTED", ID: IndicId, Result: Level);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        protected void gvRiskIndic_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    {
                        ds = dal.Dashboard_SP(Action: Method, Project_ID: Session["PROJECTID"].ToString(), User_ID: Session["User_ID"].ToString());
                    }
                            ...
                            if (dr["L1"].ToString() != "" && dr["L2"].ToString() != "")
                            {
                                ...
                                if (L1 > L2)
                                {
                                    ...
                                    else if (value <= L2)
                                    {
                                        ...
                                        if (dr["PostedC"].ToString() != "True")
                                        {
                                            POST_ISSUE_PROJECT(ID);
                                        }
                                    }
                                }
                                else
        ...
        protected void gvCountryAlerts_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    DataSet ds = dal.Risk_Indicator_SP(Action: "Triggered_Indicators_Country");
        ...
        protected void gvCountryRiskIndic_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    {
                        ds = dal.Dashboard_SP(Action: Method, Project_ID: Session["PROJECTID"].ToString(), COUNTRYID: Session["RiskIndicCOUNTRYID"].ToString(), INVID: "All", User_ID: Session["User_ID"].ToString());
                    }
                                ...
                                if (CL1 > CL2)
                                {
                                    if (value >= CL1)
                                    {
                                        ...
                                        if (dr["CLV0"].ToString() != "")
                                        {
                                            ...
                                            if (dr["CLV0"].ToString() == "5")
                                            {
                                                X += 1;
                                            }
                                            else if (dr["CLV0"].ToString() == "10")
                                            {
                                                Y += 1;
                                            }
                                            else if (dr["CLV0"].ToString() == "15")
                                            {
                                                Z += 1;
                                            }
                                        }
                                    ...
                                    else if (value <= CL1 && value >= CL2)
                                    {
                                        ...
                                        if (dr["CLV1"].ToString() != "")
                                        {
                                            ...
                                            if (dr["CLV1"].ToString() == "-5")
                                            {
                                                A += 1;
                                            }
                                            else if (dr["CLV1"].ToString() == "-10")
                                            {
                                                B += 1;
                                            }
                                            else if (dr["CLV1"].ToString() == "-15")
                                            {
                                                C += 1;
                                            }
                                            else if (dr["CLV1"].ToString() == "-20")
                                            {
                                                D += 1;
                                            }
                                            else if (dr["CLV1"].ToString() == "-25")
                                            {
                                                E += 1;
                                            }
                                        }
                                    ...
                                    else if (value <= CL2)
                                    {
                                        ...
                                        if (dr["CLV2"].ToString() != "")
                                        {
                                            ...
                                            if (dr["CLV2"].ToString() == "-5")
                                            {
                                                A += 1;
                                            }
                                            else if (dr["CLV2"].ToString() == "-10")
                                            {
                                                B += 1;
                                            }
                                            else if (dr["CLV2"].ToString() == "-15")
                                            {
                                                C += 1;
                                            }
                                            else if (dr["CLV2"].ToString() == "-20")
                                            {
                                                D += 1;
                                            }
                                            else if (dr["CLV2"].ToString() == "-25")
                                            {
                                                E += 1;
                                            }
                                        }
