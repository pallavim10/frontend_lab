...
namespace CTMS
{
    public partial class NIWRS_KITS_COUNTRY_ORDER : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_TREATMENT()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_CENTRAL_SP(ACTION: "GET_TREATMENT_CENTRAL");
        ...
        private void GET_KITS_COUNTRY_ORDER()
        {
            try
            {
                ...
                for (int i = 0; i < repeatTreat.Items.Count; i++)
                {
                    ...
                    if (txtNoKits.Text != "")
                    {
                        DataSet dsKits = dal_IWRS.IWRS_KITS_COUNTRY_SP(ACTION: "GET_KITS_COUNTRY_ORDER", TREAT_GRP: lblTreatment.Text, KITNO: txtNoKits.Text);
                ...
                if (kits)
                {
                    ds = dal_IWRS.IWRS_KITS_COUNTRY_SP(ACTION: "GET_KITS_COUNTRY_ORDER", TREAT_GRP: "0", KITNO: "");
                }
        ...
        private void GET_NEW_ORDERID()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_COUNTRY_SP(ACTION: "GET_NEW_ORDERID", COUNTRYID: ddlCountry.SelectedValue);
        ...
        private void SEND_MAIL()
        {
            try
            {
                ...
                DataSet ds = dal_IWRS.IWRS_SET_EMAIL_SP(ACTION: "GET_EMAILS", STRATA: "KIT_CENTRAL");
                ...
                DataSet dsEmail = dal_IWRS.IWRS_SET_EMAIL_SP(ACTION: "GET_EMAIL_TEMPLATE", STRATA: "NIWRS_KITS_COUNTRY_ORDER");
