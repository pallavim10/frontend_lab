<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NCTMS_AddChecklistComments_SPONSOR.aspx.cs"
    Inherits="CTMS.NCTMS_AddChecklistComments_SPONSOR" %>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row" id="divCRACOMMENT" runat="server" visible="false">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" ID="txtCRAComments" CssClass="ckeditor required" Height="10%" Enabled="false"
                        ...
                        <div class="row" id="divSPONSORCOMMENT" runat="server">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox runat="server" ID="txtSponsorComment" CssClass="ckeditor required" 
                                        Height="10%" TextMode="MultiLine" Width="99%"></asp:TextBox>
                                </div>
                            </div>
                        </div>
