<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ePRO_CESYS_List.aspx.cs" Inherits="CTMS.ePRO_CESYS_List" %>
        ...
        <div class="box-header">
            <h3 class="box-title" style="width: 100%;">
                <asp:Label ID="lblHeader" runat="server" Font-Size="12px" Font-Bold="true" Font-Names="Arial"
                    Text="Recorded Systemic Solicited Events"></asp:Label>
            </h3>
        </div>
        <asp:HiddenField ID="hdncount" runat="server" />
        <asp:HiddenField ID="hdnday0" runat="server" />
        <asp:HiddenField ID="hdnday1" runat="server" />
        <asp:HiddenField ID="hdnday2" runat="server" />
        <asp:HiddenField ID="hdnday3" runat="server" />
        <asp:HiddenField ID="hdnday4" runat="server" />
        <asp:HiddenField ID="hdnday5" runat="server" />
        <asp:HiddenField ID="hdnday6" runat="server" />
        <asp:HiddenField ID="hdnday7" runat="server" />
