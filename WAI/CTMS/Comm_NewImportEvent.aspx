<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Comm_NewImportEvent.aspx.cs" Inherits="CTMS.Comm_NewImportEvent" %>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtFromID" ReadOnly="true" CssClass="form-control required"
                                Width="100%"></asp:TextBox>
                        </div>
                        <div class="label col-md-1">
                            To
                        ...
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtToID" CssClass="form-control required" Width="100%"
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtCcID" CssClass="form-control" Width="100%" ReadOnly="true"></asp:TextBox>
                        </div>
                        <div class="label col-md-1">
                            Bcc
                        </div>
                        <div class="col-md-4">
                            <asp:TextBox runat="server" ID="txtBccID" CssClass="form-control" Width="100%" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <asp:TextBox runat="server" ID="txtSubject" CssClass="form-control required" Width="100%"
                                ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <asp:FileUpload ID="fileAttach" runat="server" Font-Size="X-Small" Enabled="false" />
                        </div>
                        <div class="label col-md-1">
                            Importance
                        </div>
                        ...
                        <div class="label col-md-2">
                            <asp:CheckBox runat="server" ID="chkFlag" Enabled="false" />&nbsp;&nbsp; Flag
                        </div>
                        <div class="label col-md-2">
                            <asp:CheckBox runat="server" ID="chkEvent" Enabled="false" />&nbsp;&nbsp; Event
                        </div>
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <asp:TextBox runat="server" ID="txtBody" ReadOnly="true" CssClass="ckeditor" Height="50px"
                ...
                <div class="row">
                    <div style="margin-left: 25%;">
                        <asp:LinkButton runat="server" ID="lbtnSend" Text="Save" ForeColor="White" CssClass="btn btn-primary btn-sm cls-btnSave"
