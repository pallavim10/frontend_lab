<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NIWRS_KITS_CENTRAL_REC.aspx.cs" Inherits="CTMS.NIWRS_KITS_CENTRAL_REC" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript" src="CommonFunctionsJs/IWRS/IWRS_Kit_Checkbox.js"></script>
    ...
    <div class="box box-warning">
        <div class="box-header">
            ...
            <div class="pull-right">
                <asp:LinkButton runat="server" ID="btnExport" OnClick="btnExport_Click" Font-Size="12px" Style="margin-top: 3px;" CssClass="btn btn-info" ForeColor="White">Export Receive Orders&nbsp;<span class="glyphicon glyphicon-download 2x"></span></asp:LinkButton>
                &nbsp;&nbsp;
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <asp:GridView ID="gvOrders" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                        CssClass="table table-bordered table-striped txt_center" OnRowCommand="gvOrders_RowCommand" OnRowDataBound="gvOrders_RowDataBound">
                        <Columns>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td colspan="100%" style="padding: 2px; padding-left: 4%;">
                                            <div style="float: right; font-size: 13px;"></div>
                                            <div>
                                                <div id="_ORDER_<%# Eval("ORDERID") %>" style="display: none; position: relative; overflow: auto;">
                                                    <asp:GridView ID="gvKits" runat="server" CellPadding="3" AutoGenerateColumns="False" CssClass="table table-bordered table-striped table-striped1 Datatable" OnPreRender="gvOrders_PreRender">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                                                <HeaderTemplate>
                                                                    <asp:Button ID="Quarantine" runat="server" CssClass="btn btn-primary btn-sm" Text="Quarantine" OnClientClick="UpdateSelectedKits(this); return CheckShipmentID(this);" OnClick="btn_Quarantine" />
                                                                    <br />
                                                                    <asp:CheckBox ID="ChekAll_Quarantine" GroupName="All" runat="server" onclick="Check_All_Quarantine(this)" />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                                                <HeaderTemplate>
                                                                    <asp:Button ID="Block" runat="server" CssClass="btn btn-primary btn-sm" Text="Block" OnClientClick="UpdateSelectedKits(this); return CheckShipmentID(this);" OnClick="btn_Block" />
                                                                    <br />
                                                                    <asp:CheckBox ID="ChekAll_Block" GroupName="All" runat="server" onclick="Check_All_Block(this)" />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                                                <HeaderTemplate>
                                                                    <asp:Button ID="Damage" runat="server" CssClass="btn btn-primary btn-sm" Text="Damage" OnClientClick="UpdateSelectedKits(this);return CheckShipmentID(this);" OnClick="btn_Damage" />
                                                                    <br />
                                                                    <asp:CheckBox ID="ChekAll_Damage" GroupName="All" runat="server" onclick="Check_All_Damage(this)" />
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                ...
                <div class="modal-body" runat="server">
                    <div id="ModelPopupDamage">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <asp:Button ID="btnSubmitDamage" runat="server" Style="margin-left: 37px; height: 34px; width: 71px; font-size: 14px;" ValidationGroup="DamageCommnet" CssClass="btn btn-DarkGreen" OnClientClick="return Check_DamageReasonEntered();" Text="Submit" OnClick="btnSubmitDamage_Click" />
                                &nbsp;&nbsp;
                            <asp:Button ID="btnCancelDamage" runat="server" Text="Cancel" ValidationGroup="DamageCommnet" CssClass="btn btn-DarkGreen" Style="height: 34px; width: 71px; font-size: 14px;" OnClick="btnCancelDamage_Click" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <asp:ModalPopupExtender ID="modalpopupACCEPT" runat="server" PopupControlID="Panel6" TargetControlID="Button_ACCEPT"
                BackgroundCssClass="Background">
            </asp:ModalPopupExtender>
                ...
                <div class="modal-body" runat="server">
                    <div id="ModelPopupACCEPT">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <asp:Button ID="btnSubmitACCEPT" runat="server" Style="margin-left: 37px; height: 34px; width: 71px; font-size: 14px;" ValidationGroup="AcceptComment" CssClass="btn btn-DarkGreen" Text="Submit" OnClick="btnSubmitACCEPT_Click" OnClientClick="return Check_AcceptComments();" />
                                &nbsp;&nbsp;
