...
namespace CTMS
{
    ...
    public partial class eTMF_QC_DISAPPROVED : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void Get_Files()
        {
            try
            {
                ...
                ACTION: "GET_QC_DIS_APPROVED_REPORT",
        ...
        protected void gvFiles_PreRender(object sender, EventArgs e)
        {
            try
            {
        ...
        protected void gvFiles_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    LinkButton lbtntakeAction = (LinkButton)e.Row.FindControl("lbtntakeAction");
