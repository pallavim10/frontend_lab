    ...
    public partial class UnlockUser : System.Web.UI.Page
    {
        ...
        protected void Btn_Update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "alert('User Unlocked successfully'); window.location='UnlockUser.aspx';", true);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = "";
        ...
        protected void SendEmail(string User_Name, string Email_ID)
        {
            try
            {
                ...
                cmd5.Parameters.AddWithValue("@Email_Type", "UserUnlock");
                ...
                EmailAdd = Email_ID;
                E_Sub = "Protocol Id - " + Drp_Project_Name.SelectedItem.Text.ToString() + " : User Unlocked ";
                ...
                E_Body = "Hi " + Drp_User.SelectedItem.Text + ", Your Login Password: " + PWD + " ";
