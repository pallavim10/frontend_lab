...
namespace CTMS
{
    public partial class NIWRS_LIST : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_LIST()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_LIST_SP(ACTION: "GET_LIST", ID: Request.QueryString["STEPID"].ToString());
                if (ds.Tables[0].Rows.Count > 0)
                {
        ...
        private void GET_LIST_DETAILS(string SOURCE_ID)
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_LIST_SP(ACTION: "GET_LIST_DETAILS", LISTID: SOURCE_ID, COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue, SUBSITEID: ddlSubSite.SelectedValue, ENTEREDBY: Session["User_ID"].ToString());
        ...
        private void GET_SITE()
        {
            try
            {
                DataSet ds = dal.GET_INVID_SP(USERID: Session["User_ID"].ToString(), COUNTRYID: ddlCountry.SelectedValue);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet dsLIST = dal_IWRS.IWRS_LIST_SP(ACTION: "GET_LIST", ID: Request.QueryString["STEPID"].ToString());
                DataSet ds = dal_IWRS.IWRS_LIST_SP(ACTION: "GET_LIST_DETAILS", LISTID: dsLIST.Tables[0].Rows[0]["SOURCE_ID"].ToString(), SITEID: ddlSite.SelectedValue, COUNTRYID: ddlCountry.SelectedValue, ENTEREDBY: Session["User_ID"].ToString());
                ds.Tables[0].Columns["Screening Id"].ColumnName = Session["SUBJECTTEXT"].ToString();
