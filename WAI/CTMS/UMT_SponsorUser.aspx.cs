    ...
    public partial class UMT_SponsorUser : System.Web.UI.Page
    {
        ...
        protected void lbtnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "alert('Sponsor User Created Successfully');  window.location.href = 'UMT_SponsorUser.aspx';", true);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void lbnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Sponsor User Updated Successfully'); window.location.href = 'UMT_SponsorUser.aspx';", true);
                }
            }
            catch (Exception ex)
            {
        ...
        private void DELETE_USER(string ID)
        {
            try
            {
                ...
                Response.Write("<script> alert('User deleted Successfully'); window.location.href = 'UMT_SponsorUser.aspx';</script>");
                GET_USER();
            }
            catch (Exception ex)
            {
