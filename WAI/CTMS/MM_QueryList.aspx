<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="MM_QueryList.aspx.cs" Inherits="Risk_Management.QueryList" %>
            ...
            <div class="form-group">
                <div style="overflow: auto;">
                    <asp:GridView ID="grdQUERY" runat="server" AutoGenerateColumns="False"
                        ...
                        CellPadding="4" CellSpacing="2" OnRowCommand="grdQUERY_RowCommand"
                        OnRowDataBound="grdQUERY_RowDataBound" Width="100%">
                        <Columns>
                            <asp:TemplateField HeaderText="Change Query Text">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    ...
                                    <label style="color: green; font-weight: lighter; margin-bottom: 0px;">[Datetime(Server)]</label><br />
                                    <label style="color: red; font-weight: lighter; margin-bottom: 0px;">[Datetime(User), (Timezone)]</label><br />
                                    <label style="color: orange; font-weight: lighter; margin-bottom: 0px;">[Reason for Delete]</label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div runat="server" id="divDELETE">
                                        ...
                                        <div>
                                            <asp:Label ID="DELETED_COMMENTS" runat="server" Text='<%# Bind("DELETED_COMMENTS") %>' ForeColor="Orange"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="txt_center">
                                        <asp:LinkButton ID="lbldeletequery" runat="server" CommandName="DELETEQUERY" ToolTip="Delete Query" CommandArgument='<%# Bind("ID") %>'><i class="fa fa-trash"></i></asp:LinkButton>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
