...
namespace CTMS
{
    public partial class NIWRS_VISIT_FORECAST : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_VISITS()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "GET_VISIT_FORECAST", SITEID: ddlSite.SelectedValue, ENTEREDBY: Session["User_ID"].ToString());
