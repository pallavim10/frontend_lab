<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="eTMF_QC_DISAPPROVED.aspx.cs" Inherits="CTMS.eTMF_QC_DISAPPROVED" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function TakeActionQCFailed(element) {

            var DocID = $(element).closest('tr').find('td:eq(0)').find('span').text();

            var test = "eTMF_DiSAPP_MODIFY.aspx?ID=" + DocID;
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div>
            <div class="box-header">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblHeader" Text="QC Rejected"></asp:Label>
                </h3>
            </div>
    ...
    <asp:GridView ID="gvFiles" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="lbtntakeAction" runat="server" OnClientClick="return TakeActionQCFailed(this)" CommandArgument='<%# Bind("ID") %>'>Take Action </asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
