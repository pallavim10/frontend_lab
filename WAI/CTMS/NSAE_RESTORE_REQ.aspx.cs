...
namespace CTMS
{
    public partial class NSAE_RESTORE_REQ : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            try
            {
                DataSet ds = dal_SAE.SAE_STATUS_LIST_SP(ACTION: "GET_PENDING_RESTORE_REQ_LIST",
        ...
        protected void grdSAELog_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "EditSAE")
                {
                    ...
                    Response.Redirect("NSAE_RESTORE_REQ_LIST.aspx?SAEID=" + SAEID, false);
                }
            }
            catch (Exception ex)
            {
