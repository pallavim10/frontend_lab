...
namespace CTMS
{
    public partial class NSAE_CLOSED_SAE : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            try
            {
                DataSet ds = dal_SAE.SAE_STATUS_LIST_SP(ACTION: "GET_CLOSED_SAE",
        ...
        protected void grdSAELog_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "EditSAE")
                {
                    ...
                    Response.Redirect("NSAE_CLOSED_SAE_DETAILS.aspx?SAEID=" + SAEID, false);
                }
            }
            catch (Exception ex)
            {
