<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NSAE_LOGGED_EVENTS_LIST_Complete.aspx.cs" Inherits="CTMS.NSAE_LOGGED_EVENTS_LIST_Complete" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">SAE Initial-Complete
            </h3>
        </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="form-group" style="display: inline-flex">
                            ...
                            <div class="Control">
                                <asp:DropDownList ID="drpSubID" ForeColor="Blue" runat="server" CssClass="form-control required select" AutoPostBack="True"
                        ...
                        <div class="box">
                            <div style="width: 100%; overflow: auto;">
                                <asp:GridView ID="grdSAELog" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                                    OnRowCommand="grdSAELog_RowCommand" AllowSorting="true" Width="100%" OnPreRender="grd_data_PreRender" OnRowDataBound="grd_data_RowDataBound">
                                    <Columns>
