    ...
    public partial class UMT_Active_Deactive : System.Web.UI.Page
    {
        ...
        private void DEACTIVATION()
        {
            try
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Site Deactivated Successfully')", true);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        private void ACTIVATION()
        {
            try
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Site Activated Successfully')", true);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
