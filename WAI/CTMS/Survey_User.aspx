<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Survey_User.aspx.cs" Inherits="CTMS.Survey_User" %>
...
<body>
    ...
    <div class="login-wrap">
        <div class="login-html">
            <asp:Label ID="lblErrorMsg" runat="server" Style="color: #CC3300; font-size: 17px;
                font-weight: bold;" ForeColor="Red"></asp:Label>
            <br />
            <br />
            <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1"
                class="tab">Your Details</label>
                ...
                <div id="divLogin" runat="server">
                    <div class="sign-in-htm">
                        <div class="group">
                            ...
                            <asp:TextBox ID="txtName" runat="server" autocomplete="off" type="text" required="true"
                        ...
                        <div class="group">
                            ...
                            <asp:TextBox ID="txtEmailID" runat="server" autocomplete="off" type="text" class="input"></asp:TextBox>
                        </div>
                        <div class="group">
                            &nbsp
                        </div>
                        <div class="group">
                            <asp:Button ID="BtnNext" runat="server" type="submit" class="button" value="Next"
