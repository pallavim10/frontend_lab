<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="NIWRS_RETENTION_SITE.aspx.cs" Inherits="CTMS.NIWRS_RETENTION_SITE" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvKits" runat="server" AllowSorting="True" AutoGenerateColumns="False" OnPreRender="gvKits_PreRender"
                            CssClass="table table-bordered Datatable txt_center table-striped notranslate" OnRowDataBound="gvKits_RowDataBound">
                            <Columns>
                    ...
                    <div class="modal-body" runat="server">
                        <div id="ModelPopupReject">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox ID="txtRetentionComments" MaxLength="200" CssClass="form-control-model" ValidationGroup="RetentionCommnet" TextMode="MultiLine"
