...
namespace CTMS
{
    public partial class Budget_HomePage : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void Get_Dashboard()
        {
            try
            {
                //DataSet ds1 = dal.Dashboard_SP(Action: "GET_Dashboard", User_ID: Session["User_ID"].ToString(), Project_ID: Session["PROJECTID"].ToString(), Section: "Business Development");

                DataSet ds1 = dal.DASHBOARD_ASSIGNING(Action: "GET_Dashboard",
                     USERID: Session["User_ID"].ToString(),
                     PROJECTID: Session["PROJECTID"].ToString(),
                     TYPENAME: "Business Development"
                     );
