<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DM_VISIT_COMPLETED_VS_ENTERED.aspx.cs" Inherits="CTMS.DM_VISIT_COMPLETED_VS_ENTERED" %>
        ...
        <div class="box-header">
            <h3 class="box-title" style="width: 100%;">
                <asp:Label ID="lblHeader" runat="server" Font-Size="12px" Font-Bold="true" Font-Names="Arial"
                    Text="Visit Completed v/s SDV"></asp:Label>
            </h3>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div runat="server" id="divSubject" style="display: inline-flex">
                            <div style="display: inline-flex">
                                ...
                                <div class="Control">
                                    <asp:DropDownList ID="ddlSUBJID" runat="server" CssClass="form-control select" OnSelectedIndexChanged="ddlSUBJID_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div runat="server" id="div1" style="display: inline-flex">
                            <div style="display: inline-flex">
                                ...
                                <div class="Control">
                                    <asp:DropDownList ID="ddlVisit" runat="server" CssClass="form-control select" OnSelectedIndexChanged="ddlVisit_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        ...
                        <div runat="server" id="div2" style="display: inline-flex">
                            <div style="display: inline-flex">
                                ...
                                <div class="Control">
                                    <asp:DropDownList ID="ddlModule" runat="server" CssClass="form-control select" OnSelectedIndexChanged="ddlModule_SelectedIndexChanged" AutoPostBack="true">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
