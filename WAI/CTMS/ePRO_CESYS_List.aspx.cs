...
namespace CTMS
{
    public partial class ePRO_CESYS_List : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_DATA()
        {
            try
            {
                ...
                {
                    DataSet dsData = dal.ePRO_WAD_SP(ACTION: "GET_SOLICITED_SYS_SUMMARY", SUBJID: ddlSubject.SelectedValue, LASTDOSE: hdnLASTDOSE.Value, USERID: Session["User_ID"].ToString());
        ...
        protected void gridData_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    //e.Row.CssClass = e.Row.CssClass + " fontBlack";
                    ...
                    if (Session["UserType"].ToString() == "Investigator" || Session["UserType"].ToString() == "Investigator Team Member" || Session["UserGroup_ID"].ToString() == "Administrator")
                    {
                        ...
                        string MODULENAME = "SOLICITED SYSTEMIC ADVERSE EVENT";
        ...
        protected void gridData_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                string MODULENAME = "SYSTEMIC SOLICITED ADVERSE EVENT";
        ...
        private void ExportSingleSheet()
        {
            try
            {
                ...
                ds = dal.ePRO_WAD_SP(ACTION: "GET_SOLICITED_SYS_SUMMARY", SUBJID: ddlSubject.SelectedValue, USERID: Session["User_ID"].ToString());
