<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="NIWRS_SETUP_FORM_OnSubmitCrits.aspx.cs"
    Inherits="CTMS.NIWRS_SETUP_FORM_OnSubmitCrits" %>
        ...
        <div style="margin: 5px">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Manage OnSubmit Criterias</h3>
                </div>
                <div class="rows">
                    <asp:GridView ID="grdStepCrits" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped"
                        OnRowCommand="grdStepCrits_RowCommand" OnRowDataBound="grdStepCrits_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Audit Trail" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnAudttrail" runat="server" OnClientClick="return showAuditTrail('NIWRS_FORM_CRITs', this);" ToolTip="Audit Trail"><i class="fa fa-clock-o" style="color:blue; font-size:15px"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Delete" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnDelete" OnClientClick='<%# string.Format("return ConfirmMsg(\"{0}{1}\");", "Are you sure you want to delete this criteria : ", Eval("Criteria")) %>' CommandArgument='<%# Bind("ID") %>' CommandName="DeleteCrit"
                ...
                <div class="col-md-12">
                    <div class="box box-primary" style="min-height: 210px;">
                        <div class="box-header" style="float: left; top: 0px; left: 0px;">
                            <h4 class="box-title" align="left">Add OnSubmit Criterias for : &nbsp;<asp:Label ID="lblList" runat="server"></asp:Label>
                            </h4>
                        </div>
                        <br />
                        <br />
