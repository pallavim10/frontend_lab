...
namespace CTMS
{
    public partial class NCTMS_AddComments_PM : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void bntSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["PM_PAGECOMMENTID"] == null)
                {
                    dal.GetSetChecklistComments(
                ...
                else
                {
                    dal.GetSetChecklistComments(
                           ...
                           Comments: txtPMComment.Text,
                           ENTEREDBY: Session["USER_ID"].ToString(),
                           ID: ViewState["PM_PAGECOMMENTID"].ToString()
                           );
                }
