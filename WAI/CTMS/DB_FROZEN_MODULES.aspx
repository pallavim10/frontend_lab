<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DB_FROZEN_MODULES.aspx.cs" Inherits="CTMS.DB_FROZEN_MODULES" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function REVIEW_HISTORY(element) {
            ...
            $.ajax({
                type: "POST",
                url: "DB_FROZEN_MODULES.aspx/REVIEW_HISTORY",
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning" runat="server" id="content">
        <div class="box-header">
            <h3 class="box-title">Frozen Modules
            </h3>
        </div>
        <div>
            ...
            <div class="fixTableHead">
                <asp:GridView ID="grdModule" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Un-Freeze Request" ItemStyle-CssClass="txt_center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnUnFreezeReq" runat="server" ToolTip="Un-Freeze Request" OnClick="lbtnUnFreezeReq_Click">
                                        <img src="Images/UNFREEZED.png" style="height:20px;width:20px;" alt="" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
        ...
        <div class="modal-body" runat="server" style="padding: 10px;">
            <div id="ModelPopup2">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-8">
                            <asp:TextBox runat="server" ID="txtReason" placeholder="Please enter comment to generate unfreeze request for above systems...." TextMode="MultiLine" MaxLength="500" CssClass="form-control required2" Style="width: 575px; height: 131px;"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <br />
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:Button ID="btnSubmitUnFreezeReq" runat="server" Style="margin-left: 37px; height: 34px; width: 71px; font-size: 14px;" CssClass="btn btn-DarkGreen btn-sm cls-btnSave2"
                            Text="Submit" OnClick="btnSubmitUnFreezeReq_Click" />
                        &nbsp;
                            &nbsp;
