...
namespace CTMS
{
    public partial class NCTMS_SPONSOR_REVIEW_LIST : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        public void FillVISITS_NOM()
        {
            ...
            {
                DataSet ds = dal.CTMS_DATA_SP(
                ACTION: "GET_VISIT_NOM_AGAINST_USER_SPONSOR",
        ...
        protected void GETDATA()
        {
            try
            {
                DataSet ds = dal.CTMS_DATA_SP(ACTION: "GET_VISIT_REPORT_DATA_SPONSOR",
        ...
        protected void grdVisits_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "GoToOpenCRF")
                {
                    ...
                    Response.Redirect("NCTMS_SPONSOR_REVIEW_OPEN_CRF.aspx?SVID=" + SVID + "&SITEID=" + SITEID + "&VISITID=" + VISITID + "&VISIT=" + VISIT_NAME, false);
                }
            }
            catch (Exception ex)
            {
