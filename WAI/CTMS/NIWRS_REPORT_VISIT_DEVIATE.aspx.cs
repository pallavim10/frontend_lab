...
namespace CTMS
{
    public partial class NIWRS_REPORT_VISIT_DEVIATE : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_LIST()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "NIWRS_REPORT_VISIT_DEVIATION", SITEID: ddlSite.SelectedValue);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "NIWRS_REPORT_VISIT_DEVIATION", SITEID: ddlSite.SelectedValue, SUBSITEID: ddlSubSite.SelectedValue);
                ds.Tables[0].Columns["Screening Id"].ColumnName = Session["SUBJECTTEXT"].ToString();
