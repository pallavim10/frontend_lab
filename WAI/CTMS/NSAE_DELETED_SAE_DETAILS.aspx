<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NSAE_DELETED_SAE_DETAILS.aspx.cs" Inherits="CTMS.NSAE_DELETED_SAE_DETAILS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d == 'Object reference not set to an instance of an object.') {
                        ...
                        $('#SAE_DivDeletedAllQuery').html(data.d)

                        $("#SAE_popup_DeletedAllQuery").dialog({
                            title: "Deleted Query",
                            width: 1100,
                            height: 500,
                            modal: true,
        ...
        function ConfirmMsg() {
            ...
            var error_msg = "Are you sure you want to Restore this SAE?..";
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-success">
        <div class="box-header">
            <h3 class="box-title">Deleted SAE Details
            </h3>
            ...
            <div class="pull-right">
                ...
                <asp:Button ID="btnRestoreSAE" runat="server" Text="Restore SAE" CssClass="btn btn-sm btn-DARKORANGE"
                    OnClientClick="return ConfirmMsg();" />&nbsp&nbsp&nbsp
            </div>
        </div>
            ...
            <div style="border-style: double; margin-bottom: 1px;">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="col-md-6">
                                <asp:Label Font-Bold="true" runat="server" ForeColor="Blue">Deleted By :
                                </asp:Label>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-md-6">
                                <asp:Label Font-Bold="true" runat="server" ForeColor="Blue">Deleted Datetime(Server) :
                                </asp:Label>
                            </div>
                            <div class="col-md-6">
                                <asp:Label ID="lblDeletedDTServer" runat="server"></asp:Label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="col-md-6">
                                <asp:Label Font-Bold="true" runat="server" ForeColor="Blue">Deleted Datetime(User), (Timezone) :
                                </asp:Label>
                            </div>
                            <div class="col-md-6">
                                <asp:Label ID="lblDeletedDTUTC" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-md-6">
                                <asp:Label Font-Bold="true" runat="server" ForeColor="Blue">Deleted Reason :
                                </asp:Label>
                            </div>
                            <div class="col-md-6">
                                <asp:Label ID="lblDeleteReason" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <ItemTemplate>
                                                   ...
                                                   <asp:LinkButton ID="lnkQUERYANS" ToolTip="Answered Open Query" OnClientClick="return ShowAnsQuery_SAEID_RECID(this);" runat="server">
                                                       <i class="fa fa-question-circle" style="font-size: 17px; color: blue;"></i>
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <asp:LinkButton ID="lnkQUERYCLOSE" ToolTip="Deleted Query" OnClientClick="return ShowClosedQuery_SAEID_RECID(this);" runat="server">
    ...
    <cc1:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnlRestoreSAE" TargetControlID="lnkReason"
        BackgroundCssClass="Background" BehaviorID="modalpnlRestoreSAE">
    </cc1:ModalPopupExtender>
    <asp:Panel ID="pnlRestoreSAE" runat="server" Style="display: none;" CssClass="Popup1">
        <asp:Button runat="server" ID="lnkReason" Style="display: none" />
        <h5 class="heading">Reason for Restore SAE</h5>
        <div class="modal-body" runat="server">
            <div id="ModelPopup2">
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-8">
                            <asp:TextBox runat="server" ID="txtReason" TextMode="MultiLine" CssClass="form-control required" Style="width: 575px; height: 131px;"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <br />
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:Button ID="btnSubmitRestoreSAE" runat="server" Style="margin-left: 37px; height: 34px; width: 71px; font-size: 14px;" CssClass="btn btn-DarkGreen btn-sm cls-btnSave"
                            Text="Submit" OnClick="btnSubmitRestoreSAE_Click" />
                        &nbsp;
                            &nbsp;
