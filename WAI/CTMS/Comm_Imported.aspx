<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Comm_Imported.aspx.cs" Inherits="CTMS.Comm_Imported" %>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="list-group" style="padding-left: 0px;">
                        <asp:Repeater runat="server" ID="repeatImported" OnItemCommand="repeatImported_ItemCommand"
                            OnItemDataBound="repeatImported_ItemDataBound">
                            <ItemTemplate>
                                <div class="row list-group-item" runat="server" id="divMailItem">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-1">
                                            <asp:LinkButton runat="server" ToolTip="Create Event" CommandArgument='<%# Bind("ID") %>'
                                                CommandName="Event" ID="lbtnEvent">
                                            <i class="fa fa-calendar-o color"></i>
                                            </asp:LinkButton>
                                        </div>
                                        <div class="col-md-1">
                                            <asp:LinkButton runat="server" Visible="false" ToolTip="Already Created Events" CommandArgument='<%# Bind("ID") %>'
                                                CommandName="ShowEvent" ID="lbtnEventCreated"> 
