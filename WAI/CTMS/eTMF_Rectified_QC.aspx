<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="eTMF_Rectified_QC.aspx.cs" Inherits="CTMS.eTMF_Rectified_QC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div>
            <div class="box-header">
                <h3 class="box-title">
                    <asp:Label runat="server" ID="lblHeader" Text="QC Rectified"></asp:Label>
                </h3>
            </div>
    ...
    <asp:GridView ID="gvFiles" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        CssClass="table table-bordered table-striped  Datatable" OnPreRender="gvFiles_PreRender" OnRowDataBound="gvFiles_RowDataBound"
        Width="100%" OnRowCommand="gvFiles_RowCommand">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Status" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label runat="server" ID="lblStatus" CssClass="label" Text='<%# Eval("Status") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Correct Nomenclature" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label ID="QCDOC_CORRECT_NOM" Width="100%"
                        runat="server" Text='<%# Bind("QCDOC_CORRECT_NOM") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Legibility of Document" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label ID="QCDocLegible" Width="100%"
                        runat="server" Text='<%# Bind("QCDocLegible") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Correct Orientation" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label ID="QCDOC_CORRECT_ORIEN" Width="100%"
                        runat="server" Text='<%# Bind("QCDOC_CORRECT_ORIEN") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Filed in Correct Location" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label ID="QCDocLocat" Width="100%"
                        runat="server" Text='<%# Bind("QCDocLocat") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Document attributable" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label ID="QCDOC_DOC_ATTRI" Width="100%"
                        runat="server" Text='<%# Bind("QCDOC_DOC_ATTRI") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Document Complete" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label ID="QCDOC_COMPLETE" Width="100%"
                        runat="server" Text='<%# Bind("QCDOC_COMPLETE") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="QC Comment" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label ID="QCcomments" Width="100%"
                        runat="server" Text='<%# Bind("QCcomments") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="QCed Status" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label ID="QC_ACTION" Width="100%"
                        runat="server" Text='<%# Bind("QC_ACTION") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <HeaderTemplate>
            ...
            <asp:TemplateField HeaderText="QC Rectification" ItemStyle-CssClass="txt_center">
                <ItemTemplate>
                    <asp:Label ID="QCACT_DETAIL" Width="100%"
                        runat="server" Text='<%# Bind("QCACT_DETAIL") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <HeaderTemplate>
                    <label>Retification Details</label><br />
                ...
                <ItemTemplate>
                    <div>
                        ...
                        <div>
                            <asp:Label ID="QCACT_CAL_TZDAT" runat="server" Text='<%# Eval("QCACT_CAL_TZDAT") +" "+ Eval("QCACT_TZVAL") %>' ForeColor="Red"></asp:Label>
                        </div>
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
