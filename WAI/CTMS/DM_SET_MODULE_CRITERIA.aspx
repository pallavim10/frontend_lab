<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DM_SET_MODULE_CRITERIA.aspx.cs"
    Inherits="CTMS.DM_SET_MODULE_CRITERIA" %>
                    ...
                    <div class="box-body" id="divCrit">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Manage Module Criterias</h3>
                                                ...
                                                <asp:GridView ID="grdStepCrits" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Audit Trail" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lbtnAudttrail" runat="server" OnClientClick="return showAuditTrail('DM_MODULE_CRITs', this);" ToolTip="Audit Trail"><i class="fa fa-clock-o" style="color:blue; font-size:15px"></i></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Delete" ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lbtnDelete" CommandArgument='<%# Bind("ID") %>' CommandName="DeleteCrit"
                                                                    runat="server" OnClientClick='<%# string.Format("return ConfirmMsg(\"{0}{1}\");", "Are you sure you want to delete this module Criterias : ", Eval("NAME")) %>' ToolTip="Delete"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                        ...
                        <div class="box box-primary" style="min-height: 210px;">
                            <div class="box-header" style="float: left; top: 0px; left: 0px;">
                                <h4 class="box-title" align="left">Add Module Criterias for : &nbsp;<asp:Label ID="lblList" runat="server"></asp:Label>
                                </h4>
                            </div>
                            <br />
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtName" runat="server" Width="300px" CssClass="form-control required"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <br />
