...
namespace CTMS
{
    public partial class NCTMS_MonitoringVisitList_FU : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void GETDATA()
        {
            try
            {
                DataSet ds = dal.CTMS_DATA_SP(ACTION: "GET_VISIT_REPORT_FU",
        ...
        protected void grdVisits_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "CreateFU")
                {
                    Response.Redirect("NCTMS_SET_FU_LETTER.aspx?SVID=" + SVID + "&SITEID=" + SITEID + "&VISITID=" + VISITID + "&VISIT=" + VISIT_NAME);
                }
                else if (e.CommandName == "PrintFU")
                {
