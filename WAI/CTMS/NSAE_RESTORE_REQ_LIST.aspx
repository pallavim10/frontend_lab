<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NSAE_RESTORE_REQ_LIST.aspx.cs" Inherits="CTMS.NSAE_RESTORE_REQ_LIST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-success">
        <div class="box-header">
            <h3 class="box-title">Restore SAE
            </h3>
    ...
    <cc1:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnlRestoreSAE" TargetControlID="btnApprove"
        BackgroundCssClass="Background">
    </cc1:ModalPopupExtender>
    <asp:Panel ID="pnlRestoreSAE" runat="server" Style="display: none;" CssClass="Popup1">
        <h5 class="heading">Restore Request</h5>
