<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_DAMAGED_CENTRAL.aspx.cs" Inherits="CTMS.NIWRS_DAMAGED_CENTRAL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Check_All_UnDestory(element) {

            $('input[type=checkbox][id*=Chek_UnDestory]').each(function () {
                // >>this<< refers to specific checkbox
        ...
        function Check_All_UnReturn(element) {

            $('input[type=checkbox][id*=Chek_UnReturn]').each(function () {
                // >>this<< refers to specific checkbox
    ...
    <script type="text/javascript">
        ...
        function Check_UnDestoryReasonEntered() {

            if ($('#MainContent_TxtDestoryComm').val().trim() == '') {
                $('#MainContent_TxtDestoryComm').val('');
                alert('Please enter Comments');
                return false;
            }
        };

        function Check_UnReturnReasonEntered() {

            if ($('#MainContent_txtReturnComm').val().trim() == '') {
                $('#MainContent_txtReturnComm').val('');
                alert('Please enter Comments');
                return false;
            }
        };
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Damaged Kits</h3>
            <asp:HiddenField ID="hfKITS" runat="server" />
            <asp:Label runat="server" ID="lblHeader" Text="Damaged Kits" Visible="false"></asp:Label>
            <div class="pull-right">
                <asp:LinkButton runat="server" ID="btnExport" OnClick="btnExport_Click" Font-Size="12px" Style="margin-top: 3px;" CssClass="btn btn-info" ForeColor="White">Export Damaged Kits&nbsp;<span class="glyphicon glyphicon-download 2x"></span></asp:LinkButton>
                &nbsp;&nbsp;
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="rows">
                    ...
                    <div class="col-md-12">
                        <asp:GridView ID="gvKits" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Damaged At">
                                    <ItemTemplate>
                                        <asp:Label ID="Location" runat="server" Text='<%# Bind("Location") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Damaged Comment">
                                    <ItemTemplate>
                                        <asp:Label ID="DamagedComment" runat="server" Text='<%# Bind("DAMAGEDCOMM") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <label>Damaged Details</label><br />
                                        <label style="color: blue; font-weight: lighter; margin-bottom: 0px;">[Damaged By]</label><br />
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <div>
                                                <asp:Label ID="DAMAGEDBYNAME" runat="server" Text='<%# Bind("DAMAGEDBYNAME") %>' ForeColor="Blue"></asp:Label>
                                            </div>
                                            <div>
                                                <asp:Label ID="DAMAGED_CAL_DAT" runat="server" Text='<%# Bind("DAMAGED_CAL_DAT") %>' ForeColor="Green"></asp:Label>
                                            </div>
                                            <div>
                                                <asp:Label ID="DAMAGED_CAL_TZDAT" runat="server" Text='<%# Eval("DAMAGED_CAL_TZDAT") +"  "+ Eval("DAMAGED_TZVAL") %>' ForeColor="Red"></asp:Label>
                                            </div>
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                    <HeaderTemplate>
                                        <asp:Button ID="Destory" runat="server" CssClass="btn btn-primary btn-sm"
                                            Text="Destroy" OnClientClick="UpdateSelectedKits(this);" OnClick="Destory_Click" />
                                        <br />
                                        <asp:CheckBox ID="ChekAll_Destory" runat="server" onclick="Check_All_UnDestory(this)" />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:CheckBox ID="Chek_UnDestory" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                    <HeaderTemplate>
                                        <asp:Button ID="Return" runat="server" CssClass="btn btn-primary btn-sm"
                                            Text=" Return " OnClientClick="UpdateSelectedKits(this);" OnClick="Return_Click" />
                                        <br />
                                        <asp:CheckBox ID="ChekAll_Return" runat="server" onclick="Check_All_UnReturn(this)" />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:CheckBox ID="Chek_UnReturn" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                    <HeaderTemplate>
                ...
                <br />
                <cc1:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="PanelDestory" TargetControlID="Button_Destory"
                    BackgroundCssClass="Background">
                </cc1:ModalPopupExtender>
                <asp:Panel ID="PanelDestory" runat="server" Style="display: none;" CssClass="Popup1">
                    <asp:Button runat="server" ID="Button_Destory" Style="display: none" />
                    <h5 class="heading">Please Enter Comment</h5>
                    <div class="disp-none">
                        <asp:Label ID="Label1" runat="server" Text="Table Name"></asp:Label>
                        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                        <asp:Label ID="Label2" runat="server" Text="Cont Id"></asp:Label>
                        <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                        <asp:Label ID="Label3" runat="server" Text="Variable Name"></asp:Label>
                    ...
                    <div class="modal-body" runat="server">
                        <div id="ModelPopup">
                            <div class="row">
                                <div class="col-md-4">
                                    <asp:Label ID="lblDestory" runat="server" CssClass="wrapperLable" Text="Comments" Style="color: black; font-weight: 600; font-size: 14px;"></asp:Label>
                                </div>
                                <div class="col-md-8">
                                    <asp:TextBox ID="TxtDestoryComm" CssClass="form-control-model" MaxLength="200" TextMode="MultiLine"
                                        runat="server" Style="width: 250px;"></asp:TextBox>
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <asp:Button ID="btnSubmitDestory" runat="server" Style="margin-left: 37px; height: 34px; width: 71px; font-size: 14px;" ValidationGroup="Commnet" CssClass="btn btn-DarkGreen"
                                        OnClientClick="return Check_UnDestoryReasonEntered();" Text="Submit" OnClick="btnSubmitDestory_Click" />
                                    &nbsp;
                            &nbsp;
                            <asp:Button ID="btnCancelDestory" runat="server" Text="Cancel" ValidationGroup="Commnet"
                                CssClass="btn btn-DarkGreen" Style="height: 34px; width: 71px; font-size: 14px;" OnClick="btnCancelDestory_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <br />
                <cc1:ModalPopupExtender ID="ModalPopupExtender3" runat="server" PopupControlID="PanelREeturn" TargetControlID="Button_Return"
                    BackgroundCssClass="Background">
                </cc1:ModalPopupExtender>
                <asp:Panel ID="PanelREeturn" runat="server" Style="display: none;" CssClass="Popup1">
                    <asp:Button runat="server" ID="Button_Return" Style="display: none" />
                    <h5 class="heading">Please Enter Comment</h5>
                    <div class="disp-none">
                        <asp:Label ID="Label8" runat="server" Text="Table Name"></asp:Label>
                        <asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
                        <asp:Label ID="Label9" runat="server" Text="Cont Id"></asp:Label>
                        <asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
                        <asp:Label ID="Label10" runat="server" Text="Variable Name"></asp:Label>
                    ...
                    <div class="modal-body" runat="server">
                        <div id="ModelPopup">
                            <div class="row">
                                <div class="col-md-4">
                                    <asp:Label ID="lblReturn" runat="server" CssClass="wrapperLable" Text="Comments" Style="color: black; font-weight: 600; font-size: 14px;"></asp:Label>
                                </div>
                                <div class="col-md-8">
                                    <asp:TextBox ID="txtReturnComm" CssClass="form-control-model" MaxLength="200" TextMode="MultiLine"
                                        runat="server" Style="width: 250px;"></asp:TextBox>
                                </div>
                            </div>
                            <br />
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <asp:Button ID="btnSubmitReturn" runat="server" Style="margin-left: 37px; height: 34px; width: 71px; font-size: 14px;" ValidationGroup="Commnet" CssClass="btn btn-DarkGreen"
                                        OnClientClick="return Check_UnReturnReasonEntered();" Text="Submit" OnClick="btnSubmitReturn_Click" />
                                    &nbsp;
                            &nbsp;
                            <asp:Button ID="btnCancelReturn" runat="server" Text="Cancel" ValidationGroup="Commnet"
