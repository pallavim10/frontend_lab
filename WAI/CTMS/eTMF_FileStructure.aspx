<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="eTMF_FileStructure.aspx.cs" Inherits="CTMS.eTMF_FileStructure" %>
    ...
    <div class="box box-success">
        ...
        <div class="col-md-12">
            <div class="col-md-6">
                ...
                <div class="col-md-3">
                    <asp:DropDownList ID="DrpUploadUsing" runat="server" CssClass="form-control width300px"
                        OnSelectedIndexChanged="DrpUploadUsing_SelectedIndexChanged" AutoPostBack="true">
                                                                                    ...
                                                                                    <div id="_SubFolder<%# Eval("SubFolder_ID") %>" style="display: none; position: relative; overflow: auto;">
                                                                                        <asp:GridView ID="gvArtifact" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                            ...
                                                                                            <Columns>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="Ref. No." ItemStyle-Width="10%" ItemStyle-CssClass="txt_center">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lbl_RefNo" Width="100%" ToolTip='<%# Bind("RefNo") %>' CssClass="label"
                                                                                                            runat="server" Text='<%# Bind("RefNo") %>'></asp:Label>
                                                                                                    </ItemTemplate>
