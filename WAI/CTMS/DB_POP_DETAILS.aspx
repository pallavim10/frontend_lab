<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DB_POP_DETAILS.aspx.cs"
    Inherits="CTMS.DB_POP_DETAILS" %>
        ...
        <div class="box box-warning">
            <div class="box-header">
                ...
                <div id="Div1" class="dropdown" runat="server" style="display: inline-flex">
                    <a href="#" class="dropdown-toggle glyphicon glyphicon-download-alt" data-toggle="dropdown"
                        style="color: #333333" title="Export" tabindex="1"></a>
                    <ul class="dropdown-menu dropdown-menu-sm">
                        <li>
                            <asp:LinkButton runat="server" ID="btnExport" OnClick="btnExport_Click" ToolTip="Export to Excel"
                                Text="Export to Excel" CssClass="dropdown-item" Style="color: #333333;" TabIndex="2">
                            </asp:LinkButton></li>
                        <hr style="margin: 5px;" />
                        <li>
                            <asp:LinkButton runat="server" CssClass="dropdown-item" ID="btnPDF" OnClick="btnPDF_Click"
                                ToolTip="Export to PDF" Text="Export to PDF" Style="color: #333333;" TabIndex="3">
                            </asp:LinkButton></li>
                        <hr style="margin: 5px;" />
                        <li>
                            <asp:LinkButton runat="server" CssClass="dropdown-item" ID="btnRTF" OnClick="btnRTF_Click"
                                ToolTip="Export to RTF" Text="Export to RTF" Style="color: #333333;" TabIndex="4">
                            </asp:LinkButton></li>
                    </ul>
                </div>
            ...
            <div class="box-body">
                <div class="form-group">
                    <div class="box-body">
                        <div class="box">
                            <asp:GridView ID="grdPopUpDetails" runat="server" AutoGenerateColumns="true"
