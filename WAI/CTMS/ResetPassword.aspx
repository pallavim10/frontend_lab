<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ResetPassword.aspx.cs" Inherits="CTMS.ResetPassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Resend Password</h3>
        </div>
        <!-- /.box-header -->
        <!-- text input -->
        <div class="box-body">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <asp:RequiredFieldValidator ID="Req_EmailID" runat="server" ControlToValidate="txt_EmailID"
                                                    ErrorMessage="Required" Font-Size="X-Small" ForeColor="Red"></asp:RequiredFieldValidator>
                                            ...
                                            <div class="label col-md-2">
                                                <asp:Button ID="Btn_Update" runat="server" CssClass="btn btn-primary btn-sm cls-btnSave"
                                                    Style="margin-left: 10px" OnClick="Btn_Update_Click" Text="Resend Password" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
