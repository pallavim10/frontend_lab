<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NSAE_DOWNGRADING_REQ_LIST.aspx.cs" Inherits="CTMS.NSAE_DOWNGRADING_REQ_LIST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-success">
        <div class="box-header">
            <h3 class="box-title">Downgrading SAE
            </h3>
            ...
            <div class="pull-right">
                ...
                <asp:Button ID="btnApprove" runat="server" Text="Take Action" CssClass="btn btn-sm btn-DARKORANGE" />&nbsp&nbsp&nbsp
            </div>
        </div>
            ...
            <div style="border-style: double; margin-bottom: 1px;">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="col-md-6">
                                <asp:Label Font-Bold="true" runat="server" ForeColor="Blue">Downgrading Request By :
                                </asp:Label>
                            </div>
                            <div class="col-md-6">
                                <asp:Label ID="lblDOWNREQBy" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-md-6">
                                <asp:Label Font-Bold="true" runat="server" ForeColor="Blue">Downgrading Request Datetime(Server) :
                                </asp:Label>
                            </div>
                            <div class="col-md-6">
                                <asp:Label ID="lblDOWNREQDTServer" runat="server"></asp:Label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="col-md-6">
                                <asp:Label Font-Bold="true" runat="server" ForeColor="Blue">Downgrading Request Datetime(User), (Timezone) :
                                </asp:Label>
                            </div>
                            <div class="col-md-6">
                                <asp:Label ID="lblDOWNREQDTUTC" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-md-6">
                                <asp:Label Font-Bold="true" runat="server" ForeColor="Blue">Downgrading Request Reason :
                                </asp:Label>
                            </div>
                            <div class="col-md-6">
                                <asp:Label ID="lblDOWNREQReason" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <asp:Panel ID="pnlReOpenSAE" runat="server" Style="display: none;" CssClass="Popup1">
        <h5 class="heading">Downgrading Request</h5>
