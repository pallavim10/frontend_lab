<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DM_AUDITTRAIL_REPORT_UNBLINDED.aspx.cs" Inherits="CTMS.DM_AUDITTRAIL_REPORT_UNBLINDED" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Unblinded Audit Trail Reports
            </h3>
        </div>
        <div class="lblError">
