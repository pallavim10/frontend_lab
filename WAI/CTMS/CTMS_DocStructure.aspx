<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CTMS_DocStructure.aspx.cs" Inherits="CTMS.CTMS_DocStructure" %>
        ...
        <ContentTemplate>
            <asp:GridView ID="gvFolder" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Folder" ItemStyle-Width="100%">
                        <ItemTemplate>
                                                ...
                                                <div id="_Folder<%# Eval("ID") %>" style="display: none; position: relative; overflow: auto;">
                                                    <asp:GridView ID="gvSubFolder" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Sub-Folder" ItemStyle-Width="100%">
                                                                <ItemTemplate>
                                                                                            ...
                                                                                            <asp:GridView ID="gvDocs" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                                ...
                                                                                                <Columns>
                                                                                                    ...
                                                                                                    <asp:TemplateField ItemStyle-CssClass="txt_center" ItemStyle-Width="1%">
                                                                                                        <ItemTemplate>
                                                                                                            <asp:LinkButton ID="lbtnDownloadDoc" OnClientClick="return DownloadDoc(this);" runat="server"
                                                                                                                ToolTip="View" CommandArgument='<%# Bind("ID") %>'><i class="fa fa-search" style="color:#333333;" aria-hidden="true"></i>
                                                                                                            </asp:LinkButton>
                                                                                                        </ItemTemplate>
                                                                                                    </asp:TemplateField>
                                                                                                </Columns>
