<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_REPORT_KIT_DISP_SUM.aspx.cs" Inherits="CTMS.NIWRS_REPORT_KIT_DISP_SUM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">
                <asp:Label runat="server" ID="lblHeader" Text="Dosing Summary"></asp:Label>
            </h3>
            <div class="pull-right">
                <%--<asp:LinkButton runat="server" ID="btnExport" OnClick="btnExport_Click" Font-Size="12px" Style="margin-top: 3px;" CssClass="btn btn-info" ForeColor="White">Export Dosing Summary&nbsp;<span class="glyphicon glyphicon-download 2x"></span></asp:LinkButton>--%>
                <a href="#" class="dropdown-toggle btn-info prevent-refresh-button" data-toggle="dropdown" style="color: #FFFFFF">Export Dosing Summary&nbsp;<span class="glyphicon glyphicon-download"></span></a>
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div style="display: none">
                        ...
                        <div class="Control">
                            <asp:DropDownList ID="ddlSubSite" runat="server" CssClass="form-control">
                            </asp:DropDownList>
                        </div>
                    </div>
