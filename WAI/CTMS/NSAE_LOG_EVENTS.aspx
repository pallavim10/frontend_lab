<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NSAE_LOG_EVENTS.aspx.cs" Inherits="CTMS.NSAE_LOG_EVENTS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Log New SAE
            </h3>
        </div>
            ...
            <ContentTemplate>
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <asp:Button ID="btnNewSAE" runat="server" Text="Log New SAE" CssClass="btn btn-sm btn-primary cls-btnSave"
                            OnClick="btnNewSAE_Click" />
                        <div class="box">
