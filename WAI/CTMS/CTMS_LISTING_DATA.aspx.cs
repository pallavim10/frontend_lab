...
namespace CTMS
{
    public partial class CTMS_LISTING_DATA : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void btngetdata_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ds = dal.DM_LISTINGS_SP(Action: "CTMS_GETLISTDATA", PROJECTID: Session["PROJECTID"].ToString(), LISTING_ID: Request.QueryString["LISTID"].ToString(), SUBJECTID: drpSubID.SelectedValue, INVID: drpInvID.SelectedValue, INDICATION: drpIndication.SelectedValue, COUNTRYID: drpCountry.SelectedValue);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                ...
                if (hdntranspose.Value == "FieldNameVise")
                {
                    ds = dal.DM_LISTINGS_SP(Action: "CTMS_GETLISTDATA", PROJECTID: Session["PROJECTID"].ToString(), LISTING_ID: Request.QueryString["LISTID"].ToString(), SUBJECTID: drpSubID.SelectedValue, INVID: drpInvID.SelectedValue, INDICATION: drpIndication.SelectedValue);
                }
                else
                {
                    ds = dal.DM_LISTINGS_SP(Action: "CTMS_GETLISTDATA", PROJECTID: Session["PROJECTID"].ToString(), LISTING_ID: Request.QueryString["LISTID"].ToString(), SUBJECTID: drpSubID.SelectedValue, INVID: drpInvID.SelectedValue, INDICATION: drpIndication.SelectedValue);
