...
namespace CTMS
{
    public partial class ReportCTMS_SiteList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                try
                {
                    ...
                    dsMain = new DataSet();
                    dsMain = dal.GetSetINVDETAILS(Action: Action, Project_ID: ProjectID);
                    ReportViewer1.ProcessingMode = ProcessingMode.Local;
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ReportCTMS_SiteList.rdlc");
