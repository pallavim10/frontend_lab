<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_SPONSOR_REVIEW_REPORTS.aspx.cs" Inherits="CTMS.NCTMS_SPONSOR_REVIEW_REPORTS" %>
    ...
    <script>
        ...
        function ShowComments(element) {
            ...
            if (dataFreezeLockStatus == '1') {
                ...
                var test = "NCTMS_AddChecklistComments_SPONSOR.aspx?Section=" + VISIT + "&SubSectionText=" + Section + "&ProjectId=" + PROJECTID + "&INVID=" + INVID + "&SVID=" + SVID + "&SectionID=" + VISITID + "&SubSectionID=" + SectionID + "&CHECKLISTID=" + CHECKLISTID + "&Action=Field_Added_Comment" + "&ID=" + ID;
        ...
        function Add_Field_Comments(element) {
            ...
            if (dataFreezeLockStatus == '1') {
                ...
                var test = "NCTMS_AddChecklistComments_SPONSOR.aspx?Section=" + VISIT + "&SubSectionText=" + Section + "&ProjectId=" + PROJECTID + "&INVID=" + INVID + "&SVID=" + SVID + "&SectionID=" + VISITID + "&SubSectionID=" + SectionID + "&CHECKLISTID=" + CHECKLISTID + "&Action=FieldComment";
                var strWinProperty = "toolbar=no,menubar=no,location=no,scrollbars=yes,titlebar=no,height=550,width=1200";
                window.open(test, '_blank', strWinProperty);
                return false;
        ...
        function showAuditTrail(element) {
            ...
            if (dataFreezeLockStatus == '1') {
                ...
                var CTMS_SVID = $("#MainContent_hdnSVID").val();
                var CTMS_RECID = $("#MainContent_hdnRECID").val();
        ...
        function ShowTrackers(element) {
            ...
            var VISITID = $("#MainContent_hdnVISITID").val();
            var VISIT = $("#MainContent_hdnVISIT").val();
            var MODULEID = $("#<%=drpModule.ClientID%>").find("option:selected").val();
            var MODULENAME = $("#<%=drpModule.ClientID%>").find("option:selected").text();

            var test = "NCTMS_VISIT_TRACKES.aspx?INVID=" + INVID + "&SVID=" + SVID + "&VISITID=" + VISITID + "&VISIT=" + VISIT + "&MODULEID=" + MODULEID + "&MODULENAME=" + MODULENAME;
    ...
    <div class="box box-warning">
        <div class="box-header" style="display: inline-flex; width: 100%;">
            ...
            <div class="pull-right">
                <asp:Button ID="btnTrackers" runat="server" Text="Show All Trackers" CssClass="btn btn-primary btn-sm"
                    OnClientClick="return ShowTrackers(this);" />
            </div>
            <%--   <div class="pull-right">
                <asp:Label ID="lblAddSectionCmt" CssClass="btn btn-info btn-sm" runat="server" ToolTip="Add Section Comments"
            ...
            <div class="pull-right" style="padding-right: 5px;">
                <asp:Label ID="lblViewAllComment" CssClass="btn btn-danger btn-sm" runat="server"
                    ToolTip="View All Comments"><i class="fa fa-comments fa-2x"></i>
                ...
                <asp:GridView ID="grdField" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="" HeaderStyle-CssClass=" " ItemStyle-Width="2%" ItemStyle-CssClass="txt_center ">
                            <ItemTemplate>
                                <asp:LinkButton ID="CM" CssClass="btn btn-warning btn-sm" runat="server" ToolTip="Add Comments"
                                    OnClientClick="return Add_Field_Comments(this);">
                                    <i class="fa fa-comments" style="color: White; font-size: medium"></i>
                                    <asp:Label class="badge badge-info right" ID="lblAllCommentCount" runat="server"
                                        Text="0" Style="margin-left: 5px;" Font-Bold="true"></asp:Label>
                                </asp:LinkButton>
                            </ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <tr>
                                    <td colspan="100%" style="padding: 2px; overflow: auto">
                                        <div>
                                            <div class="rows">
                                                <div class="col-md-12">
                                                    <div id="_Comment<%# Eval("ID") %>" style="display: none; position: relative; overflow: auto;">
                                                        <asp:GridView ID="grdComments" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                            CssClass="table table-bordered table-striped Datatable" Caption="" OnRowDataBound="grdComments_RowDataBound"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Issue" HeaderStyle-CssClass="txt_center disp-none"
                                                                ...
                                                                <asp:TemplateField HeaderText="For Internal Use" HeaderStyle-CssClass="disp-none"
                                                                    ItemStyle-CssClass="disp-none">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="lbtnAddComment" runat="server" CommandArgument='<%# Bind("CheckListRow_ID") %>'
                                                                            OnClientClick="return ShowComments(this);"><i class="fa fa-comments"></i></asp:LinkButton>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
