...
namespace CTMS
{
    public partial class ePRO_MH_List : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_DATA()
        {
            try
            {
                DataSet ds = dal.ePRO_WAD_SP(ACTION: "GET_DATA_Additional", SITEID: ddlSite.SelectedValue, USERID: Session["User_ID"].ToString(), MODULEID: hdnMODULEID.Value, TABLENAME: hdnTABLENAME.Value);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal.ePRO_WAD_SP(ACTION: "GET_DATA_Additional", SITEID: ddlSite.SelectedValue, USERID: Session["User_ID"].ToString(), MODULEID: hdnMODULEID.Value);
