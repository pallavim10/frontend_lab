...
namespace CTMS
{
    public partial class DM_Popup_Queries : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                lblHeader.Text = Request.QueryString["Name"].ToString();

                DataSet ds = dal.DASHBOARD_MASTER(Action: Request.QueryString["Type"].ToString(), PROJECTID: Session["PROJECTID"].ToString(), INVID: Session["DASHBOARD_SITE"].ToString(),
