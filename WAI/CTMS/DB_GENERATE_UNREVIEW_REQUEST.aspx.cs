...
namespace CTMS
{
    public partial class DB_GENERATE_UNREVIEW_REQUEST : System.Web.UI.Page
    {
        ...
        public void GetModule()
        {
            try
            {
                DataSet ds = dal_DB.DB_REVIEW_SP(ACTION: "GET_MODULES_FOR_GEN_UNREVIEW_REQUEST");
        ...
        protected void lbtnUnReviewReq_Click(object sender, EventArgs e)
        {
            try
            {
                txtReason.Attributes.Add("MaxLength", "500");
                ...
                DataSet ds = dal_DB.DB_REVIEW_SP(ACTION: "GET_SYSTEMS_FOR_GEN_UNREVIEW_REQUEST",
                    MODULEID: MODULEID
                    );
        ...
        protected void btnSubmitUnReviewReq_Click(object sender, EventArgs e)
        {
            try
            {
                for (int i = 0; i < lstSystems.Items.Count; i++)
                {
                    dal_DB.DB_REVIEW_SP(ACTION: "UPDATE_UNREVIEW_REQ",
                ...
                SendEmail("Un-Review Request Generated", txtReason.Text);

                string MSG = "Un-Review request has been generated for " + hdnModulename.Value + " module.";
