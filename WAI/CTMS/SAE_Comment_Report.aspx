<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SAE_Comment_Report.aspx.cs" Inherits="CTMS.SAE_Comment_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title" style="width: 100%;">SAE Field Comment Report</h3>
        </div>
                        ...
                        <div class="box-body">
                            <div class="rows">
                                <div style="width: 100%; overflow: auto;">
                                    <div>
                                        <asp:GridView ID="gridData" HeaderStyle-CssClass="txt_center" runat="server" AutoGenerateColumns="true" Width="100%" CssClass="table table-bordered table-striped  Datatable" OnPreRender="gridData_PreRender">
                                        </asp:GridView>
                                    </div>
                                </div>
                            </div>
