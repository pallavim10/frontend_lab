<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DM_DataLock.aspx.cs" Inherits="CTMS.DM_DataLock" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function countCheckboxes() {
            ...
            if (count < 1) {
                alert("Select at least one data to Lock");
        ...
        function Check_child(element) {
            ...
            $(element).closest('tr').next().find('td').find('table').find('input[type=checkbox][id*=Chkchild_LockYN]').each(function () {
        ...
        function Check_All(element) {
            $('input[type=checkbox][id*=Chk_LockYN]').each(function () {
                if ($(element).prop('checked') == true) {
                    $(this).prop('checked', true);
                }
                else {
            ...
            $('input[type=checkbox][id*=Chkchild_LockYN]').each(function () {
                if ($(element).prop('checked') == true) {
                    $(this).prop('checked', true);
                }
                else {
    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
                ...
                <div class="form-group" style="display: inline-flex">
                    ...
                    <div class="Control">
                        <asp:DropDownList ID="drpType" ForeColor="Blue" runat="server" OnSelectedIndexChanged="drpType_SelectedIndexChanged" Width="200px"
                            ...
                            <asp:ListItem Text="Site Wise Bulk Lock" Value="1"></asp:ListItem>
                            <asp:ListItem Text="Subject Wise Bulk Lock" Value="2"></asp:ListItem>
                            <asp:ListItem Text="Visit Wise Bulk Lock" Value="3"></asp:ListItem>
                            <asp:ListItem Text="Record Level Lock" Value="4"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
            ...
            <asp:Button ID="Btn_Get_Data" runat="server" OnClick="Btn_Get_Data_Click" CssClass="btn btn-primary btn-sm cls-btnSave" Visible="false"
                Text="Get Data" />
            <asp:Button ID="btnBulkLock" runat="server" OnClick="btnBulkLock_Click" CssClass="btn btn-DarkGreen btn-sm" Visible="false"
                Text="Bulk Lock" />
        </div>
        <div class="box-body">
            <div class="form-group ">
                <label id="selectchkall" visible="false" runat="server" class="label pull-right">
                    Select All:
                            <asp:CheckBox ID="Chk_Select_All" runat="server" AutoPostBack="True" OnCheckedChanged="Chk_Select_All_CheckedChanged1" />
                </label>
                <div style="width: 100%; overflow: auto; padding-top: 10px;">
                    <asp:GridView ID="Grd_lock" runat="server" AutoGenerateColumns="False" CellPadding="3" HeaderStyle-ForeColor="Blue"
                        CssClass="table table-bordered table-striped" CellSpacing="2" OnRowDataBound="Grd_lock_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField ItemStyle-CssClass="txt_center">
                                <HeaderTemplate>
                                    <asp:Button ID="Btn_Update" runat="server" OnClick="Btn_Update_Click" CssClass="btn btn-primary btn-sm cls-btnSave"
                                        Text="Data Lock YN" OnClientClick="return countCheckboxes();" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:CheckBox ID="Chk_LockYN" runat="server" onclick="Check_child(this)" />
                                </ItemTemplate>
                            </asp:TemplateField>
                                            ...
                                            <div id="PVID1<%# Eval("PVID") %>" style="display: none; position: relative; overflow: scroll;">
                                                <div class="box">
                                                    <div style="width: 100%; overflow: scroll;">
                                                        <asp:GridView ID="Gridchild" runat="server" CellPadding="4" AutoGenerateColumns="false" CssClass="table table-bordered table-striped" HeaderStyle-ForeColor="Maroon"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField ItemStyle-CssClass="txt_center" HeaderStyle-Width="50px">
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="Chkchild_LockYN" CssClass="freezcheck" runat="server" />
