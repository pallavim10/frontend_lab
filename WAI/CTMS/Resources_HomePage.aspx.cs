...
namespace CTMS
{
    public partial class Resources_HomePage : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void Get_Dashboard()
        {
            try
            {
                //DataSet ds1 = dal.Dashboard_SP(Action: "GET_Dashboard", User_ID: Session["User_ID"].ToString(), Project_ID: Session["PROJECTID"].ToString(), Section: "Data Management");
