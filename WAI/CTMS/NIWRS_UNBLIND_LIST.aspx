<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_UNBLIND_LIST.aspx.cs" Inherits="CTMS.NIWRS_UNBLIND_LIST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Unblinding Report</h3>
        </div>
        <div class="box-body">
    ...
    <div class="box">
        <asp:GridView ID="grdUNBLINDED" runat="server" AutoGenerateColumns="false" AllowSorting="True"
            CssClass="table table-bordered table-striped Datatable" OnPreRender="GrdData_PreRender" OnRowDataBound="grdUNBLINDED_RowDataBound" OnRowCommand="grdUNBLINDED_RowCommand">
            ...
            <Columns>
                ...
                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                    <HeaderTemplate>
                        ...
                        <label style="color: blue; font-weight: lighter; margin-bottom: 0px;">[Approved By]</label><br />
                        <label style="color: green; font-weight: lighter; margin-bottom: 0px;">[Datetime(Server)]</label><br />
                        <label style="color: red; font-weight: lighter; margin-bottom: 0px;">[Datetime(User), (Timezone)]</label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Comment by Approver" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                ...
                <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                    <HeaderTemplate>
                        <label>Unblind Details</label><br />
                        <label style="color: blue; font-weight: lighter; margin-bottom: 0px;">[Unblinded By]</label><br />
                        <label style="color: green; font-weight: lighter; margin-bottom: 0px;">[Datetime(Server)]</label><br />
                        <label style="color: red; font-weight: lighter; margin-bottom: 0px;">[Datetime(User), (Timezone)]</label>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <div>
                            <div>
                                <asp:Label ID="UNBLINDED_USERNAME" runat="server" Text='<%# Bind("UNBLINDED_USERNAME") %>' ForeColor="Blue"></asp:Label>
                            </div>
                            <div>
                                <asp:Label ID="UNBLINDED_CAL_DAT" runat="server" Text='<%# Bind("UNBLINDED_CAL_DAT") %>' ForeColor="Green"></asp:Label>
                            </div>
                            <div>
                                <asp:Label ID="UNBLINDED_CAL_TZDAT" runat="server" Text='<%# Eval("UNBLINDED_CAL_TZDAT") +" "+ Eval("UNBLINDED_TZVAL") %>' ForeColor="Red"></asp:Label>
                            </div>
                        </div>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Download" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtnDownload" CssClass="btn btn-info" Font-Size="12px" ForeColor="White" runat="server" CommandName="Download"
                            CommandArgument='<%# Eval("SUBJID") %>'>&nbsp;&nbsp;Download &nbsp;&nbsp;<span class="glyphicon glyphicon-download 2x"></span>
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
