<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="frmADDSITETEAMMEMBER.aspx.cs" Inherits="CTMS.frmADDSITETEAMMEMBER" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <div class="box box-primary">
                <div class="box-header">
                    <div>
                    <h3 class="box-title">
                        Add Investigator Team Member
                    </h3></div>
                     <div id="Div2" class="dropdown" runat="server" style="display: inline-flex"><h3 class="box-title">
               <asp:LinkButton runat="server" ID="lbInvMemberEport" OnClick="lbInvMemberEport_Click" ToolTip="Export to Excel Add Investigator Team Member"
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="lbInvMemberEport" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
