...
namespace CTMS
{
    public partial class DM_DataEntry_MultipleData_ReadOnly : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    if (Convert.ToString(Request.QueryString["VIEWDATA"]) == "1")
                    {
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (VISITID != Request.QueryString["VISITID"].ToString())
                    {
                        ...
                        {
                            Response.Redirect("DM_DataEntry_MultipleData_ReadOnly.aspx?MODULEID=" + MODULEID + "&MODULENAME=" + MODULENAME + "&VISITID=" + VISITID + "&VISIT=" + VISIT + "&INVID=" + INVID + "&SUBJID=" + SUBJID + "&OPENLINK=1&REFERENCE=" + Request.QueryString["REFERENCE"].ToString());
                        }
                        else
                        {
                            Response.Redirect("DM_DataEntry_MultipleData_ReadOnly.aspx?MODULEID=" + MODULEID + "&MODULENAME=" + MODULENAME + "&VISITID=" + VISITID + "&VISIT=" + VISIT + "&INVID=" + INVID + "&SUBJID=" + SUBJID + "&OPENLINK=1");
                        }
                    }
                }
            ...
            try
            {
                if (drpSubID.SelectedValue != "0")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            Response.Redirect("DM_DataEntry_ReadOnly.aspx?MODULEID=" + drpModule.SelectedValue + "&MODULENAME=" + drpModule.SelectedItem.Text + "&VISITID=" + drpVisit.SelectedValue + "&VISIT=" + drpVisit.SelectedItem.Text + "&INVID=" + Request.QueryString["INVID"] + "&SUBJID=" + drpSubID.SelectedValue, false);
                        }
                        if (ds.Tables[0].Rows[0]["MULTIPLEYN"].ToString() == "True")
                        {
                            Response.Redirect("DM_DataEntry_MultipleData_ReadOnly.aspx?MODULEID=" + drpModule.SelectedValue + "&MODULENAME=" + drpModule.SelectedItem.Text + "&VISITID=" + drpVisit.SelectedValue + "&VISIT=" + drpVisit.SelectedItem.Text + "&INVID=" + Request.QueryString["INVID"] + "&SUBJID=" + drpSubID.SelectedValue, false);
                        }
                    }
                    else
                    {
        ...
        protected void btnBacktoHomePage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Response.Redirect("DM_OpenCRF_ReadOnly.aspx?VISITNUM=" + Request.QueryString["VISITID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "");
                }
            }
            catch (Exception ex)
            {
        ...
        protected void lnkPAGENUM_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("DM_DataEntry_MultipleData_ReadOnly.aspx?MODULEID=" + Request.QueryString["MODULEID"] + "&MODULENAME=" + Request.QueryString["MODULENAME"] + "&VISITID=" + Request.QueryString["VISITID"] + "&VISIT=" + Request.QueryString["VISIT"] + "&INVID=" + Request.QueryString["INVID"] + "&SUBJID=" + Request.QueryString["SUBJID"] + "&RECID=" + REC_ID.Text);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        protected void lnkPAGENUMDeleted_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("DM_DataEntry_MultipleData_ReadOnly.aspx?MODULEID=" + Request.QueryString["MODULEID"] + "&MODULENAME=" + Request.QueryString["MODULENAME"] + "&VISITID=" + Request.QueryString["VISITID"] + "&VISIT=" + Request.QueryString["VISIT"] + "&INVID=" + Request.QueryString["INVID"] + "&SUBJID=" + Request.QueryString["SUBJID"] + "&RECID=" + REC_ID.Text + "&DELETED=1");
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "window.location.href = 'DM_DataEntry_MultipleData_ReadOnly.aspx?MODULEID=" + Request.QueryString["MODULEID"].ToString() + "&MODULENAME=" + Request.QueryString["MODULENAME"].ToString() + "&VISITID=" + Request.QueryString["VISITID"].ToString() + "&VISIT=" + Request.QueryString["VISIT"].ToString() + "&INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "';", true);
        }
