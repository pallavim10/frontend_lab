...
namespace CTMS
{
    public partial class NSAE_LIST_STATUS_WISE : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        public void FillSITEID()
        {
            try
            {
                ...
                ddlSite.DataBind();
                ddlSite.Items.Insert(0, new System.Web.UI.WebControls.ListItem("All", "0"));
        ...
        private void GET_SAE_STATUS_LIST()
        {
            try
            {
                DataSet ds = dal_SAE.SAE_REPORT_SP(ACTION: "GET_SAE_STATUS_LIST", ID: ddlSite.SelectedValue, SUBJID: ddlSUBJID.SelectedValue, SAEID: drpSAEID.SelectedValue);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                ...
                string xlname = Session["PROJECTIDTEXT"].ToString() + "_SAE List Report_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
