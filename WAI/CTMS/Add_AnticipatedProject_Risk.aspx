<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Add_AnticipatedProject_Risk.aspx.cs" Inherits="CTMS.Add_AnticipatedProject_Risk" %>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Add Anticipate Project Risk
                </h3></div>  
     <div class="box-body">
        ...
        <Columns>
            ...
            <%--CssClass="disp-none"--%>
                    <asp:Label ID="lbl_RISK_ID" runat="server" CssClass="disp-none"  CommandArgument='<%#Eval("RISK_ID") %>'   Text='<%# Bind("RISK_ID") %>'></asp:Label>
                        ...
                        <asp:LinkButton ID="lnk_RISK_ID"  Text='<%# Bind("RISK_ID") %>' CommandArgument='<%#Eval("RISK_ID") %>' OnClientClick="return ViewRECIDDETAILS(this);" CommandName="Risk_ID"
                                runat="server"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
<%--            <asp:TemplateField HeaderText="Nature">
                <ItemTemplate>
                    <asp:Label ID="lbl_Nature" runat="server" Text='<%# Bind("Nature") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>--%>
