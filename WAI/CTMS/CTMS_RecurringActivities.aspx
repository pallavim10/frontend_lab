<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CTMS_RecurringActivities.aspx.cs" Inherits="CTMS.CTMS_RecurringActivities" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowAudit(element) {
            ...
            var Action = "Get_Audit_Trail_Recurring";
            $.ajax({
                type: "POST",
                url: "AjaxFunction.aspx/BudgetPP_Audit_Trail_Recurring",
        ...
        function BudgetPP_UpdateData() {
            ...
            var Action = "Audit_trail_BudgetPP_Recurring";
    ...
    <script type="text/javascript">
        ...
        function DownloadDoc(element) {
            ...
            var INVID = $('#<%=ddl_INVID.ClientID%>').val();
            var TaskID = $(element).closest('tr').find('td:eq(2)').find('input').val();
            var SubTaskID = $(element).closest('tr').find('td:eq(3)').find('input').val();
                    ...
                    <tr>
                        ...
                        <td class="Control">
                            <asp:DropDownList ID="ddl_INVID" Style="text-align: center;" runat="server" Width="100%"
                                class="form-control drpControl" ValidationGroup="View">
                            </asp:DropDownList>
                        </td>
                        <td class="label">
                            Departments :&nbsp
                                                                ...
                                                                <tr>
                                                                    <td colspan="100%" style="padding: 2px;">
                                                                        ...
                                                                        <div>
                                                                            <div class="rows">
                                                                                <div class="col-md-12">
                                                                                    <%--<div id="_Site<%# Eval("Sub_Task_Id") %>" style="display: none; position: relative;
                                                                                                                                overflow: auto;">--%>
