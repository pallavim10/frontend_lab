...
namespace CTMS
{
    public partial class NCTMS_AddChecklistComments_PM : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        public void GetData()
        {
            try
            {
                ...
                ds = dal.GetSetChecklistComments(
                    Action: "GET_CHECKLIST_COMMENTS_PM",
        ...
        protected void bntSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["PMCOMMID"] == null)
                {
                    dal.GetSetChecklistComments(
                          Action: "INSERT_Comments_PM",
                          INVID: lblSiteId.Text,
                ...
                else
                {
                    dal.GetSetChecklistComments(
                         ...
                         ENTEREDBY: Session["USER_ID"].ToString(),
                         CheckListRow_ID: Request.QueryString["FIELDID"].ToString(),
                         ID: ViewState["PMCOMMID"].ToString()
                         );
                }
