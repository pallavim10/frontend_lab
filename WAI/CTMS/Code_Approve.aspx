<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Code_Approve.aspx.cs" Inherits="CTMS.Code_Approve" %>
    ...
    <div class="content">
        <div class="box box-warning">
            <div class="box-header">
                <h3 class="box-title">Approved codes
                </h3>
            </div>
                            ...
                            <div style="width: 100%; overflow: auto;">
                                <div>
                                    <asp:GridView ID="grdData" HeaderStyle-CssClass="txt_center" runat="server" AutoGenerateColumns="true"
                                        OnPreRender="gridData_PreRender" CssClass="table table-bordered Datatable table-striped" OnRowDataBound="grdData_RowDataBound" OnRowCommand="grdData_RowCommand">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Make Available for Re-Code " ItemStyle-CssClass="width50px txt_center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbtReCode" runat="server" CommandArgument='<%# Bind("ID") %>'
                                                        CommandName="RECODE" ToolTip="Re-Code"><i class="fa fa-arrow-up" style="font-size:medium"></i></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
