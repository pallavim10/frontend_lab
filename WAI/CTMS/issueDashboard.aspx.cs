...
namespace CTMS
{
    public partial class issueDashboard : System.Web.UI.Page
    {
        ...
        private void Get_Dashboard()
        {
            try
            {
                //DataSet ds1 = dal.Dashboard_SP(Action: "GET_Dashboard", User_ID: Session["User_ID"].ToString(), Project_ID: Session["PROJECTID"].ToString(), Section: "Issue Management");

                DataSet ds1 = dal.DASHBOARD_ASSIGNING(Action: "GET_Dashboard",
                  USERID: Session["User_ID"].ToString(),
                  PROJECTID: Session["PROJECTID"].ToString(),
                  TYPENAME: "Issue Management"
                  );
