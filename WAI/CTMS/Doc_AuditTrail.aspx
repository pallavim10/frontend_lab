<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Doc_AuditTrail.aspx.cs" Inherits="CTMS.Doc_AuditTrail" %>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            <asp:DropDownList Style="width: 250px;" ID="drpPlan" runat="server" class="form-control drpControl"
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            <asp:DropDownList Style="width: 250px;" ID="drpSection" runat="server" class="form-control drpControl"
