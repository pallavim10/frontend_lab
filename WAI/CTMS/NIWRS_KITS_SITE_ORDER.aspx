<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_KITS_SITE_ORDER.aspx.cs" Inherits="CTMS.NIWRS_KITS_SITE_ORDER" %>
        ...
        <ContentTemplate>
            <div class="box box-warning">
                <div class="box-header">
                    <h3 class="box-title">Order To Site Depot</h3>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <asp:GridView ID="gvKITS" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                    CssClass="table table-bordered table-striped txt_center Datatable" OnPreRender="gvKITS_PreRender">
                                    <Columns>
