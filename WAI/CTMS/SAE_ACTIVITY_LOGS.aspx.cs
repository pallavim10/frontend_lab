...
namespace CTMS
{
    public partial class SAE_ACTIVITY_LOGS : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_SAE_EVENT_LOGS()
        {
            try
            {
                DataSet ds = dal_SAE.SAE_REPORT_SP(ACTION: "GET_SAE_EVENT_LOGS",
        ...
        private void ExportSingleSheet()
        {
            try
            {
                ...
                string xlname = Session["PROJECTIDTEXT"].ToString() + "_SAE Event Logs_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
