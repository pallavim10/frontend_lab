...
namespace CTMS
{
    public partial class NIRS_REPORT_UNBLINDED : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_LIST()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "REPORT_UNBLINDED", COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "REPORT_UNBLINDED", SITEID: ddlSite.SelectedValue, COUNTRYID: ddlCountry.SelectedValue);
                ds.Tables[0].Columns["Participant Id"].ColumnName = Session["SUBJECTTEXT"].ToString();
