...
namespace CTMS
{
    public partial class NIWRS_DAMAGED_SITE : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_KITS()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_SITE_SP(ACTION: "GET_DAMAGED_SITE", COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
        ...
        private void SEND_MAIL_DESTROY(string KITNO, string COUNTRY, string SITE, string Location)
        {
            try
            {
                ...
                DataSet dsEmail = dal_IWRS.IWRS_SET_EMAIL_SP(ACTION: "GET_EMAIL_TEMPLATE", STRATA: "NIWRS_DAMAGED_SITE - Destroy");
        ...
        private void SEND_MAIL_UNQUARANTINE(string KITNO, string COUNTRY, string SITE, string Location)
        {
            try
            {
                ...
                DataSet dsEmail = dal_IWRS.IWRS_SET_EMAIL_SP(ACTION: "GET_EMAIL_TEMPLATE", STRATA: "NIWRS_DAMAGED_SITE - UnQuaratine");
        ...
        private void SEND_MAIL_RETURNED(string KITNO, string COUNTRY, string SITE, string Location)
        {
            try
            {
                CommonFunction.CommonFunction cf = new CommonFunction.CommonFunction();
                ...
                DataSet dsEmail = dal_IWRS.IWRS_SET_EMAIL_SP(ACTION: "GET_EMAIL_TEMPLATE", STRATA: "NIWRS_DAMAGED_SITE - Return");
            ...
            try
            {
                for (int i = 0; i < gvKits.Rows.Count; i++)
                {
                    ...
                    if (Chek_Return.Checked)
                    {
                        ...
                        SEND_MAIL_RETURNED(KITNO, COUNTRYNAME, SITEID, Location);
                    }
                }
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_SITE_SP(ACTION: "GET_DAMAGED_SITE_EXPORT", COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
