<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="etmf_Define_Lang.aspx.cs"
    Inherits="CTMS.etmf_Define_Lang" %>
                                ...
                                <div>
                                    <div class="row disp-none">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-7">
                                                <asp:TextBox ID="txtVariable" runat="server" Enabled="false" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-7">
                                                <asp:TextBox ID="txtText" runat="server" CssClass="form-control required"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <br />
