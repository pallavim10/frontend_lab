<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DB_AddDrpDownData_Linked_Master.aspx.cs" Inherits="CTMS.DB_AddDrpDownData_Linked_Master" %>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:Label ID="lblField" runat="server" Style="overflow-y: auto; max-height: 100px; min-height: 21px; min-width: 300px;" CssClass="form-control-model" TabIndex="1"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="col-md-4">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList runat="server" ID="ddlParentField" Style="overflow-y: auto; max-height: 100px; min-height: 21px; min-width: 300px;" CssClass="form-control-model required"
                                                        AutoPostBack="true" OnSelectedIndexChanged="ddlParentField_SelectedIndexChanged" TabIndex="2">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList runat="server" ID="ddlParentANS" Style="overflow-y: auto; max-height: 100px; min-height: 21px; min-width: 300px;" CssClass="form-control-model required" TabIndex="3">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtSeqNo" runat="server" CssClass="form-control numeric required text-center" TabIndex="4"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtText" runat="server" TextMode="MultiLine" MaxLength="500" CssClass="form-control required" style="width: 306px; height: 42px;" TabIndex="5"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
