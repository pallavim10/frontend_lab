<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_FORM_SCREEN.aspx.cs" Inherits="CTMS.NIWRS_FORM_SCREEN" %>
    ...
    <div class="box box-warning" onkeydown="tab(event);">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <asp:HiddenField runat="server" ID="hfAvlScrID" />
                ...
                <div style="display: inline-flex;">
                    <div runat="server" id="divDDLS">
                        ...
                        <div class="form-group" runat="server" id="divSubSite" style="display: inline-flex">
                            <label class="label">
                                Select Sub-Site:
                            </label>
                            <div class="Control">
                ...
                <br />
                <div runat="server" id="divStructure">
                    <div class="row">
                        <div class="col-md-12">
