...
namespace CTMS
{
    public partial class DM_Event_Logs : System.Web.UI.Page
    {
        ...
        protected void btngetdata_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet ds = dal_DM.DM_SIGNOFF_SP(ACTION: "GET_EVENT_LOGS_EXPORT",
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string xlname = Session["PROJECTIDTEXT"].ToString() + "_Subject Event Logs_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
