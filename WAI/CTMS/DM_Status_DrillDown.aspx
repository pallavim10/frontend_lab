<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DM_Status_DrillDown.aspx.cs" Inherits="CTMS.DM_Status_DrillDown" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Data Status DrillDown
                <asp:LinkButton ID="lbtnprint" runat="server" Text="Print" OnClientClick="return Print()" Visible="false"
                    CssClass="btn-sm">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div class="form-group" style="display: inline-flex">
                            ...
                            <div class="Control">
                                <asp:DropDownList ID="drpSubID" runat="server" CssClass="form-control required select" SelectionMode="Single" AutoPostBack="True">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group" style="display: inline-flex">
                            ...
                            <div class="Control">
                                <asp:DropDownList runat="server" ID="ddlStatus" CssClass="form-control required"
                                    ...
                                    <asp:ListItem Text="SDV Complete" Value="SDV Complete"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="Control">
                        ...
                        <asp:GridView ID="gridData" HeaderStyle-CssClass="txt_center" RowStyle-CssClass="txt_center"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-CssClass="txtCenter" ControlStyle-CssClass="txt_center"
                                    ...
                                    <HeaderTemplate>
                                        <a href="JavaScript:ManipulateAll('_CHILD');" id="_Folder" style="color: #333333"><i
                                            id="img_CHILD" class="icon-plus-sign-alt"></i></a>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <div runat="server" id="anchor">
                                            <a href="JavaScript:divexpandcollapse('_CHILD<%# Eval("SUBJID") %>');" style="color: #333333">
                                                <i id="img_CHILD<%# Eval("SUBJID") %>" class="icon-plus-sign-alt"></i></a>
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Subject ID" ItemStyle-CssClass="txtCenter" HeaderStyle-CssClass="txt_center"
                                    HeaderStyle-Font-Bold="true">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSUBJID" runat="server" Text='<%# Eval("SUBJID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <tr>
                                            <td colspan="100%" style="padding: 2px; padding-left: 4%;">
                                                ...
                                                <div>
                                                    <%--<div class="rows">--%>
                                                    <%--<div class="col-md-12">--%>
                                                    <div id="_CHILD<%# Eval("SUBJID") %>" style="display: none; position: relative; overflow: auto;">
                                                        <asp:GridView ID="grdData1" runat="server" CellPadding="3" AutoGenerateColumns="False"
                                                            CssClass="table table-bordered table-striped Datatable1" OnRowDataBound="gridData1_RowDataBound">
                                                            <Columns>
                                                                <asp:TemplateField ItemStyle-CssClass="txtCenter" ControlStyle-CssClass="txt_center"
                                                                    HeaderStyle-CssClass="txt_center width60px">
                                                                    <HeaderTemplate>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="100%" style="padding: 2px; padding-left: 4%;">
                                                                                ...
                                                                                <div>
                                                                                    <%--<div class="rows">
                                                                                                    <div class="col-md-12">--%>
                                                                                    <div id="_grdData1<%# Eval("VISITNUM") %>" style="display: none; position: relative; overflow: auto;">
                                                                                        <asp:GridView ID="grdData2" runat="server" CellPadding="3" AutoGenerateColumns="False"
                                                                                            ...
                                                                                            <Columns>
                                                                                                <asp:TemplateField HeaderText="MODULEID" HeaderStyle-CssClass="disp-none" ItemStyle-CssClass="disp-none">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lblMODULEID" Text='<%# Bind("Page") %>' runat="server"></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                ...
                                                                                                <asp:TemplateField HeaderText="User Name" HeaderStyle-CssClass="txt_center" ItemStyle-CssClass="txt_center">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lblUser_Name" Text='<%# Bind("User_Name") %>' runat="server"></asp:Label>
                                                                                                    </ItemTemplate>
                                                                                                </asp:TemplateField>
                                                                                                <asp:TemplateField HeaderText="Date" HeaderStyle-CssClass="align-center" ItemStyle-CssClass="txt_center"
                                                                                                    ItemStyle-Width="33%" HeaderStyle-Width="33%">
                                                                                                    <ItemTemplate>
                                                                                                        <asp:Label ID="lblFieldName" Text='<%# Bind("SDVDAT") %>' Style="text-align: center"
