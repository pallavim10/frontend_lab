...
namespace CTMS
{
    public partial class SAE_Page_Comment : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_SAE_PAGE_COMMENTS()
        {
            try
            {
                DataSet ds = dal_SAE.SAE_REPORT_SP(ACTION: "GET_SAE_PAGE_COMMENTS", ID: ddlSite.SelectedValue, SUBJID: ddlSUBJID.SelectedValue, SAEID: drpSAEID.SelectedValue);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                ...
                string xlname = Session["PROJECTIDTEXT"].ToString() + "_SAE Page Comment Report_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
