...
namespace CTMS
{
    public partial class ReportCTMS_RolesTraining : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                try
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/ReportCTMS_RolesTraining.rdlc");
