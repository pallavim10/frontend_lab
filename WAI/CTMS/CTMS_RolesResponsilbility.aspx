<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CTMS_RolesResponsilbility.aspx.cs" Inherits="CTMS.CTMS_RolesResponsilbility" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Print() {
            ...
            var Action = "GET_ROLE_TASK_Data";
            var Role = $("#<%= drpRole.ClientID %>").val();
            var test = "ReportCTMS_RolesResponsilbility.aspx?ProjectId=" + ProjectId + "&Action=" + Action + "&Role=" + Role;
