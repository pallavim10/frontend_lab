<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_REJECTED_COUNTRY.aspx.cs" Inherits="CTMS.NIWRS_REJECTED_COUNTRY" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Check_All_Expire(element) {
            ...
            $('.Datatable input[id^="Chek_Expire"]').each(function () {
                $(this).prop('checked', isChecked);
                var row = $(this).closest('tr');
                var orderId = row.find('[id="ORDERID"]').text();

                if (isChecked) {
                    checkedItems[orderId] = true;
                } else {
                    delete checkedItems[orderId];
                }
            });
        }
