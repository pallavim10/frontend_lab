<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MM_IssueList.aspx.cs" Inherits="CTMS.MM_IssueList" %>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-2" style="margin-left:-12%;">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="Drp_Status" runat="server" class="form-control"
                                            AutoPostBack="True" 
