<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Budget_HomePage.aspx.cs" Inherits="CTMS.Budget_HomePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="col-md-12">
            <div class="pull-left" style="display: inline-flex;">
                ...
                <asp:DropDownList Style="width: 250px;" ID="drpSites" runat="server" class="form-control drpControl">
                    <asp:ListItem Text="All Sites" Value="0"></asp:ListItem>
                </asp:DropDownList>
            </div>
    ...
    <script type="text/javascript">
        function Manage_Dashboard() {
            var test = "Manage_Dashboard.aspx?Section=Business Development&Type=Chart";
        ...
        function Manage_Tile() {
            var test = "Manage_Dashboard.aspx?Section=Business Development&Type=Tile";
            var strWinProperty = "toolbar=no,menubar=no,location=no,scrollbars=yes,titlebar=no";
            window.open(test, '_blank');
            return false;
        }
