...
namespace CTMS
{
    public partial class UMT_ExtUser : System.Web.UI.Page
    {
        ...
        protected void lbtnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "alert('External User Created Successfully');  window.location.href = 'UMT_ExtUser.aspx';", true);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void lbnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", "alert('External User Updated Successfully');  window.location.href = 'UMT_ExtUser.aspx';", true);
                }
            }
            catch (Exception ex)
            {
        ...
        private void DELETE_USER(string ID)
        {
            try
            {
                ...
                Response.Write("<script> alert('User deleted Successfully'); window.location.href = 'UMT_ExtUser.aspx';</script>");
                GET_USER();
            }
            catch (Exception ex)
            {
        ...
        protected void lblUserDetailsExport_Click(object sender, EventArgs e)
        {
            try
            {
                string xlname = "External Users Details";
