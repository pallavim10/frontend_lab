...
namespace CTMS
{
    public partial class SAE_Comment_Report : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_SAE_COMMENT()
        {
            try
            {
                DataSet ds = dal_SAE.SAE_REPORT_SP(ACTION: "GET_SAE_COMMENT", ID: ddlSite.SelectedValue, SUBJID: ddlSUBJID.SelectedValue, SAEID: drpSAEID.SelectedValue);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                ...
                string xlname = Session["PROJECTIDTEXT"].ToString() + "_SAE Comment Report_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
