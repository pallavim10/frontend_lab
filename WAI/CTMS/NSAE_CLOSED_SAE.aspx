<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NSAE_CLOSED_SAE.aspx.cs" Inherits="CTMS.NSAE_CLOSED_SAE" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">List Of Closed SAE
            </h3>
        </div>
                                ...
                                <asp:GridView ID="grdSAELog" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-CssClass="align-left">
                                            ...
                                            <ItemTemplate>
                                                <div align="center">
                                                    <asp:LinkButton ID="lbtnEdit" runat="server" ToolTip="Generate Re-Open Request" CommandName="EditSAE" CommandArgument='<%# Bind("SAE") %>'><i class="fa fa-edit"></i></asp:LinkButton>
                                                </div>
