<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_LIST_PREDOSING.aspx.cs" Inherits="CTMS.NIWRS_LIST_PREDOSING" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ShowKits(element) {

            var VISIT = $(element).context.innerText;
            var SUBJID = $(element).closest('tr').find('td:eq(2)').text().trim();

            window.location = "NIWRS_KITS.aspx?VISIT=" + VISIT + "&SUBJID=" + SUBJID;
            return false;
