<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_PM_REVIEW_REPORTS.aspx.cs" Inherits="CTMS.NCTMS_PM_REVIEW_REPORTS" %>
                                            ...
                                            <div class="rows">
                                                <div class="col-md-12">
                                                    <div id="_Comment<%# Eval("ID") %>" style="display: none; position: relative; overflow: auto;">
                                                        <asp:GridView ID="grdComments" runat="server" AllowSorting="True" ForeColor="Blue"
                                                            AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                                                            Caption="" OnRowDataBound="grdComments_RowDataBound" OnPreRender="gvEmp_PreRender">
                                                            <Columns>
