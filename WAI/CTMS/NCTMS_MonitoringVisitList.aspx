<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_MonitoringVisitList.aspx.cs" Inherits="CTMS.NCTMS_MonitoringVisitList" %>
                ...
                <div class="box">
                    <asp:GridView runat="server" ID="grdVisits" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Visit Report" HeaderStyle-CssClass="txt_center" ItemStyle-CssClass="txt_center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnPrint" runat="server" CommandName="PrintSAE" CommandArgument='<%# Bind("SVID") %>'><i class="fa fa-print"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Follow Up" HeaderStyle-CssClass="txt_center" ItemStyle-CssClass="txt_center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnPrintFU" runat="server" CommandName="PrintFU" CommandArgument='<%# Bind("SVID") %>'><i class="fa fa-print"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Confirmation Letter" HeaderStyle-CssClass="disp-none" ItemStyle-CssClass="disp-none">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnPrintCL" runat="server" CommandName="PrintCL" CommandArgument='<%# Bind("SVID") %>'><i class="fa fa-print"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Close Out Letter" HeaderStyle-CssClass="disp-none" ItemStyle-CssClass="disp-none">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnPrintCOL" runat="server" CommandName="PrintCOL" CommandArgument='<%# Bind("SVID") %>'><i class="fa fa-print"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
