<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UMT_SponsorUser.aspx.cs" Inherits="CTMS.UMT_SponsorUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Create Sponsor Users
            </h3>
        </div>
        <div class="box-body">
        ...
        <div class="box-header">
            ...
            <div id="Div3" class="pull-right" runat="server" style="margin-top:5px;">
                <asp:LinkButton runat="server" ID="lblUserDetailsExport" OnClick="lblUserDetailsExport_Click" CssClass="btn btn-info" Style="color: white;">
                        Export Sponsor User &nbsp;&nbsp; <span class="glyphicon glyphicon-download 2x"></span>
                </asp:LinkButton>
                &nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </div>
                ...
                <div>
                    <asp:GridView ID="grdUser" runat="server" AllowSorting="True" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Sponsor Company Name">
                                <ItemTemplate>
