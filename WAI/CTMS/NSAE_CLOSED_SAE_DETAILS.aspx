<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NSAE_CLOSED_SAE_DETAILS.aspx.cs" Inherits="CTMS.NSAE_CLOSED_SAE_DETAILS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ConfirmMsg() {
            ...
            var error_msg = "Are you sure you want to re-open this SAE?..";
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-success">
        <div class="box-header">
            <h3 class="box-title">Closed SAE Details
            </h3>
            ...
            <div class="pull-right">
                ...
                <asp:Button ID="btnReOpenSAE" runat="server" Text="Re-Open SAE" CssClass="btn btn-sm btn-DARKORANGE"
    ...
    <cc1:ModalPopupExtender ID="ModalPopupExtender2" runat="server" PopupControlID="pnlReOpenSAE" TargetControlID="lnkReason"
        BackgroundCssClass="Background" BehaviorID="modalpnlReOpenSAE">
    ...
    <asp:Panel ID="pnlReOpenSAE" runat="server" Style="display: none;" CssClass="Popup1">
        ...
        <h5 class="heading">Reason for re-open SAE</h5>
        <div class="modal-body" runat="server">
            <div id="ModelPopup2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:Button ID="btnSubmitReOpenSAE" runat="server" Style="margin-left: 37px; height: 34px; width: 71px; font-size: 14px;" CssClass="btn btn-DarkGreen btn-sm cls-btnSave"
                            Text="Submit" OnClick="btnSubmitReOpenSAE_Click" />
                        &nbsp;
                            &nbsp;
