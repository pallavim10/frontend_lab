<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="MedicalDashboard.aspx.cs" Inherits="CTMS.MedicalDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        function Manage_Dashboard() {
            var test = "Manage_Dashboard.aspx?Section=Medical Monitoring&Type=Chart";
        ...
        function Manage_Tile() {
            var test = "Manage_Dashboard.aspx?Section=Medical Monitoring&Type=Tile";
            var strWinProperty = "toolbar=no,menubar=no,location=no,scrollbars=yes,titlebar=no";
            window.open(test, '_blank');
            return false;
        }
