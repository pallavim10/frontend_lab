...
namespace CTMS
{
    public partial class DM_AddDrpDownData_Visit : System.Web.UI.Page
    {
        ...
        private void Getdata()
        {
            try
            {
                DataSet ds = dal_DB.DB_DM_SP(ACTION: "GET_DRPDOWNDATA_VISIT",
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet ds = dal_DB.DB_DM_SP(ACTION: "UPDATE_DRPDOWNDATA_BYID_VISIT",
                    DEFAULTVAL: txtText.Text,
                    SEQNO: txtSeqNo.Text,
