<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_VISIT_FORECAST.aspx.cs" Inherits="CTMS.NIWRS_VISIT_FORECAST" %>
        ...
        <ContentTemplate>
            <div class="box box-warning">
                <div class="box-header">
                    <h3 class="box-title">
                        <asp:Label runat="server" ID="lblHeader" Text="Visit Forecast"></asp:Label></h3>
                    ...
                    <a href="#" class="dropdown-toggle btn-info prevent-refresh-button" data-toggle="dropdown" style="color: #FFFFFF" >Export Visit Forecast&nbsp;<span class="glyphicon glyphicon-download"></span></a>
