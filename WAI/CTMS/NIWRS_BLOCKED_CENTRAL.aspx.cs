...
namespace CTMS
{
    public partial class NIWRS_BLOCKED_CENTRAL : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_KITS()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_CENTRAL_SP(ACTION: "GET_BLOCK_CENTRAL", COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
        ...
        private void SEND_MAIL_UNQUARANTINE(string KITNO,string Location,string ORDERID)
        {
            try
            {
                ...
                DataSet dsEmail = dal_IWRS.IWRS_SET_EMAIL_SP(ACTION: "GET_EMAIL_TEMPLATE", STRATA: "NIWRS_BLOCKED_CENTRAL - UnQuarantine");
        ...
        protected void gvKits_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    dal_IWRS.IWRS_KITS_CENTRAL_SP(ACTION: "CENTRAL_BLOCKED_EXPIRE", KITNO: e.CommandArgument.ToString(), TREAT_GRP: Location.Text);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_CENTRAL_SP(ACTION: "GET_BLOCK_CENTRAL_EXPORT", COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
