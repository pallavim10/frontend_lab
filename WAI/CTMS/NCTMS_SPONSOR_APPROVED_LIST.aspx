<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_SPONSOR_APPROVED_LIST.aspx.cs" Inherits="CTMS.NCTMS_SPONSOR_APPROVED_LIST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script>
        function Approved_List(element) {
            ...
            var test = "NCTMS_APPROVED_OPEN_CRF.aspx?SVID=" + SVID + "&VISIT=" + VISIT + "&VISITID=" + VISITID + "&SITEID=" + SITEID + "&ACTION=SPONSOR_APPROVED";
            ...
            <div class="form-group">
                ...
                <div class="box">
                    <asp:GridView runat="server" ID="grdVisits" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                        AllowSorting="True" Width="100%" OnPreRender="gvEmp_PreRender" OnRowCommand="grdVisits_RowCommand">
                        <Columns>
