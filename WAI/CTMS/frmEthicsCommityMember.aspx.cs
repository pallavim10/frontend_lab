...
namespace CTMS
{
    public partial class frmEthicsCommityMember : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void bind_EthicsCommity()
        {
            try
            {
                DataSet ds = dal.GetSetEthicsCommityDETAILS(Action: "GETETHICSDATA");
                ddlEthicsCommity.DataSource = ds.Tables[0];
                ddlEthicsCommity.DataValueField = "ID";
                ddlEthicsCommity.DataTextField = "EthicsNAM";
                ddlEthicsCommity.DataBind();
                ddlEthicsCommity.Items.Insert(0, new ListItem("--Select--", "0"));
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        private void bind_Members()
        {
            try
            {
                DataSet ds = dal.GetSetEthicsCommityDETAILS(Action: "GET_Team", ID: ddlEthicsCommity.SelectedValue);
        ...
        private void INSERT()
        {
            try
            {
                ...
                Action: "INSERT_Team",
                ID: ddlEthicsCommity.SelectedValue,
        ...
        private void UPDATE()
        {
            try
            {
                DataSet ds = dal.GetSetEthicsCommityDETAILS(
                Action: "UPDATE_Team",
                ID: Session["EthicsMEMBERID"].ToString(),
               FirstName: txtFirstName.Text,
                LastName: txtLastName.Text,
                EMAILID: txtEmailID.Text,
                MOBNO: txtMobilePhone.Text,
        ...
        private void DELETE(string id)
        {
            try
            {
                dal.GetSetEthicsCommityDETAILS(Action: "DELETE_Team", ID: id, ENTEREDBY: Session["User_ID"].ToString());
        ...
        private void EDIT(string id)
        {
            try
            {
                DataSet ds = dal.GetSetEthicsCommityDETAILS(Action: "SELECT_Team", ID: id);
                ddlEthicsCommity.SelectedValue = ds.Tables[0].Rows[0]["EthicsCommID"].ToString();
                ddlEthicsCommity.Enabled = false;
        ...
        protected void ddlEthicsCommity_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                bind_Members();
        ...
        protected void lbECTeamMemberExport_Click(object sender, EventArgs e)
        {
            try
            {
                Ethics_Committee_TeamMember(header: "Ethics Committee Team Member", Action: "Get_Ethics_Committee_TeamMember");
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        private void Ethics_Committee_TeamMember(string header = null, string Action = null, string PRODUCT_ID = null, string SUBCLASS_ID = null)
        {
            try
            {
