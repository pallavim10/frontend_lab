<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DB_UNFREEZE_REQUESTS.aspx.cs" Inherits="CTMS.DB_UNFREEZE_REQUESTS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function REVIEW_HISTORY(element) {
            ...
            $.ajax({
                type: "POST",
                url: "DB_UNFREEZE_REQUESTS.aspx/REVIEW_HISTORY",
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning" runat="server" id="content">
        <div class="box-header">
            <h3 class="box-title">Un-Freeze Requests List
            </h3>
        </div>
        <div>
                ...
                <asp:GridView ID="grdModule" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-CssClass="txt_center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnAction" Text="Action" runat="server" ToolTip="Un-Freeze Action" OnClick="lbtnAction_Click">
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <asp:Panel ID="pnlReview" runat="server" Style="display: none;" CssClass="Popup1">
        ...
        <h5 class="heading">Un-Freeze Request</h5>
        <div class="modal-body" runat="server" style="padding: 10px;">
            <div id="ModelPopup2">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-8">
                            <asp:TextBox runat="server" ID="txtReason" placeholder="Please enter comment to approve/disapprove unfreeze request for above systems...." TextMode="MultiLine" MaxLength="500" CssClass="form-control required2" Style="width: 575px; height: 131px;"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <br />
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:Button ID="btnApproveUnFreezeReq" runat="server" Style="height: 34px; width: 71px; font-size: 14px;" CssClass="btn btn-DarkGreen btn-sm cls-btnSave2"
                            Text="Approve" OnClick="btnApproveUnFreezeReq_Click" />
                        &nbsp;
                            &nbsp;
                         <asp:Button ID="btnDisapproveUnFreezeReq" runat="server" Style="height: 34px; font-size: 14px;" CssClass="btn btn-DARKORANGE btn-sm cls-btnSave2"
                             Text="Disapprove" OnClick="btnDisapproveUnFreezeReq_Click" />
                        &nbsp;
                            &nbsp;
