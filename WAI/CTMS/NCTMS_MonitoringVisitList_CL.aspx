<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_MonitoringVisitList_CL.aspx.cs" Inherits="CTMS.NCTMS_MonitoringVisitList_CL" %>
                ...
                <div class="box">
                    <asp:GridView runat="server" ID="grdVisits" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Create Confirmation Letter" HeaderStyle-CssClass="txt_center"
                                ItemStyle-CssClass="txt_center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnCreateCL" ToolTip="Create Confirmation letter" runat="server"
                                        CommandName="CreateCL" CommandArgument='<%# Bind("SVID") %>'><i class="fa fa-edit"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Print Confirmation Letter" HeaderStyle-CssClass="txt_center"
                                ItemStyle-CssClass="txt_center">
                                <ItemTemplate>
