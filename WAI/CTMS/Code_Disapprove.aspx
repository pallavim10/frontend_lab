<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Code_Disapprove.aspx.cs" Inherits="CTMS.Code_Disapprove" %>
    ...
    <div class="content">
        <div class="box box-warning">
            <div class="box-header">
                <h3 class="box-title">Disapproved codes
                </h3>
            </div>
                    ...
                    <div class="box-body">
                        <div class="rows">
                            <div style="width: 100%; overflow: auto;">
                                <div>
                                    <asp:GridView ID="grdData" HeaderStyle-CssClass="txt_center" runat="server" AutoGenerateColumns="true" OnRowCommand="grdData_RowCommand"
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Change Code">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lbtnupdate" runat="server"
                                                        ToolTip="Change Code" CommandName="ManualCode" CommandArgument='<%# Bind("ID") %>'><i class="fa fa-edit"></i></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
