<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DB_GENERATE_UNREVIEW_REQUEST.aspx.cs" Inherits="CTMS.DB_GENERATE_UNREVIEW_REQUEST" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function REVIEW_HISTORY(element) {
            ...
            $.ajax({
                type: "POST",
                url: "DB_GENERATE_UNREVIEW_REQUEST.aspx/REVIEW_HISTORY",
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning" runat="server" id="content">
        <div class="box-header">
            <h3 class="box-title">Generate UnReview Request
            </h3>
        </div>
        <div>
                ...
                <asp:GridView ID="grdModule" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Systems">
                            <ItemTemplate>
                                <asp:Label ID="SYSTEMS" runat="server" Text='<%# Bind("SYSTEMS") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField> 
                        ...
                        <asp:TemplateField HeaderText="Un-Review Request" ItemStyle-CssClass="txt_center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnUnReviewReq" runat="server" ToolTip="Un-Review Request" OnClick="lbtnUnReviewReq_Click">
                                        <img src="Images/UNFREEZED.png" style="height:20px;width:20px;" />
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <asp:Panel ID="pnlReview" runat="server" Style="display: none;" CssClass="Popup1">
        ...
        <h5 class="heading">Generate UnReview Request</h5>
        <div class="modal-body" runat="server" style="padding: 10px;">
            <div id="ModelPopup2">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-8">
                            <asp:TextBox runat="server" ID="txtReason" placeholder="Please enter comment to generate unreview request for above systems...." TextMode="MultiLine" MaxLength="500" CssClass="form-control required2" Style="width: 575px; height: 131px;"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <br />
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <asp:Button ID="btnSubmitUnReviewReq" runat="server" Style="margin-left: 37px; height: 34px; width: 71px; font-size: 14px;" CssClass="btn btn-DarkGreen btn-sm cls-btnSave2"
                            Text="Submit" OnClick="btnSubmitUnReviewReq_Click" />
                        &nbsp;
                            &nbsp;
