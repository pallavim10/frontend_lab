<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_GEN_UNBLIND_REQ.aspx.cs" Inherits="CTMS.NIWRS_GEN_UNBLIND_REQ" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Generate Unblinding Request</h3>
        </div>
        <div class="box-body">
                                ...
                                <div style="height: 264px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <asp:DropDownList runat="server" ID="drpSUBJID" SelectionMode="Single" CssClass="form-control required width200px select">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
