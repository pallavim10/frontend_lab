<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_KITS_SITE_REC.aspx.cs" Inherits="CTMS.NIWRS_KITS_SITE_REC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Check_All_Accept(element) {

            var gvID = $(element).closest('table').attr('id');

            $('#' + gvID + ' input[type=checkbox][id*=Chek_Accept]').each(function () {
                // >>this<< refers to specific checkbox
        ...
        function Check_AcceptComments() {
            ...
            if ($('#MainContent_ddlACCEPTOptions').find('option:selected').text() == 'Others') {
                ...
                if ($('#MainContent_ddlACCEPTOptions').find('option:selected').text() == '--Select--') {
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvOrders" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            CssClass="table table-bordered table-striped txt_center Datatable" OnRowDataBound="gvOrders_RowDataBound" OnRowCommand="gvOrders_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Order ID" ItemStyle-CssClass="width150pximp">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Shipment ID" ItemStyle-CssClass="width150pximp">
                                    <ItemTemplate>
                                        <asp:Label ID="SHIPMENTID" runat="server" Text='<%# Bind("SHIPMENTID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Shipment Date" ItemStyle-CssClass="width150pximp">
                                    <ItemTemplate>
                                                        ...
                                                        <asp:GridView ID="gvKits" runat="server" CellPadding="3" Width="100%" AutoGenerateColumns="False" OnPreRender="gvKits_PreRender"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="width50px">
                                                                    <HeaderTemplate>
                                                                        <asp:Button ID="btnAccept" runat="server" CssClass="btn btn-primary btn-sm" Text="Accept" OnClientClick="return CheckShipmentID(this);" OnClick="btnAccept_Click"/><br />
                                                                        <asp:CheckBox ID="ChekAll_Accept" runat="server" onclick="Check_All_Accept(this)" />
                                                                    </HeaderTemplate>
                                                                    <ItemTemplate>
                                                                        <asp:CheckBox ID="Chek_Accept" runat="server" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                ...
                <asp:Panel ID="Panel6" runat="server" Style="display: none;" CssClass="Popup1">
                    ...
                    <div class="modal-body" runat="server">
                        <div id="ModelPopupACCEPT">
                            <div class="row">
                                <div class="col-md-4">
                                    <asp:Label ID="lblACCEPTOptions" runat="server" CssClass="wrapperLable" Text="Select" Style="color: black; font-weight: 600; font-size: 14px;"></asp:Label>
                                </div>
                                <div class="col-md-8">
                                    <asp:DropDownList runat="server" ID="ddlACCEPTOptions" CssClass="form-control required width250px">
                                        <asp:ListItem Value="0" Text="--Select--"></asp:ListItem>
                                        <asp:ListItem Value="Received in proper condition" Text="Received in proper condition"></asp:ListItem>
                                        <asp:ListItem Value="Others" Text="Others"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <br />
                            <div class="row" id="DivComment" runat="server">
                                <div class="col-md-4">
                                    <asp:Label ID="lblACCEPTComments" runat="server" CssClass="wrapperLable" Text="Comments" Style="color: black; font-weight: 600; font-size: 14px;"></asp:Label>
                                </div>
                                <div class="col-md-8">
                            ...
                            <asp:HiddenField runat="server" ID="hdnACCEPT_SITEID" />
                            ...
                            <asp:HiddenField runat="server" ID="hdnAccept_COMMAND" />
                            <br />
                            <div class="row">
                                <div class="col-md-3">
                                    &nbsp;
                                ...
                                <div class="col-md-9">
                                    ...
                                    &nbsp; &nbsp;
                                  <asp:Button ID="btnCancelACCEPT" runat="server" Text="Cancel" ValidationGroup="AcceptComment"
