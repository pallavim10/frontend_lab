...
namespace CTMS
{
    public partial class DM_AUDITTRAIL_REPORT_UNBLINDED : System.Web.UI.Page
    {
        ...
        protected void GET_SUBJECT()
        {
            try
            {
                DataSet ds = dal_DM.DM_AUDITTRAIL_SP(ACTION: "GET_SUBJID_UNBLINDED", INVID: ddlSiteId.SelectedValue);
        ...
        protected void GET_VISIT()
        {
            try
            {
                DataSet ds = dal_DM.DM_AUDITTRAIL_SP(ACTION: "GET_VISITS_UNBLINDED", SUBJID: ddlSubjectId.SelectedValue);
        ...
        protected void GET_MODULE()
        {
            try
            {
                DataSet ds = dal_DM.DM_AUDITTRAIL_SP(ACTION: "GET_MODULES_UNBLINDED",
        ...
        protected void GET_DATA()
        {
            try
            {
                DataSet ds = dal_DM.DM_AUDITTRAIL_SP(ACTION: "GET_AUDIT_REPORT_UNBLINDED",
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_DM.DM_AUDITTRAIL_SP(ACTION: "GET_AUDIT_REPORT_UNBLINDED_EXPORT",
                INVID: ddlSiteId.SelectedValue,
                SUBJID: ddlSubjectId.SelectedValue,
                VISITNUM: ddlVisitId.SelectedValue,
                MODULEID: ddlModuleId.SelectedValue,
                ...
                ds.Tables[0].TableName = "Unblinded AuditTrail Report";

                string xlname = Session["PROJECTIDTEXT"].ToString() + "_Unblinded AuditTrail Report_" + DateTime.Now.ToString("yyyyMMdd") + ".xls";
