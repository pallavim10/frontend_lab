<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_UNBLIND_REQ_LIST.aspx.cs" Inherits="CTMS.NIWRS_UNBLIND_REQ_LIST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Request List for Unblinding</h3>
        </div>
        <div class="box-body">
                ...
                <div style="display: inline-flex;">
                    <div runat="server" id="divDDLS">
                        ...
                        <div class="form-group" runat="server" id="divSubSite" style="display: none">
                            ...
                            <div class="Control">
                                <asp:DropDownList ID="drpSubSite" runat="server" CssClass="form-control " OnSelectedIndexChanged="drpSubSite_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
                    </div>
    ...
    <div class="box">
        <asp:GridView ID="grdUNBLINDREQs" runat="server" AutoGenerateColumns="false" AllowSorting="True"
            CssClass="table table-bordered table-striped Datatable1 center" OnRowCommand="grdUNBLINDREQs_RowCommand">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Open Request" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:LinkButton ID="Open_Request" runat="server" Text="Open Request" CommandName="Open Req"
                            CommandArgument='<%# Eval("SUBJID") %>' Font-Size="Small">Open Request</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
