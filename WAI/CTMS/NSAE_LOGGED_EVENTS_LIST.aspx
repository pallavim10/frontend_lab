<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NSAE_LOGGED_EVENTS_LIST.aspx.cs" Inherits="CTMS.NSAE_LOGGED_EVENTS_LIST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">SAE Initial-Incomplete
            </h3>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div runat="server" id="DivINV" class="form-group" style="display: inline-flex">
                            <div class="form-group" style="display: inline-flex">
                                ...
                                <div class="Control">
                                    <asp:DropDownList ID="drpInvID" ForeColor="Blue" runat="server" AutoPostBack="True" CssClass="form-control "
