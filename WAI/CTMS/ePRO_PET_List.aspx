<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ePRO_PET_List.aspx.cs" Inherits="CTMS.ePRO_PET_List" %>
        ...
        <div class="box-header">
            <h3 class="box-title" style="width: 100%;">
                <asp:Label ID="lblHeader" runat="server" Font-Size="12px" Font-Bold="true" Font-Names="Arial"
                    Text="Symptoms Recorded"></asp:Label>
            </h3>
        </div>
        <div class="form-group has-warning">
            <asp:Label ID="lblErrorMsg" runat="server" Style="color: #CC3300; font-weight: 700;"></asp:Label>
            <asp:HiddenField runat="server" ID="hdnMODULEID" Value="11" />
            <asp:HiddenField runat="server" ID="hdnTABLENAME" Value="ePRO_DATA_PET" />
        </div>
