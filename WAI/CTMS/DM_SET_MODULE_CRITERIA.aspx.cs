...
namespace CTMS
{
    public partial class DM_SET_MODULE_CRITERIA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    drpLISTField1.Items.Insert(0, new ListItem("--Select Field--", "0"));
                    drpLISTField2.Items.Insert(0, new ListItem("--Select Field--", "0"));
                    drpLISTField3.Items.Insert(0, new ListItem("--Select Field--", "0"));
                    drpLISTField4.Items.Insert(0, new ListItem("--Select Field--", "0"));
                    drpLISTField5.Items.Insert(0, new ListItem("--Select Field--", "0"));
                    ...
                    {
                        Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "DisableDiv('Frozen');", true);
                        grdStepCrits.Columns[8].Visible = false;
                    }
                    else
                    {
                        grdStepCrits.Columns[8].Visible = true;
                    }
                }
            }
            catch (Exception ex)
        ...
        protected void GET_CRITs()
        {
            try
            {
                DataSet ds = dal_DB.DB_SETUP_CRITs_SP(ACTION: "GET_MODULE_CRITs", MODULEID: Request.QueryString["MODULEID"].ToString());
        ...
        protected void GET_VISITS()
        {
            try
            {
                DataSet ds = dal_DB.DB_SETUP_CRITs_SP(ACTION: "GET_VISITS");
        ...
        private void GET_ADD_CRIT_Modules()
        {
            try
            {
                DataSet ds = dal_DB.DB_SETUP_CRITs_SP(ACTION: "GET_MODULES_MODULE_CRIT");
        ...
        private void BIND_OPTIONS(DropDownList ddl, HiddenField hf)
        {
            try
            {
                ...
                ds = dal_DB.DB_SETUP_CRITs_SP(ACTION: "GET_FORM_SPEC_FIELD_ANS", VARIABLENAME: ddl.SelectedValue);
        ...
        private void EDIT_CRIT(string ID)
        {
            try
            {
                DataSet ds = dal_DB.DB_SETUP_CRITs_SP(ACTION: "GET_MODULE_CRITs_BYID", ID: ID);
        ...
        protected void DELETE_CRIT(string ID)
        {
            try
            {
                ...
                dal_DB.DB_SETUP_CRITs_SP(ACTION: "Delete_Module_CRITs", ID: ID);

                Response.Write("<script> alert('Module criteria deleted successfully.'); window.location.href='" + Request.RawUrl.ToString() + "' </script>");
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Write("<script> alert('Module criteria added successfully.'); window.location.href='" + Request.RawUrl.ToString() + "' </script>");
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Write("<script> alert('Module criteria updated successfully.'); window.location.href='" + Request.RawUrl.ToString() + "' </script>");
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.ToString();
