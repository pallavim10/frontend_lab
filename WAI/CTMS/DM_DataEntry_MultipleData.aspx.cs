...
namespace CTMS
{
    public partial class DM_DataEntry_MultipleData : System.Web.UI.Page
    {
        DAL_DM dal_DM = new DAL_DM();
        DataTable dt_AuditTrail = new DataTable("DM_AUDITTRAIL");
        public static DataTable dt_AuditTrail1 = new DataTable("DM_AUDITTRAIL");
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (VISITID != Request.QueryString["VISITID"].ToString())
                    {
                        ...
                        {
                            Response.Redirect("DM_DataEntry_MultipleData.aspx?MODULEID=" + MODULEID + "&MODULENAME=" + MODULENAME + "&VISITID=" + VISITID + "&VISIT=" + VISIT + "&INVID=" + INVID + "&SUBJID=" + SUBJID + "&OPENLINK=1&REFERENCE=" + Request.QueryString["REFERENCE"].ToString());
                        }
                        else
                        {
                            Response.Redirect("DM_DataEntry_MultipleData.aspx?MODULEID=" + MODULEID + "&MODULENAME=" + MODULENAME + "&VISITID=" + VISITID + "&VISIT=" + VISIT + "&INVID=" + INVID + "&SUBJID=" + SUBJID + "&OPENLINK=1");
                        }
                    }
                }
        ...
        private void GetStructure(GridView grd)
        {
            try
            {
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        if (ds.Tables[2].Rows[0]["LabData"].ToString() != "0")
                        {
                            GET_Labs();
                            GET_LAB_MAPPING_VARIABLES();
                        }
                    }
        ...
        protected void bntSaveComplete_Click(object sender, EventArgs e)
        {
            try
            {
                if (CHECK_OnSubmit_CRITs())
                {
                    ...
                    if (Request.QueryString["OPENLINK"] == "1")
                    {
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Record saved as completed successfully.');window.close(); ", true);
                    }
                    else
                    {
                        string MSG = "DM_DataEntry_MultipleData.aspx?MODULEID=" + Request.QueryString["MODULEID"].ToString() + "&MODULENAME=" + Request.QueryString["MODULENAME"].ToString() + "&VISITID=" + Request.QueryString["VISITID"].ToString() + "&VISIT=" + Request.QueryString["VISIT"].ToString() + "&INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString();

                        Response.Write("<script> alert('Record saved as completed successfully.');window.location='" + MSG + "'; </script>");
                    }
                }
                else
                {
                ...
                if (dt_AuditTrail.Rows.Count > 0)
                {
                    ...
                    using (SqlBulkCopy sqlbc = new SqlBulkCopy(con.ConnectionString.ToString(), SqlBulkCopyOptions.KeepIdentity))
                    {
                        ...
                        if (hdn_PAGESTATUS.Value == "1")
                        {
                            ...
                            dal_DM.DM_AUDITTRAIL_SP(ACTION: "DATA_UPDATED_AUDITTRAIL_ACTION",
                                PVID: hdnPVID.Value,
                                RECID: RECID,
                                SUBJID: Request.QueryString["SUBJID"].ToString(),
                                VISITNUM: Request.QueryString["VISITID"].ToString(),
            ...
            try
            {
                if (CHECK_OnSubmit_CRITs())
                {
                    ...
                    if (Request.QueryString["OPENLINK"] == "1")
                    {
                        ...
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Record saved as incomplete successfully.');window.close(); ", true);
                    }
                    else
                    {
                        INSERT_FORM_DATA_Incomplete();
                        ...
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Record saved as incomplete successfully.');window.location.href = 'DM_OpenCRF.aspx?VISITNUM=" + Request.QueryString["VISITID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "';", true);
                    }
                }
                else
                {
        ...
        protected void UPDATE_SAE_SYNC()
        {
            try
            {
                dal_DM.DM_SAE_SYNC_SP(ACTION: "UPDATE_SAE_SYNC",
                PVID: hdnPVID.Value,
                RECID: hdnRECID.Value,
                MODULEID: Request.QueryString["MODULEID"].ToString(),
                SUBJID: Request.QueryString["SUBJID"].ToString()
        ...
        protected void lnkPAGENUM_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("DM_DataEntry_MultipleData.aspx?MODULEID=" + Request.QueryString["MODULEID"] + "&MODULENAME=" + Request.QueryString["MODULENAME"] + "&VISITID=" + Request.QueryString["VISITID"] + "&VISIT=" + Request.QueryString["VISIT"] + "&INVID=" + Request.QueryString["INVID"] + "&SUBJID=" + Request.QueryString["SUBJID"] + "&RECID=" + REC_ID.Text);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        protected void lbtnComplete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("DM_DataEntry_MultipleData.aspx?MODULEID=" + Request.QueryString["MODULEID"].ToString() + "&MODULENAME=" + Request.QueryString["MODULENAME"].ToString() + "&VISITID=" + Request.QueryString["VISITID"].ToString() + "&VISIT=" + Request.QueryString["VISIT"].ToString() + "&INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString());
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        protected void lnkPAGENUMDeleted_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("DM_DataEntry_MultipleData.aspx?MODULEID=" + Request.QueryString["MODULEID"] + "&MODULENAME=" + Request.QueryString["MODULENAME"] + "&VISITID=" + Request.QueryString["VISITID"] + "&VISIT=" + Request.QueryString["VISIT"] + "&INVID=" + Request.QueryString["INVID"] + "&SUBJID=" + Request.QueryString["SUBJID"] + "&RECID=" + REC_ID.Text + "&DELETED=1");
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        public void GET_InListEditable()
        {
            try
            {
                DataSet ds = dal_DM.DM_INSLIST_EDITABLE_SP(
                ...
                DataSet dsInlist = dal_DM.DM_INSLIST_EDITABLE_SP(
                ACTION: "GET_InList",
                MODULEID: Request.QueryString["MODULEID"].ToString(),
                VISITID: Request.QueryString["VISITID"].ToString()
                );
        ...
        public void Generate_Query(string RULE_ID, string Nature, string PVID, string RECID, string SUBJID, string Data, string QUERYTEXT, string Module_ID, string Field_ID, string VARIABLENAME, string OtherPVIDS, string VISITNUM, string VISIT)
        {
            try
            {
            ...
            try
            {
                ...
                else if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (IsComplete == "0")
                    {
                        ...
                        if (hdnFreezeStatus.Value == "1" || hdnLockStatus.Value == "1")
                        {
                            ...
                            for (int i = 0; i < e.Row.Cells.Count; i++)
                            {
                                ...
                                if (gridDataInlistEditable[i].ToString() == drRow["FIELDNAME"].ToString())
                                {
                                    ...
                                    if (drRow["CONTROLTYPE"].ToString() == "TEXTBOX")
                                    {
                                        ...
                                        TXT_FIELD.Attributes.Add("onchange", "checkOnChangeCrit_Editable(this, '" + drRow["VARIABLENAME"].ToString() + "', '" + hdnPVID.Value + "', '" + dr["RECID"].ToString() + "', '" + drRow["TABLENAME"].ToString() + "', '" + drRow["FIELDNAME"].ToString() + "');");
                                    ...
                                    else if (drRow["CONTROLTYPE"].ToString() == "DROPDOWN")
                                    {
                                        ...
                                        DataSet ds;
                                        ds = new DataSet();
                                        ds = dal_DM.DM_OPTIONS_DATA_SP(Action: "GET_OPTIONS_LIST_VISIT", VARIABLENAME: drRow["VARIABLENAME"].ToString(), VISITNUM: Request.QueryString["VISITID"].ToString());
                                        ...
                                        DRP_FIELD.Attributes.Add("onchange", "checkOnChangeCrit_Editable(this, '" + drRow["VARIABLENAME"].ToString() + "', '" + hdnPVID.Value + "', '" + dr["RECID"].ToString() + "', '" + drRow["TABLENAME"].ToString() + "', '" + drRow["FIELDNAME"].ToString() + "');");
        ...
        protected void bntSaveCompleted_Click(object sender, EventArgs e)
        {
            try
            {
                if (dt_AuditTrail1.Rows.Count > 0)
                {
                    Insert_InlistEditableDT();

                    Session.Remove("RedirceToAnotherPage");

                    Response.Write("<script> alert('Record Updated successfully.');window.location='" + Request.RawUrl + "'; </script>");
                }
                else
                {
                    Response.Write("<script> alert('There is no data available to update.');window.location='" + Request.RawUrl + "'; </script>");
                }
            }
            catch (Exception ex)
            {
        ...
        protected void Insert_InlistEditableDT()
        {
            try
            {
                for (int i = 0; i < grd_Records.Rows.Count; i++)
                {
                    ...
                    string RECID = ((Label)grd_Records.Rows[i].FindControl("lblRECID")).Text;
                    DataRow[] dr = dt_AuditTrail1.Select("PVID = '" + hdnPVID.Value + "' AND RECID = " + RECID + " ");
                    ...
                    if (dr.Length > 0)
                    {
                        for (int j = 0; j < dr.Length; j++)
                        {
                            if (UPDATEQUERY == "")
                            {
                                UPDATEQUERY = "UPDATE [" + dr[j]["TABLENAME"].ToString() + "] SET [" + dr[j]["VARIABLENAME"].ToString() + "] = '" + dr[j]["NEWVALUE"].ToString() + "' ";
                            }
                            else
                            {
                                UPDATEQUERY = UPDATEQUERY + ", " + " [" + dr[j]["VARIABLENAME"].ToString() + "] = '" + dr[j]["NEWVALUE"].ToString() + "' ";
                            }
                        }

                        UPDATEQUERY = UPDATEQUERY + " WHERE PVID = '" + hdnPVID.Value + "' AND RECID = '" + RECID + "' ";

                        DataRow[] dr1 = dt_AuditTrail1.Select("PVID = '" + hdnPVID.Value + "' AND RECID = " + RECID + " AND FIELDNAME <> '' ");
                        ...
                        using (SqlBulkCopy sqlbc = new SqlBulkCopy(con.ConnectionString.ToString(), SqlBulkCopyOptions.KeepIdentity))
                        {
                            ...
                            dal_DM.DM_AUDITTRAIL_SP(ACTION: "DATA_UPDATED_AUDITTRAIL_ACTION",
                                ...
                                VARIABLENAME: dt.Rows[0]["VARIABLENAME"].ToString(),
                            ...
                            ADD_UPDATED_AT_ENTRY_LOGS(dt, RECID);
                        }
        ...
        public static string DATA_Changed_Editable(string PVID, string RECID, string SUBJID, string VISITID, string MODULENAME, string FIELDNAME, string TABLENAME, string VARIABLENAME, string Reason, string Comment, string OldValue, string NewValue)
        {
            string str = "";
            try
            {
                ...
                if (dt_AuditTrail1.Columns.Count == 0)
                {
                    // Create Name column.
                    dtColumn = new DataColumn();
                    dt_AuditTrail1.Columns.Add("SOURCE");
                    dt_AuditTrail1.Columns.Add("PVID");
                    dt_AuditTrail1.Columns.Add("RECID");
                    dt_AuditTrail1.Columns.Add("SUBJID");
                    dt_AuditTrail1.Columns.Add("VISITNUM");
                    dt_AuditTrail1.Columns.Add("MODULENAME");
                    dt_AuditTrail1.Columns.Add("FIELDNAME");
                    dt_AuditTrail1.Columns.Add("TABLENAME");
                    dt_AuditTrail1.Columns.Add("VARIABLENAME");
                    dt_AuditTrail1.Columns.Add("OLDVALUE");
                    dt_AuditTrail1.Columns.Add("NEWVALUE");
                    dt_AuditTrail1.Columns.Add("REASON");
                    dt_AuditTrail1.Columns.Add("COMMENTS");
                    dt_AuditTrail1.Columns.Add("ENTEREDBY");
                    dt_AuditTrail1.Columns.Add("ENTEREDBYNAME");
                    dt_AuditTrail1.Columns.Add("ENTEREDDAT");
                    dt_AuditTrail1.Columns.Add("ENTERED_TZVAL");
                    dt_AuditTrail1.Columns.Add("DM");
                }

                DataRow myDataRow;
                myDataRow = dt_AuditTrail1.NewRow();
                myDataRow["SOURCE"] = "eCRF";
                myDataRow["PVID"] = PVID;
                myDataRow["RECID"] = RECID;
                ...
                myDataRow["REASON"] = Reason;
                myDataRow["COMMENTS"] = Comment;
                myDataRow["ENTEREDBY"] = HttpContext.Current.Session["User_ID"].ToString();
                myDataRow["ENTEREDBYNAME"] = HttpContext.Current.Session["User_Name"].ToString();
                myDataRow["ENTEREDDAT"] = DateTime.Now;
                myDataRow["ENTERED_TZVAL"] = HttpContext.Current.Session["TimeZone_Value"].ToString();
                myDataRow["OLDVALUE"] = REMOVEHTML(OldValue).Replace("N'", "").Replace("'", "").Trim();
                myDataRow["NEWVALUE"] = REMOVEHTML(NewValue).Replace("N'", "").Replace("'", "").Trim();
                myDataRow["DM"] = true;
                dt_AuditTrail1.Rows.Add(myDataRow);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        private void GET_Labs()
        {
            try
            {
                divLabID.Visible = true;

                DataSet ds = dal_DM.DM_LAB_DATA_SP(
                ACTION: "GET_LAB",
                INVID: Request.QueryString["INVID"].ToString()
                );
                ...
                drpLab.DataBind();
                drpLab.CssClass = drpLab.CssClass + " required";
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        protected void GET_LAB_MAPPING_VARIABLES()
        {
            try
            {
                DataSet ds = dal_DM.DM_LAB_DATA_SP(ACTION: "GET_LAB_MAPPING_VARIABLES",
                    MODULEID: drpModule.SelectedValue,
                    VISITNUM: drpVisit.SelectedValue
                    );
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    hdnLABID_VAR.Value = ds.Tables[0].Rows[0]["LABID_VAR"].ToString();
                    hdnLL_VAR.Value = ds.Tables[0].Rows[0]["LL_VAR"].ToString();
                    hdnUL_VAR.Value = ds.Tables[0].Rows[0]["UL_VAR"].ToString();
                    hdnUNIT_VAR.Value = ds.Tables[0].Rows[0]["UNIT_VAR"].ToString();
                }
            }
            catch (Exception ex)
            {
