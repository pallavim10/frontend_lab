<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NCTMS_View_ChecklistComments_SPONSOR.aspx.cs"
    Inherits="CTMS.NCTMS_View_ChecklistComments_SPONSOR" %>
            ...
            <div class="box-header" style="display: inline-flex; width: 100%;">
                <h3 class="box-title" style="width: 100%; color: Blue; font-weight: bold;">
                    ...
                    <asp:Label runat="server" ID="lblSiteId" />&nbsp;||&nbsp;<asp:Label runat="server"
                        ID="lblVisit" />&nbsp;||&nbsp;<asp:Label runat="server" ID="lblModuleName" />&nbsp;||&nbsp;<asp:Label
                            runat="server" ID="lblSVID" />&nbsp; &nbsp&nbsp&nbsp <a href="JavaScript:ManipulateAll('_Pat_');"
