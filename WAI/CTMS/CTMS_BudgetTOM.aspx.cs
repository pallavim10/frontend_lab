...
namespace CTMS
{
    public partial class CTMS_BudgetTOM : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void gvMain_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    DataSet ds = dal.Budget_SP(Action: "get_CTMS_TOM", Project_Id: Session["PROJECTID"].ToString(), Task_ID: Task_ID);
