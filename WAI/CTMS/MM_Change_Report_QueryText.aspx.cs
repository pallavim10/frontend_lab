...
namespace CTMS
{
    public partial class MM_Change_Report_QueryText : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet ds = dal_MM.MM_QUERY_SP(ACTION: "UPDATE_QUERY_TEXT",
                ID: Request.QueryString["ID"].ToString(),
                QUERYTEXT: txtNewQueryText.Text,
                QUERYTYPE: lblOLDQUERYTEXT.Text
                );

                Response.Write("<script> alert('Query Text Updated Successfully.'); window.location='MM_QueryList.aspx'; </script>");
