...
namespace CTMS
{
    public partial class eTMF_PROC_InternalApp : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void gvFiles_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    ViewState["Unblind"] = drv["Unblind"].ToString();
        ...
        protected void gvDocs_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (Convert.ToString(ViewState["Unblind"]) == "Unblinded")
                    {
                        if (Session["Unblind"].ToString() == "Unblinded")
                        {
                            lbl_UploadFileName.Visible = false;
