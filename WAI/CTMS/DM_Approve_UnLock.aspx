<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DM_Approve_UnLock.aspx.cs" Inherits="CTMS.DM_Approve_UnLock" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function countCheckboxes() {
            ...
            if (count < 1) {
                alert("Select at least one data to Approve Unlock Request");
        ...
        function countCheckboxesDisapprove() {
            ...
            if (count < 1) {
                alert("Select at least one data to Disapprove Unlock Request");
                event.preventDefault();
            }
        }
        ...
        function VIEW_DM_DATA(element) {
            ...
            if ((($(element).closest('table').attr('id')).indexOf('Gridchild') != -1)) {
                ...
                MODULENAME = $(element).closest('table').closest('tr').prev().find('td:eq(17)').find('span').text();
            }
            else {
                ...
                MODULENAME = $(element).closest('tr').find('td:eq(17)').find('span').text();
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Request List for Unlock
            </h3>
        </div>
        <div class="lblError">
        ...
        <div class="box-body">
            <div class="form-group ">
                <div style="width: 100%; overflow: auto; padding-top: 10px;">
                    <asp:GridView ID="Grd_AppUnlock" runat="server" AutoGenerateColumns="False" CellPadding="3" HeaderStyle-ForeColor="Blue"
                        CssClass="table table-bordered table-striped" CellSpacing="2" OnRowDataBound="Grd_AppUnlock_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="align-left">
                                <HeaderTemplate>
                                    <label>UnLocked Request Details</label><br />
                                    <label style="color: blue; font-weight: lighter; margin-bottom: 0px;">[UnLocked Request By]</label><br />
                                    <label style="color: green; font-weight: lighter; margin-bottom: 0px;">[Datetime(Server)]</label><br />
                                    <label style="color: red; font-weight: lighter; margin-bottom: 0px;">[Datetime(User), (Timezone)]</label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <div>
                                        <div>
                                            <asp:Label ID="UNLOCK_REQBYNAME" runat="server" Text='<%# Bind("UNLOCK_REQBYNAME") %>' ForeColor="Blue"></asp:Label>
                                        </div>
                                        <div>
                                            <asp:Label ID="UNLOCK_REQ_CAL_DAT" runat="server" Text='<%# Bind("UNLOCK_REQ_CAL_DAT") %>' ForeColor="Green"></asp:Label>
                                        </div>
                                        <div>
                                            <asp:Label ID="UNLOCK_REQ_CAL_TZDAT" runat="server" Text='<%# Bind("UNLOCK_REQ_CAL_TZDAT") %>' ForeColor="Red"></asp:Label>
                                        </div>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
