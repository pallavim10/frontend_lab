...
namespace CTMS
{
    public partial class NCTMS_REVIEW_HISTORY : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void GETDATA()
        {
            try
            {
                DataSet ds = dal.CTMS_DATA_SP(ACTION: "GET_VISIT_REPORT_DATA_REVIEW_HISTORY",
        ...
        protected void grdVisits_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "GoToOpenCRF")
                {
                    ...
                    Response.Redirect("NCTMS_PM_REVIEW_OPEN_CRF.aspx?SVID=" + SVID + "&SITEID=" + SITEID + "&VISITID=" + VISITID + "&VISIT=" + VISIT_NAME, false);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void grdVisits_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    string COUNTS = drv["LOGCOUNT"].ToString();
