<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="eTMF_QC_DOC_REPORT.aspx.cs" Inherits="CTMS.eTMF_QC_DOC_REPORT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">
                <asp:Label runat="server" ID="lblHeader" Text="Document QC Listing"></asp:Label>
            </h3>
    ...
    <asp:GridView ID="gvFiles" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <%-- <asp:TemplateField HeaderText="Is the document Original / Certified">
                    <ItemTemplate>
                        <asp:Label ID="QCDOC_ORIGINAL" ToolTip='<%# Bind("QCDOC_ORIGINAL") %>' runat="server" Text='<%# Bind("QCDOC_ORIGINAL") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>--%>
