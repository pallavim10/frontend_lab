<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UMT_ExtUser.aspx.cs" Inherits="CTMS.UMT_ExtUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Create External Users
            </h3>
        </div>
        <div class="box-body">
        ...
        <div class="box-header">
            ...
            <div id="Div3" class="pull-right" runat="server" style="margin-top: 5px;">
                <asp:LinkButton runat="server" ID="lblUserDetailsExport" OnClick="lblUserDetailsExport_Click" CssClass="btn btn-info" Style="color: white;">
                        Export External User &nbsp;&nbsp; <span class="glyphicon glyphicon-download 2x"></span>
                </asp:LinkButton>
                &nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:RegularExpressionValidator ID="regexEmailValid" runat="server" ForeColor="Red" ValidationExpression="^[^\s]*\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*[^\s]*$" ControlToValidate="txtEmailid" ErrorMessage="Invalid Email"></asp:RegularExpressionValidator>
