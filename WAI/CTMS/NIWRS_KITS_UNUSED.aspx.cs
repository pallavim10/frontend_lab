...
namespace CTMS
{
    public partial class NIWRS_KITS_UNUSED : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_KITS()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_REPORT_SP(ACTION: "GET_UNUSED_KITS", TRIGGER_VAL: ddlFilterBy.SelectedValue, COUNTRYID: ddlCountry.SelectedValue, SITEID: ddlSite.SelectedValue);
