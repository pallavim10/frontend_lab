<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="eTMF_Editable_NestedView.aspx.cs" Inherits="CTMS.eTMF_Editable_NestedView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ReferenceDoc(element) {

            var ID = $(element).closest('tr').find('td:eq(0)').find('span').text();

            var test = "eTMF_Refrence_Doc.aspx?ID=" + ID;
    ...
    <div class="box box-warning">
        <div class="box-header" style="display: inline-flex; width: 100%;">
            <h3 class="box-title" style="width: 100%">
                <asp:Label runat="server" ID="lblHeader" Text="Editable Docs - Tree Structure" />
            </h3>
                                                                                                                                                            ...
                                                                                                                                                            <div class="col-md-12">
                                                                                                                                                                <div id="_Files<%# Eval("ID") %>" style="display: none; position: relative; overflow: auto;">
                                                                                                                                                                    <asp:GridView ID="gvFiles" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                                                                                                                                        OnRowCommand="gvFiles_RowCommand" CssClass="table table-bordered table-striped layerFiles Datatable"
                                                                                                                                                                        ...
                                                                                                                                                                        <Columns>
                                                                                                                                                                            ...
                                                                                                                                                                            <asp:TemplateField ItemStyle-CssClass="txt_center" ItemStyle-Width="1%">
                                                                                                                                                                                <ItemTemplate>
                                                                                                                                                                                    <asp:LinkButton ID="lbtnReference" runat="server" ToolTip="Reference" CommandName="Reference"
                                                                                                                                                                                        OnClientClick="return ReferenceDoc(this);" CommandArgument='<%# Eval("ID") %>'
                                                                                                                                                                                        Style="color: #333333; font-size: initial; font-weight: bold;">
                                                                                                                                                                                        <asp:Label ID="lblR" Text="R" runat="server"></asp:Label>
                                                                                                                                                                                    </asp:LinkButton>
                                                                                                                                                                                </ItemTemplate>
                                                                                                                                                                            </asp:TemplateField>
                                                                                                                                                                            <asp:TemplateField ItemStyle-CssClass="txt_center" ItemStyle-Width="1%">
