<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Comm_Trails.aspx.cs" Inherits="CTMS.Comm_Trails" %>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <div class="list-group" style="padding-left: 0px;">
                        <asp:Repeater runat="server" ID="repeatTrails" OnItemCommand="repeatTrails_ItemCommand"
                            OnItemDataBound="repeatTrails_ItemDataBound">
                            <ItemTemplate>
