...
namespace CTMS
{
    public partial class NIWRS_BLOCKED_COUNTRY : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_KITS()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_COUNTRY_SP(ACTION: "GET_BLOCK_COUNTRY", COUNTRYID: ddlCountry.SelectedValue);
        ...
        protected void gvKits_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "UnQuarantine")
                {
                    ...
                    SEND_MAIL_UNQUARANTINE(ORDERID.Text, COUNTRYNAME.Text, KITNO.Text, Location.Text);
        ...
        private void SEND_MAIL_UNQUARANTINE(string ORDERID, string COUNTRY, string KITNO,string  Location)
        {
            try
            {
                ...
                DataSet dsEmail = dal_IWRS.IWRS_SET_EMAIL_SP(ACTION: "GET_EMAIL_TEMPLATE", STRATA: "NIWRS_BLOCKED_COUNTRY -UnQuarantine");
            ...
            try
            {
                for (int i = 0; i < gvKits.Rows.Count; i++)
                {
                    ...
                    if (Chek_UnQuarantine.Checked)
                    {
                        ...
                        SEND_MAIL_UNQUARANTINE(ORDERID, COUNTRYNAME, KITNO,Location);
        ...
        private void ExportSingleSheet()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_KITS_COUNTRY_SP(ACTION: "GET_BLOCK_COUNTRY_EXPORT", COUNTRYID: ddlCountry.SelectedValue);
