<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_UNBLIND_APP.aspx.cs" Inherits="CTMS.NIWRS_UNBLIND_APP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Approved For Unblinding</h3>
        </div>
        <div class="box-body">
    ...
    <div class="box">
        <asp:GridView ID="grdUNBLINDAPP" runat="server" AutoGenerateColumns="false" AllowSorting="True"
            CssClass="table table-bordered table-striped" OnRowCommand="grdUNBLINDAPP_RowCommand">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Unblind" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:LinkButton ID="Open_Request" runat="server" Text="Unblind" CommandName="Unblind"
                            CommandArgument='<%# Eval("SUBJID") %>' Font-Size="Small">Unblind</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
