<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NIWRS_KITS_COUNTRY_PENDING.aspx.cs" Inherits="CTMS.NIWRS_KITS_COUNTRY_PENDING" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
 <%--   <script type="text/javascript" src="js/MaxLength.min.js"></script>
    <script type="text/javascript" src="js/MaxLength_Limit.js"></script>--%>
    <script src="CommonFunctionsJs/IWRS/IWRS_Kit_Checkbox.js"></script>
    ...
    <script type="text/javascript">
        ...
        function CheckShipmentID(element) {
            ...
            if ($(element).closest('tr').find('input').eq(0).val() == '') {
                alert('Please Enter Shipment ID');
                return false;
            }
            else if ($(element).closest('tr').find('input').eq(1).val() == '') {
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:GridView ID="gvOrders" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            CssClass="table table-bordered table-striped txtCenter" OnRowDataBound="gvOrders_RowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Shipment Date" ItemStyle-CssClass="width250pximp">
                                    <ItemTemplate>
                                        <asp:TextBox ID="SHIPMENTDATE" runat="server" Width="100%" CssClass="txtCenter txtDateNoFuture form-control"
                                            ...
                                            <td colspan="100%" style="padding: 2px; padding-left: 4%;">
                                                ...
                                                <div>
                                                    <div id="_ORDER_<%# Eval("ORDERID") %>" style="display: none; position: relative; overflow: auto;">
                                                        <asp:GridView ID="gvKits" runat="server" CellPadding="3" AutoGenerateColumns="False" Width="100%"
                                                            CssClass="table table-bordered table-striped table-striped1 Datatable" OnPreRender="gvOrders_PreRender">
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Kit Number" ItemStyle-CssClass="txtCenter width100px">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="KITNO" runat="server" Text='<%# Bind("KITNO") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Lot Number" ItemStyle-CssClass="txtCenter width100px">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="LOTNO" runat="server" Text='<%# Bind("LOTNO") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Expiry Date" ItemStyle-CssClass="txtCenter width100px">
                                                                    <ItemTemplate>
                                                                ...
                                                                <asp:TemplateField ShowHeader="false" ItemStyle-CssClass="txtCenter width50px">
                                                                    <HeaderTemplate>
                    ...
                    <div class="modal-body" runat="server">
                        <div id="ModelPopupDamage">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <asp:TextBox ID="txtDamageComments" CssClass="form-control-model" ValidationGroup="DamageCommnet" MaxLength="200" TextMode="MultiLine"
                                        runat="server" Style="width: 250px;"></asp:TextBox>
                                </div>
                            </div>
                            <br />
