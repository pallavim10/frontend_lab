<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="eTMF_MODIFY_DOCS.aspx.cs" Inherits="CTMS.eTMF_MODIFY_DOCS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">Modify Documents</h3>
        </div>
        <div class="row">
                ...
                <div id="divDefaultView" runat="server" visible="false">
                    ...
                    <div class="row" id="div8" runat="server" style="padding-top: 15px;">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <asp:TextBox runat="server" ID="txtDocDateTime" CssClass="form-control txtDate width250px"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="div2" runat="server" style="padding-top: 15px;">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-8">
                                <asp:TextBox runat="server" ID="txtReason" TextMode="MultiLine" CssClass="form-control required"
                                    Height="50" Width="721"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row" id="div12" runat="server">
                        <div class="col-md-12">
                            ...
                            &nbsp&nbsp
                            <div class="col-md-4">
                                <asp:Button ID="btnUUpdate" runat="server" Text="Update" CssClass="btn btn-primary btn-sm cls-btnSave"
                                    OnClick="btnUUpdate_Click" />
                            </div>
                        </div>
                    </div>
                    <br />
