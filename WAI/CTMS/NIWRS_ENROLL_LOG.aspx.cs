...
namespace CTMS
{
    public partial class NIWRS_ENROLL_LOG : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_LIST()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "GET_ENROLL_LOG");
        ...
        private void GET_LIST_DETAILS(string SOURCE_ID)
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "GET_ENROLLMENT_DETAILS", LISTID: SOURCE_ID);
