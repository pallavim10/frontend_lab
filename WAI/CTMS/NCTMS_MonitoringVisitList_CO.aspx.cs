...
namespace CTMS
{
    public partial class NCTMS_MonitoringVisitList_CO : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        protected void GETDATA()
        {
            try
            {
                DataSet ds = dal.CTMS_DATA_SP(ACTION: "GET_VISIT_REPORT_CO",
        ...
        protected void grdVisits_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "CreateCO")
                {
                    Response.Redirect("NCTMS_SET_CLOSE_OUT_LETTER.aspx?SVID=" + SVID + "&SITEID=" + SITEID + "&VISITID=" + VISITID + "&VISIT=" + VISIT_NAME);
                }
                else if (e.CommandName == "PrintCO")
                {
