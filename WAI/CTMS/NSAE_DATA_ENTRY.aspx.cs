...
namespace CTMS
{
    public partial class NSAE_DATA_ENTRY : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    DataSet dsModuleChk = dal_SAE.SAE_GENERAL_SP(ACTION: "CHECK_SYNC_BUTTON_BY_MODULE_FOR_SINGLE",
                    ...
                    if (dsModuleChk.Tables.Count > 0 && dsModuleChk.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            bntDM_SYNC.Visible = true;
                        }
                        else
                        {
                            bntDM_SYNC.Visible = false;
                        }
                    }
                }
            }
        ...
        protected void bntSaveComplete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string MSG = "NSAE_DATA_ENTRY.aspx?INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "&SAE=" + hdnSAE.Value + "&STATUS=" + hdnStatus.Value + "&SAEID=" + hdnSAEID.Value + "&MODULEID=" + drpModule.SelectedValue;
        ...
        protected void bntDM_SYNC_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void GetRecords_SYNC(GridView grd)
        {
            try
            {
                string COLNAME, COLVAL;
                ...
                DataSet dsData = dal_SAE.SAE_SYNC_MODULE_DATA_SP(
                    DM_PVID: hdnDM_PVID.Value,
                    DM_RECID: hdnDM_RECID.Value,
                    MODULEID: drpModule.SelectedValue,
                    TABLENAME: hdnDM_TABLENAME.Value,
                    SAEID: hdnSAEID.Value
                    );
        ...
        protected void chkReview_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (chkReview.Checked == true)
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Data Reviewed Successfully.');", true);
                }
                else
                {
                    chkReview.Checked = false;
        ...
        protected void btnDELETESubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Record deleted successfully.'); window.location.href = 'NSAE_DATA_ENTRY.aspx?INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "&SAE=" + hdnSAE.Value + "&STATUS=" + hdnStatus.Value + "&SAEID=" + hdnSAEID.Value + "&MODULEID=" + drpModule.SelectedValue + "';", true);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        protected void lnkPAGENUMDeleted_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("NSAE_DATA_ENTRY.aspx?INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "&SAE=" + hdnSAE.Value + "&STATUS=" + hdnStatus.Value + "&SAEID=" + hdnSAEID.Value + "&MODULEID=" + drpModule.SelectedValue + "&RECID=" + REC_ID.Text + "&DELETED=1");
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        {
            Response.Redirect("NSAE_DATA_ENTRY.aspx?INVID=" + Request.QueryString["INVID"].ToString() + "&SUBJID=" + Request.QueryString["SUBJID"].ToString() + "&SAE=" + hdnSAE.Value + "&STATUS=" + hdnStatus.Value + "&SAEID=" + hdnSAEID.Value + "&MODULEID=" + drpModule.SelectedValue);
        }
