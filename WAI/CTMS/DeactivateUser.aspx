<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="DeactivateUser.aspx.cs" Inherits="CTMS.DeactivateUser" %>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <asp:TextBox ID="txt_User_Name" runat="server" class="form-control width200px" ReadOnly="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <asp:TextBox ID="txt_EmailID" runat="server" class="form-control width200px" ReadOnly="true"></asp:TextBox>
                                            </div>
                                            <div class="label col-md-2">
                                                <asp:Button ID="Btn_Update" runat="server" CssClass="btn btn-primary btn-sm cls-btnSave"
                                                    Style="margin-left: 10px" OnClick="Btn_Update_Click" Text="Deactive" />
                                            </div>
                                        </div>
                                    </div>
                                    <br />
