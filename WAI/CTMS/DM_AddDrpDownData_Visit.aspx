<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DM_AddDrpDownData_Visit.aspx.cs"
    Inherits="CTMS.DM_AddDrpDownData_Visit" %>
                                    ...
                                    <div>
                                        <asp:GridView ID="grdData" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Audit Trail" ItemStyle-Width="5%" ControlStyle-Width="5%" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lbtnAudttrail" runat="server" OnClientClick="return showAuditTrail('DM_DRP_DWN_MASTER_VISIT', this);" ToolTip="Audit Trail"><i class="fa fa-clock-o" style="color:blue; font-size:15px"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Delete" ItemStyle-Width="2%" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lbtndeleteSection" runat="server" OnClientClick='<%# string.Format("return ConfirmMsg(\"{0}{1}\");", "Are you sure you want to delete this Variable : ", Eval("TEXT")) %>' CommandArgument='<%# Bind("ID") %>'
