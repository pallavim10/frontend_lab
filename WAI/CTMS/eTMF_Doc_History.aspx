<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="eTMF_Doc_History.aspx.cs" Inherits="CTMS.eTMF_Doc_History" %>
    ...
    <form id="form1" method="post" class="content" runat="server">
        ...
        <div class="box box-warning">
            <div class="box-header">
                <h3 class="box-title">Document History</h3>
            </div>
            ...
            <div style="overflow: auto">
                <asp:GridView ID="gvFiles" runat="server" AutoGenerateColumns="true"
                    CssClass="table table-bordered layerFiles Datatable" OnPreRender="grd_data_PreRender"
