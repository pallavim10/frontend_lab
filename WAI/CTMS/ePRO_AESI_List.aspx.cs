...
namespace CTMS
{
    public partial class ePRO_AESI_List : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_DATA()
        {
            try
            {
                ...
                {
                    DataSet dsData = dal.ePRO_WAD_SP(ACTION: "GET_AESI_SYMP_SUMMARY", SUBJID: ddlSubject.SelectedValue, LASTDOSE: hdnLASTDOSE.Value, USERID: Session["User_ID"].ToString());
            ...
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (Session["UserType"].ToString() == "Investigator" || Session["UserType"].ToString() == "Investigator Team Member" || Session["UserGroup_ID"].ToString() == "Administrator")
                    {
                        ...
                        string MODULENAME = "AESI - SYMPTOMS";
        ...
        private void ExportSingleSheet()
        {
            try
            {
                ...
                ds = dal.ePRO_WAD_SP(ACTION: "GET_AESI_SYMP_SUMMARY", SUBJID: ddlSubject.SelectedValue, USERID: Session["User_ID"].ToString());
