<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_PM_REVIEW_LIST.aspx.cs" Inherits="CTMS.NCTMS_PM_REVIEW_LIST" %>
            ...
            <div class="form-group">
                ...
                <div class="box">
                    <asp:GridView runat="server" ID="grdVisits" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                        OnRowCommand="grdVisits_RowCommand" AllowSorting="True" OnPreRender="gvEmp_PreRender"
                        Width="100%">
                        <Columns>
