<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NCTMS_SET_CL_LETTER.aspx.cs" Inherits="CTMS.NCTMS_SET_CL_LETTER" %>
    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <asp:TextBox runat="server" ID="txtCLLETTER" CssClass="ckeditor" Height="100%" TextMode="MultiLine"
