function SetLinkedData() {
    ...
    if (pageName == "DM_DataEntry_MultipleData.aspx" || pageName == "DM_DataEntry.aspx") {
        callChange();
    }
    else {
        callChange_ReadOnly();
...
function BindLinkedData() {
    ...
    $(".ParentLinked").each(function () {
        ...
        var VISITNUM = /[^:]*$/.exec($("#MainContent_hdnVISITID").val())[0].trim();
        ...
        for (var a = 0; a < childLinkedFields.length; ++a) {
            ...
            (function (index) {
                ...
                $.ajax({
                    ...
                    data: '{VariableName: "' + VariableName + '",ParentANS : "' + ParentANS + '",ParentVARIABLENAME: "' + ParentVARIABLENAME + '",VISITNUM: "' + VISITNUM + '",PVID: "' + PVID + '",RECID: "' + RECID + '",TABLENAME:"' + TABLENAME + '"}',
                    dataType: "json",
