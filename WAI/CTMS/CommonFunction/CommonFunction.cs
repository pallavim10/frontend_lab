...
namespace CTMS.CommonFunction
{
    public class CommonFunction
    {
        ...
        public void AutoSet_DM_PVs(string PVID, string RECID)
        {
            DataSet dsDATA = dal.GetSet_DM_ProjectData(
            ...
            dal.GetSet_DM_ProjectData(Action: "UPDATE_PVDETAILS", PVID: PVID, RECID: RECID, IsMissing: IsMissing);
        ...
        public void Insert_Tracking(string System, string Actions, string PID, string Table_Name)
        {
            string Action = "";

            if (System == "Design Bench")
            {
                Action = "DESIGN_BENCH_INSERT_TRACKER";
            }
            else if (System == "eTMF")
            {
                Action = "eTMF_INSERT_TRACKER";
            }
            else if (System == "Pharmacovigilance")
            {
                Action = "Pharmacovigilance_INSERT_TRACKER";
            }

            //dal.Insert_Tracking_SP(
            //                Action: Action,
            //                Actions: Actions,
            //                PID: PID,
        ...
        public DataSet DM_GET_ALL_ANS_QUERIES_BY_PVID_RECID(string DM_PVID, string DM_RECID)
        {
            DAL dal = new DAL();
            ...
            {
                string PVID = DM_PVID;
                int RECID = Convert.ToInt32(DM_RECID);

                ds = dal.GetRecordsQueryDetails(Action: "DM_GET_ALL_ANS_QUERIES_BY_PVID_RECID", PVID: PVID, RECID: RECID);
            }
            catch (Exception ex)
            {
        ...
        public DataSet DM_GET_ALL_CLOSED_QUERIES_BY_PVID_RECID(string DM_PVID, string DM_RECID)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
            ...
            try
            {
                ...
                ds = dal.GetRecordsQueryDetails(Action: "DM_GET_ALL_CLOSED_QUERIES_BY_PVID_RECID", PVID: PVID, RECID: RECID);
            }
            catch (Exception ex)
            {
        ...
        //SAE
        public string SAE_Insert_Qry_Comment(string SAEID, string RECID, string SUBJID, string QUERYTEXT, string MODULENAME, string FIELDNAME, string TABLENAME, string VARIABLENAME, string MODULEID)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
            string msg = "";
            try
            {
                dal.SAE_SetManualQuery(Action: "GENERATE_MQ",
                    SAEID: SAEID,
        ...
        public DataSet SAE_GET_ALL_OPEN_QUERIES(string SAEID, string MODULEID)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
            ...
            try
            {
                ds = dal.SAE_GetRecordsQueryDetails(Action: "SAE_GET_ALL_OPEN_QUERIES", SAEID: SAEID, MODULEID: MODULEID);
            }
            catch (Exception ex)
            {
        ...
        public DataSet SAE_Show_MR_Page_Comments(string SAEID, string STATUS, string MODULEID)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
        ...
        public string SAE_Insert_Qry_Comment(string SAEID, string RECID, string SUBJID, string QUERYTEXT, string MODULENAME, string FIELDNAME, string TABLENAME, string VARIABLENAME, string STATUS, string MODULEID)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
            string msg = "";
        ...
        public DataSet GetQuery_ByID(string PVID, string RECID, bool MULTIPLEYN = false)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
            ...
            try
            {
                ds = dal.GetRecordsQueryDetails(Action: "GetFieldQuery_OPEN_BYID", PVID: PVID, RECID: Convert.ToInt32(RECID), MULTIPLEYN: MULTIPLEYN);
            }
            catch (Exception ex)
            {
        ...
        //NSAE_SDV_ALL PAGE CODE-----------------------------------
        public DataSet SAE_GET_ALL_ANS_QUERIES_BY_SAEID_RECID(string SAEID, string RECID, string MODULEID)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
            ...
            try
            {
                ds = dal.SAE_GetRecordsQueryDetails(Action: "SAE_GET_ALL_ANS_QUERIES_BY_SAEID_RECID", SAEID: SAEID, RECID: Convert.ToInt32(RECID), MODULEID: MODULEID);
            }
            catch (Exception ex)
            {
        ...
        public DataSet SAE_GET_ALL_CLOSED_QUERIES_BY_SAEID_RECID(string SAEID, string RECID, string MODULEID)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
            ...
            try
            {
                ds = dal.SAE_GetRecordsQueryDetails(Action: "SAE_GET_ALL_CLOSED_QUERIES_BY_SAEID_RECID", SAEID: SAEID, RECID: Convert.ToInt32(RECID), MODULEID: MODULEID);
            }
            catch (Exception ex)
            {
        ...
        public DataSet SAE_GET_ALL_AUDIT_BY_SAEID_RECID(string SAEID, string RECID, string MODULEID)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
            try
            {
                ...
                ds = dal.SAE_GetAUDITTRAILDETAILS(Action: "SAE_GET_ALL_AUDIT_BY_SAEID_RECID", SAEID: SAEID, RECID: Convert.ToInt32(RECID), MODULEID: MODULEID);
            }
            catch (Exception ex)
            {
        ...
        public string Insert_Kit_Comment(string KitNo, string Comment)
        {
            DAL dal = new DAL();
            DataSet ds = new DataSet();
            string msg = "";
            try
            {
                //dal_IWRS.IWRS_KITS_SP(ACTION: "INSERT_KIT_COMMNET", Comment: Comment, KITNO: KitNo);
            }
            catch (Exception ex)
            {
                msg = ex.Message.ToString();
