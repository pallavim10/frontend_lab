<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="User_Deactivation_Config.aspx.cs" Inherits="CTMS.User_Deactivation_Config" %>
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <div class="box-header with-border" style="float: left;">
                        <h4 class="box-title" align="left">User Deactivation
                        </h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-10">
                            <table class="table table-bordered table-striped" cellspacing="0" rules="all" border="1" id="MainContent_gvEmailds" style="border-collapse: collapse; width: 99%; border-collapse: collapse;">
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 30%;">
                                            <asp:TextBox runat="server" ID="txtTOEMAILIDs" Rows="2" cols="20" class="form-control" Style="width: 100%;"></asp:TextBox>
                                        </td>
                                        <td style="width: 30%;">

                                            <asp:TextBox runat="server" ID="txtCCEMAILIDs" Rows="2" cols="20" class="form-control" Style="width: 100%;"></asp:TextBox>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
