...
namespace CTMS
{
    public partial class NSAE_DELETED_SAE : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            try
            {
                DataSet ds = dal_SAE.SAE_STATUS_LIST_SP(ACTION: "GET_DELETED_SAE",
        ...
        protected void grdSAELog_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "EditSAE")
                {
                    ...
                    Response.Redirect("NSAE_DELETED_SAE_DETAILS.aspx?SAEID=" + SAEID, false);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void grdSAELog_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    HtmlGenericControl divReq = (HtmlGenericControl)e.Row.FindControl("divReq");

                    if (dr["REQ"].ToString() == "True" && dr["ACTION"].ToString() == "")
                    {
                        divReq.Visible = true;
