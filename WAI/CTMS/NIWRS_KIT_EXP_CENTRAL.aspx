<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="NIWRS_KIT_EXP_CENTRAL.aspx.cs" Inherits="CTMS.NIWRS_KIT_EXP_CENTRAL" %>
            ...
            <div class="box box-warning">
                ...
                <div class="form-group">
                    ...
                    <div class="rows">
                            ...
                            <div class="col-md-12">
                                <asp:GridView ID="gvKits" HeaderStyle-CssClass="txt_center" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ShowHeader="true" ItemStyle-CssClass="width50px">
                                            <HeaderTemplate>
                        ...
                        <asp:ModalPopupExtender ID="ModalPopupExtender4" runat="server" PopupControlID="Panel4" TargetControlID="Button_Destroy" BackgroundCssClass="Background">
                            ...
                            <div class="modal-body" runat="server">
                                <div id="ModelPopupDestroy">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <asp:TextBox ID="txtDestroyComments" CssClass="form-control-model" MaxLength="200" ValidationGroup="DestroyCommnet" TextMode="MultiLine" runat="server" Style="width: 250px;"></asp:TextBox>
                                        </div>
                                    </div>
                                    <br />
                                    <div class="row">
