<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Add_User_Rights.aspx.cs" Inherits="PPT.Add_User_Rights" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">
                Manage User Functions</h3>

             <div id="Div2" class="dropdown" runat="server" style="display: inline-flex"><h3 class="box-title">
               <asp:LinkButton runat="server" ID="lbGetFunctionExport" OnClick="lbGetFunctionExport_Click" ToolTip="Export to Excel"
