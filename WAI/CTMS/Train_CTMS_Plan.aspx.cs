...
namespace CTMS
{
    public partial class Train_CTMS_Plan : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void bind_NewActs()
        {
            try
            {
                DataSet ds = dal.Training_SP(Action: "get_New_CTMS", ID: ddlPlan.SelectedValue, Project_ID: Session["PROJECTID"].ToString(), Section_ID: ddlSec.SelectedValue);
        ...
        private void bind_AddedActs()
        {
            try
            {
                DataSet ds = dal.Training_SP(Action: "get_Added_CTMS", ID: ddlPlan.SelectedValue, Project_ID: Session["PROJECTID"].ToString(), Section_ID: ddlSec.SelectedValue);
        ...
        private void insert_Plan()
        {
            try
            {
                dal.Training_SP(Action: "insert_TrainPlan_CTMS", TrainingPlan: txtGrp.Text, Project_ID: Session["PROJECTID"].ToString());
                txtGrp.Text = "";
            }
            catch (Exception ex)
            {
        ...
        private void update_Plan()
        {
            try
            {
                dal.Training_SP(Action: "update_TrainPlan_CTMS", TrainingPlan: txtGrp.Text, ID: ddlPlan.SelectedValue);
                txtGrp.Text = "";
        ...
        private void edit_Plan()
        {
            ...
            {
                Session["PLANID"] = ID;
                DataSet ds = dal.Training_SP(Action: "select_TrainPlan_CTMS", ID: ddlPlan.SelectedValue);
        ...
        private void delete_Plan()
        {
            try
            {
                dal.Training_SP(Action: "delete_TrainPlan_CTMS", ID: ddlPlan.SelectedValue);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
            ...
            try
            {
                for (int i = 0; i < gvNewActs.Rows.Count; i++)
                {
                    ...
                    if (ChAction.Checked)
                    {
                        ...
                        dal.Training_SP(Action: "addToPlan_CTMS", Project_ID: ProjectID, Section_ID: ddlSec.SelectedValue, SubSection_ID: lblSubSectionID.Text, ID: ddlPlan.SelectedValue);
                    }
                }
            }
            catch (Exception ex)
            ...
            try
            {
                for (int i = 0; i < gvAddedActs.Rows.Count; i++)
                {
                    ...
                    if (ChAction.Checked)
                    {
                        ...
                        dal.Training_SP(Action: "removeFromPlan_CTMS", ID: lblSubSectionID.Text);
                    }
                }
            }
            catch (Exception ex)
        ...
        private void get_Section()
        {
            try
            {
                DataSet ds = dal.Training_SP(Action: "get_Sec_CTMS", Project_ID: Session["PROJECTID"].ToString());
        ...
        private void get_SubSec()
        {
            try
            {
                DataSet ds = dal.Training_SP(Action: "get_Added_CTMS", ID: ddlQuePlan.SelectedValue, Project_ID: Session["PROJECTID"].ToString(), Section_ID: ddlSec.SelectedValue);
        ...
        private void insert_ques()
        {
            try
            {
                ...
                dal.Train_Verification_SP(Action: "insert_Que", Plan_ID: ddlQuePlan.SelectedValue, SEQNO: txtChkSeq.Text, FIELDNAME: txtQue.Text, CONTROLTYPE: ddlChkList.SelectedValue, SubSec_ID: ddlSubSec.SelectedValue, ANS: txtANS.Text, Date: date);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        private void update_Que()
        {
            try
            {
                ...
                dal.Train_Verification_SP(Action: "update_Que", ID: Session["QUEID"].ToString(), Plan_ID: ddlQuePlan.SelectedValue, SEQNO: txtChkSeq.Text, FIELDNAME: txtQue.Text, CONTROLTYPE: ddlChkList.SelectedValue, ANS: txtANS.Text, Date: date);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        private void delete_Que(string id)
        {
            try
            {
                dal.Train_Verification_SP(Action: "delete_Que", ID: id);
            }
            catch (Exception ex)
            {
                lblErrorMsg.Text = ex.Message.ToString();
        ...
        private void get_Que()
        {
            try
            {
                DataSet ds = dal.Train_Verification_SP(Action: "get_Que", Plan_ID: ddlQuePlan.SelectedValue, SubSec_ID: ddlSubSec.SelectedValue);
        ...
        private void edit_Que(string id)
        {
            try
            {
                DataSet ds = dal.Train_Verification_SP(Action: "select_Que", ID: id);
