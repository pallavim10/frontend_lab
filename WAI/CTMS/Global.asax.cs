...
namespace CTMS
{
    public class Global : System.Web.HttpApplication
    {
        ...
        private string Insert_RecMail(string UNIQUEID, string MessageUniqueNum, string FromID, string ToID, string CcID, string BccID, string Subject, string Body, DateTime DateTimeSent, string ROLEID)
        {
            string ReturnValue = "";
            try
            {
                ...
                DataSet ds = dal.Communication_SP(Action: "Insert_RecMail",
