    ...
    public partial class UMT_SiteUsersApproval : System.Web.UI.Page
    {
                    ...
                    if (rowView != null)
                    {
                        ...
                        if (IsSelected == "True")
                        {
                            ...
                            else if (lblSystemName.Text == "eSource")
                            {
                                ...
                                string HiddSubSytem = HiddenSubSytem.Value;
                                string[] values = HiddSubSytem.Split(',');
                                ...
                                if (ChksubsyseSource.Checked == false && chlReadOnlyeSource.Checked == false)
                                {
        ...
        private void UPDATE_SITE_USER_APPROVAL()
        {
            try
            {
                ...
                string EMAILID = ds.Tables[0].Rows[0][0].ToString();

                if (drpAction.SelectedValue == "Approve")
                {
                    SEND_MAIL_APPROVAL_DISAPPROVAL(EMAILID, USERNAME, STUDYROLE, APPROVAL_ACTION, APPROVAL_COMMENT);
        ...
        private void SEND_MAIL_APPROVAL_DISAPPROVAL(string EMAILID, string USERNAME, string STUDYROLE, string APPROVAL_ACTION, string APPROVAL_COMMENT)
        {
            try
            {
                ...
                {
                    EMAILIDS = EMAILID + "," + ds.Tables[0].Rows[0]["To"].ToString();
