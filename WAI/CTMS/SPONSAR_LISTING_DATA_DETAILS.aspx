<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SPONSAR_LISTING_DATA_DETAILS.aspx.cs"
    Inherits="CTMS.SPONSAR_LISTING_DATA_DETAILS" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ViewEventDetails_Other(element, LISTING_ID, PREV_LISTID) {
            ...
            var test = "SPONSAR_LISTING_DATA_DETAILS.aspx?VALUE=" + VALUE + "&LISTING_ID=" + LISTING_ID + "&SUBJID=" + SUBJID + "&PREV_LISTID=" + PREV_LISTID + "&FIELDID=" + FIELDID + "&TYPE=" + TYPE;
        ...
        function ViewSubjectDetails_Other(element, LISTING_ID, PREV_LISTID) {
            ...
            var test = "SPONSOR_LISTING_DATA_SUBJECT.aspx?VALUE=" + VALUE + "&LISTING_ID=" + LISTING_ID + "&PREV_LISTID=" + PREV_LISTID + "&SUBJID=" + SUBJID;
            var strWinProperty = "toolbar=no,menubar=no,location=no,scrollbars=yes,titlebar=no,height=445,width=1300";
            window.open(test, '_blank', strWinProperty);
            return false;
        }
        ...
        function ViewEventDetails(element, LISTING_ID, FIELDID) {
            ...
            if ($(element).text().trim() != '') {
                var test = "SPONSAR_LISTING_DATA_DETAILS.aspx?VALUE=" + VALUE + "&LISTING_ID=" + LISTING_ID + "&SUBJID=" + SUBJID + "&PREV_LISTID=" + PREV_LISTID + "&FIELDID=" + FIELDID + "&PVID=" + PVID + "&RECID=" + RECID + "&TYPE=" + TYPE;
                                    ...
                                    <div style="width: 100%; overflow: auto;">
                                        <div>
                                            <asp:GridView ID="gridData" HeaderStyle-CssClass="txt_center" runat="server" AutoGenerateColumns="true"
                                                ...
                                                OnRowDataBound="gridData_RowDataBound" EmptyDataText="No Records Found" EditRowStyle-CssClass="txtCenter">
                                                <Columns>
                                            ...
                                            <asp:GridView ID="gridData_Tran" Visible="false" HeaderStyle-CssClass="txt_center"
                                                ...
                                                EmptyDataText="No Records Found" EditRowStyle-CssClass="txtCenter">
                                            </asp:GridView>
                                        </div>
                                    </div>
                                </div>
