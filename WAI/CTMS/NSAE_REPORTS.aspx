<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NSAE_REPORTS.aspx.cs" Inherits="CTMS.NSAE_REPORTS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="box box-warning">
        <div class="box-header">
            <h3 class="box-title">SAE Reports
            </h3>
        </div>
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="form-group" style="display: inline-flex">
                    ...
                    <div class="Control">
                        <asp:DropDownList ID="drpReportType" runat="server" CssClass="form-control" AutoPostBack="True"
                            OnSelectedIndexChanged="drpReportType_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="form-group" style="display: inline-flex" runat="server" visible="false"
                    id="divStatus">
                    <label class="label">
                        Status:
                    </label>
                ...
                <div class="box">
                    <asp:GridView ID="grdReports" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-striped Datatable"
                        OnRowCommand="grdReports_RowCommand" AllowSorting="true" Width="100%" OnPreRender="grd_data_PreRender" OnRowDataBound="grd_data_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="align-left">
                                <HeaderTemplate>
                                    <label>Last Status Modified</label><br />
                                    <label style="color: blue; font-weight: lighter; margin-bottom: 0px;">[Last Status Modified By]</label><br />
                                ...
                                <ItemTemplate>
                                    <div runat="server">
                                        <div>
                                            <asp:Label ID="LAST_STATUS_ENTEREDBYNAME" runat="server" Enabled="false" Font-Bold="true" Text='<%# Bind("LAST_STATUS_ENTEREDBYNAME") %>' ForeColor="Blue"></asp:Label>
                                        </div>
                                        <div>
                                            <asp:Label ID="LAST_STATUS_ENTERED_CAL_DAT" runat="server" Text='<%# Bind("LAST_STATUS_ENTERED_CAL_DAT") %>' ForeColor="Green"></asp:Label>
                                        </div>
                                        <div>
                                            <asp:Label ID="LAST_STATUS_ENTERED_CAL_TZDAT" runat="server" Text='<%# Bind("LAST_STATUS_ENTERED_CAL_TZDAT") %>' ForeColor="Red"></asp:Label>
                                        </div>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="txt_center" ItemStyle-CssClass="txt_center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lbtnEdit" runat="server" ToolTip="Download" CommandName="DonwloadReport" CommandArgument='<%# Bind("SAE") %>' CssClass="btn"><i class="fa fa-download"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
