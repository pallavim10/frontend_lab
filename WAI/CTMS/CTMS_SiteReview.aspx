<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CTMS_SiteReview.aspx.cs" Inherits="CTMS.CTMS_SiteReview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="anish">
        ...
        <br />
        <br />
        <%--<asp:Button Text="Export to PDF" OnClientClick="return exportReport();" style="float:right;" runat="server"  CssClass="btn-sm"/>--%>
        <div class="row">
            <div class="col-md-12">
...
//        });
    ...
    <script type="text/javascript">
        function Manage_Dashboard() {
            var test = "Manage_Dashboard.aspx?Section=SiteReview&Type=Chart";
        ...
        function Manage_Tile() {
            var test = "Manage_Dashboard.aspx?Section=SiteReview&Type=Tile";
            var strWinProperty = "toolbar=no,menubar=no,location=no,scrollbars=yes,titlebar=no";
            window.open(test, '_blank');
            return false;
        }
