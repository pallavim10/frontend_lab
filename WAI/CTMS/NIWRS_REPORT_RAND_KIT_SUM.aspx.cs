...
namespace CTMS
{
    public partial class NIWRS_REPORT_RAND_KIT_SUM : System.Web.UI.Page
    {
        DAL dal = new DAL();
        ...
        private void GET_LIST()
        {
            try
            {
                DataSet ds = dal_IWRS.IWRS_REPORTS_SP(ACTION: "REPORT_UNBLIND_GET_RANDOMIZATION_AND_KIT_SUMMARY", SITEID: ddlSite.SelectedValue, COUNTRYID: ddlCountry.SelectedValue, SUBSITEID: ddlSubSite.SelectedValue, FROMDATE: txtDateFrom.Text, TODATE: txtDateTo.Text);
